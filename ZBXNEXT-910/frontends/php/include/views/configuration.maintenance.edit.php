...
$maintenanceFormList->addRow(_('Active since'), array(
	...
	new CNumericBox('mntc_since_year', (($this->data['active_since'] > 0) ? date('Y', $this->data['active_since']) : ''), 4), SPACE,
	new CNumericBox('mntc_since_hour', (($this->data['active_since'] > 0) ? date('H', $this->data['active_since']) : ''), 2), ':',
	new CNumericBox('mntc_since_minute', (($this->data['active_since'] > 0) ? date('i', $this->data['active_since']) : ''), 2),
	$calendarIcon
));
...
$maintenanceFormList->addRow(_('Active till'), array(
	...
	new CNumericBox('mntc_till_year', (($this->data['active_till'] > 0) ? date('Y', $this->data['active_till']) : ''), 4), SPACE,
	new CNumericBox('mntc_till_hour', (($this->data['active_till'] > 0) ? date('H', $this->data['active_till']) : ''), 2), ':',
	new CNumericBox('mntc_till_minute', (($this->data['active_till'] > 0) ? date('i', $this->data['active_till']) : ''), 2),
	$calendarIcon
));
