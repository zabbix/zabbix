 ...
 *                                                                            *
 ******************************************************************************/
static void	evaluate_item_func_last(zbx_vector_vc_value_t *values, int value_type, history_value_t *result)
{
	*result = values->values[0].value;
}
