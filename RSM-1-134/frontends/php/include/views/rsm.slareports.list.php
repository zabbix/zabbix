...
$filter_table->addRow(array(
	array(array(bold(_('TLD')), ':'.SPACE), $filter_tld),
	array(array($filter_month, SPACE, $filterYear))
));
...
$filter_table->addRow(new CCol($div_buttons, 'center', 2));
...
$widget->addFlicker($filterForm, CProfile::get('web.rsm.slareports.filter.state', 0));
