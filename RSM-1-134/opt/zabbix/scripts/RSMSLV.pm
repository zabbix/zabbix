...
our @EXPORT = qw($result $dbh $tld
		...
		get_macro_rdds_rollweek_sla get_macro_dns_udp_rtt_high get_macro_dns_udp_rtt_low get_macro_rdds_enabled
...
sub get_macro_rdds_enabled
{
	my $hostid = shift;

	my $rdds43 = __get_macro('{$RSM.TLD.RDDS43.ENABLED}', 1, $hostid);	# search TLD
	my $rdds80 = __get_macro('{$RSM.TLD.RDDS80.ENABLED}', 1, $hostid);	# search TLD
	my $rdap = __get_macro('{$RSM.TLD.RDAP.ENABLED}', 1, $hostid);		# search TLD

	return ($rdds43, $rdds80, $rdap);
}
