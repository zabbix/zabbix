...
class CWidget {
	...
	public function get() {
		...
		if (!empty($this->flicker)) {
			...
			$thin_tab->onClick("change_flicker_state('".$flicker_domid."');");
	...
	private function createHeader() {
		...
		if (!is_null($this->state)) {
			...
			$icon->attr('id', $this->bodyId.'_icon');
