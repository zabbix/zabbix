...
// discovery info
$drules = DBfetch(DBselect('SELECT COUNT(d.druleid) AS cnt FROM drules d WHERE d.status='.DRULE_STATUS_ACTIVE));
if ($drules['cnt'] > 0 && CWebUser::getType() == USER_TYPE_SUPER_ADMIN) {
