...
class CWidgetIterator extends CWidget {
	...
	_makeView() {
		...
		this._button_previous_page.classList.add('btn-iterator-page-previous', 'zi-chevron-left');
		...
		this._button_next_page.classList.add('btn-iterator-page-next', 'zi-chevron-right');
