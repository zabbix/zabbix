...
const ZBX_DB_CLICKHOUSE = 'CLICKHOUSE';
const ZBX_DB_ELASTICSEARCH = 'ELASTICSEARCH';

const ELASTICSEARCH_AUTH_NONE = 0;
const ELASTICSEARCH_AUTH_BASIC = 1;
const ELASTICSEARCH_AUTH_API_KEY = 2;
