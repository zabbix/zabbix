...
const METRIC_POINT_MARKER_TYPE_SQUARE = 1;
const METRIC_POINT_MARKER_TYPE_TRIANGLE = 2;
const METRIC_POINT_MARKER_TYPE_DIAMOND = 3;
const METRIC_POINT_MARKER_TYPE_STAR = 4;
const METRIC_POINT_MARKER_TYPE_CROSS = 5;
