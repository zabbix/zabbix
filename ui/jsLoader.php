...
$translate_strings = [
	...
	'class.cmap.js' => [
		...
		'S_ITEM_IS_REQUIRED' => _('Item is required.'),
		'S_ITEM_TYPE_UNSUPPORTED' => _('Unsupported item type.'),
		'S_PATTERN_IS_EMPTY' => _('Pattern can not be empty.'),
		'S_PATTERN_IS_REQUIRED' => _('At least 1 link highlight is required.'),
		'S_THRESHOLD_IS_NOT_CORRECT' => _('Threshold "%1$s" is not correct: expecting a numeric value.'),
		'S_THRESHOLD_IS_EMPTY' => _('Threshold can not be empty.'),
		'S_THRESHOLD_IS_REQUIRED' => _('At least 1 link threshold is required.'),
