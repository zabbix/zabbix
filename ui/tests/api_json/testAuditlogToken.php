...
class testAuditlogToken extends testAuditlogCommon {
	...
	public function testAuditlogToken_Update() {
		...
		$this->getAuditDetails('details', $this->update_actionid, $updated, self::TOKENID, self::RESOURCE_TYPE);
	}

	public function testAuditlogToken_Delete() {
		$this->call('token.delete', [self::TOKENID]);
		$this->getAuditDetails('resourcename', $this->delete_actionid, 'Updated audit token', self::TOKENID, self::RESOURCE_TYPE);
	}
}
