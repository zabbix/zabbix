...
class testTemplate extends CAPITest {
	...
	public function testTemplate_CreateDoubleLink() {
		...
		], 'Cannot link template "test-template-double-link-03" to template "test-template-double-link-04" because its parent template "test-template-double-link-01" will be linked twice.');
	}
