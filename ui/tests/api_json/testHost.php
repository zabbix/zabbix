...
class testHost extends CAPITest {
	...
	private static $data = [
		...
		'hostids' => [
			...
			// Discovered hosts to test host.update, host.massadd, host.massremove.
	...
	public function prepareHostsData() {
		...
		self::prepareTestDataHostMonitoredByFieldsCreate();
		self::prepareTestDataHostMonitoredByFieldsUpdate();
	}
	...
	public static function prepareTestDataHostMonitoredByFieldsCreate() {
		CTestDataHelper::createObjects([
			'proxy_groups' => [
				[
					'name' => 'API tests proxy group',
					'failover_delay' => '5m',
					'min_online' => '10'
				]
			],
			'host_groups' => [
				['name' => 'API tests hosts group proxy']
			],
			'proxies' => [
				[
					'name' => 'API tests proxy',
					'operating_mode' => 0
				],
				[
					'name' => 'API tests proxy 2',
					'operating_mode' => 0,
					'local_address' => '127.0.0.1',
					'proxy_groupid' => ':proxy_group:API tests proxy group'
				]
			],
			'user_groups' => [
				[
					'name' => 'user with limited proxies',
					'users' => ['userid' => 4],
					'hostgroup_rights' => [
						'id' => ':host_group:API tests hosts group proxy',
						'permission' => 3
					],
					'proxies' => ['proxyid' => ':proxy:API tests proxy']
				]
			],
			'roles' => [
				[
					'name' => 'role without server monitoring',
					'type' => 2,
					'rules' => [
						'actions' => [
			...
			'users' => [
				[
					'username' => 'user_without_server_for_monitoring',
					'roleid' => ':role:role without server monitoring',
					'passwd' => 'zabbix123456',
					'usrgrps' => [
						['usrgrpid' => ':user_group:user with limited proxies']
					]
				]
			]
		]);
	...
	public static function dataProviderInvalidHostMonitoredByFieldsCreate() {
		$groups = [['groupid' => ':host_group:API tests hosts group proxy']];

		return [
			'Create host with wrong monitored_by for proxy' => [
				'host' => [
					[
						'host' => 'proxy1.example.com',
						'groups' => $groups,
						'monitored_by' => ZBX_MONITORED_BY_PROXY_GROUP,
						'proxyid' => ':proxy:API tests proxy'
					]
				],
				'user' => null,
				'expected_error' => 'Invalid parameter "/1/proxyid": value must be 0.'
			],
			'Create host with wrong monitored_by for proxy group' => [
				'host' => [
					[
						'host' => 'proxygroup1.example.com',
						'groups' => $groups,
			...
			'Create host with inaccessible proxy' => [
				'host' => [
					[
			...
			'Create host with server for monitoring' => [
				'host' => [
					[
				...
				'user' => ['user' => 'user_without_server_for_monitoring', 'password' => 'zabbix123456'],
				'expected_error' => 'Invalid parameter "/1/monitored_by": you do not have permission to select server for monitoring.'
			],
			'Create host for the user without access to server for monitoring' => [
				'host' => [
					[
				...
				'user' => ['user' => 'user_without_server_for_monitoring', 'password' => 'zabbix123456'],
				'expected_error' => 'Invalid parameter "/1": the parameter "monitored_by" is missing.'
			]
		];
	}

	public static function dataProviderValidHostMonitoredByFieldsCreate() {
		$groups = [['groupid' => ':host_group:API tests hosts group proxy']];

		return [
			'Create host with proxy' => [
				'host' => [
					[
			...
			'Create host with proxy group' => [
				'host' => [
					[
						'host' => 'proxygroup.example.com',
						'groups' => $groups,
						'monitored_by' => ZBX_MONITORED_BY_PROXY_GROUP,
						'proxy_groupid' => ':proxy_group:API tests proxy group'
					]
			...
			'Create host for user without access to server for minitoring' => [
				'host' => [
					[
						'host' => 'withoutserver.example.com',
						'groups' => $groups,
						'monitored_by' => ZBX_MONITORED_BY_PROXY,
						'proxyid' => ':proxy:API tests proxy2'
					]
				],
				'user' => ['user' => 'user_without_server_for_monitoring', 'password' => 'zabbix123456']
			]
	...
	/**
	 * @dataProvider dataProviderInvalidHostMonitoredByFieldsCreate
	 * @dataProvider dataProviderValidHostMonitoredByFieldsCreate
	 */
	public function testHostMonitoredByFields_Create($hosts, $user = null, $expected_error = null) {
		CTestDataHelper::convertHostReferences($hosts);
	...
	public static function prepareTestDataHostMonitoredByFieldsUpdate() {
		CTestDataHelper::createObjects([
			'proxies' => [
				[
					'name' => 'API tests proxy1',
					'operating_mode' => 0
				],
				[
					'name' => 'API tests proxy2',
					'operating_mode' => 0
				]
			],
			'proxy_groups' => [
				[
					'name' => 'API tests proxy group1',
					'failover_delay' => '5m',
					'min_online' => '10'
				],
				[
					'name' => 'API tests proxy group2',
					'failover_delay' => '5m',
					'min_online' => '10'
				]
			],
			'hosts' => [
				[
					'host' => 'monitor_proxy_inaccessible.example.com',
					'groups' => [['groupid' => ':host_group:API tests hosts group proxy']],
					'monitored_by' => ZBX_MONITORED_BY_PROXY,
					'proxyid' => ':proxy:API tests proxy1'
				],
				[
					'host' => 'monitor_proxy_accessible.example.com',
					'groups' => [['groupid' => ':host_group:API tests hosts group proxy']],
					'monitored_by' => ZBX_MONITORED_BY_PROXY,
					'proxyid' => ':proxy:API tests proxy2'
				],
				[
					'host' => 'monitor_proxy_group_inaccessible.example.com',
					'groups' => [['groupid' => ':host_group:API tests hosts group proxy']],
					'monitored_by' => ZBX_MONITORED_BY_PROXY_GROUP,
					'proxy_groupid' => ':proxy_group:API tests proxy group1'
				],
				[
					'host' => 'monitor_proxy_group_accessible.example.com',
					'groups' => [['groupid' => ':host_group:API tests hosts group proxy']],
					'monitored_by' => ZBX_MONITORED_BY_PROXY_GROUP,
					'proxy_groupid' => ':proxy_group:API tests proxy group2'
				]
			],
			'user_groups' => [
				[
					'name' => 'user with limited proxies2',
					'users' => ['userid' => 4],
					'proxies' => ['proxyid' => ':proxy:API tests proxy1'],
					'proxy_groups' => ['proxy_groupid' => ':proxy_group:API tests proxy group1'],
					'hostgroup_rights' => [
						'id' => ':host_group:API tests hosts group proxy',
						'permission' => 3
					]
			...
			'users' => [
				[
					'username' => 'user_without_server_for_monitoring2',
					'roleid' => ':role:role without server monitoring',
					'passwd' => 'zabbix123456',
					'usrgrps' => [
						['usrgrpid' => ':user_group:user with limited proxies2']
					]
				]
			]
		]);
	...
	public static function dataProviderInvalidHostMonitoredByFieldsUpdate() {
		return [
			'monitored_by update while inaccessible proxy' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_inaccessible.example.com',
						'monitored_by' => ZBX_MONITORED_BY_SERVER
					]
				],
				'user' => ['user' => 'zabbix-admin', 'password' => 'zabbix'],
				'expected_error' => 'Invalid parameter "/1/monitored_by": parameter is readonly while you do not have permission to current proxy.'
			],
			'proxyid update while inaccessible proxy' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_inaccessible.example.com',
						'proxyid' => ':proxy:API tests proxy2'
				...
				'user' => ['user' => 'zabbix-admin', 'password' => 'zabbix'],
				'expected_error' => 'Invalid parameter "/1/proxyid": parameter is readonly while you do not have permission to current proxy.'
			],
			'monitored_by update while inaccessible proxy group' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_group_inaccessible.example.com',
						'monitored_by' => ZBX_MONITORED_BY_SERVER
					]
				],
				'user' => ['user' => 'zabbix-admin', 'password' => 'zabbix'],
				'expected_error' => 'Invalid parameter "/1/monitored_by": parameter is readonly while you do not have permission to current proxy group.'
			],
			'proxy_groupid update while inaccessible proxy group' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_group_inaccessible.example.com',
						'proxy_groupid' => ':proxy_group:API tests proxy group2'
				...
				'user' => ['user' => 'zabbix-admin', 'password' => 'zabbix'],
				'expected_error' => 'Invalid parameter "/1/proxy_groupid": parameter is readonly while you do not have permission to current proxy group.'
			],
			'proxyid update with inaccessible proxy' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_accessible.example.com',
						'proxyid' => ':proxy:API tests proxy1'
					]
				],
				'user' => ['user' => 'zabbix-admin', 'password' => 'zabbix'],
			...
			'proxy_groupid update with inaccessible proxy group' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_group_accessible.example.com',
						'proxy_groupid' => ':proxy_group:API tests proxy group1'
					]
				],
				'user' => ['user' => 'zabbix-admin', 'password' => 'zabbix'],
			...
			'monitored_by update for user without monitoring for server' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_accessible.example.com',
						'monitored_by' => ZBX_MONITORED_BY_SERVER
				...
				'user' => ['user' => 'user_without_server_for_monitoring2', 'password' => 'zabbix123456'],
				'expected_error' => 'Invalid parameter "/1/monitored_by": you do not have permission to select server for monitoring.'
			],
			'proxyid update for two host' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_accessible.example.com',
						'monitored_by' => ZBX_MONITORED_BY_PROXY_GROUP,
	...
	public static function dataProviderValidHostMonitoredByFieldsUpdate() {
		return [
			'monitored_by update as super admin' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_inaccessible.example.com',
						'monitored_by' => ZBX_MONITORED_BY_SERVER
			...
			'proxy_groupid update as super admin' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_inaccessible.example.com',
						'monitored_by' => ZBX_MONITORED_BY_PROXY_GROUP,
			...
			'proxy_groupid update as admin for host with proxy monitoring' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_accessible.example.com',
						'monitored_by' => ZBX_MONITORED_BY_PROXY_GROUP,
			...
			'proxy_groupid update as user with limited proxy' => [
				'host' => [
					[
						'hostid' => ':host:monitor_proxy_accessible.example.com',
						'monitored_by' => ZBX_MONITORED_BY_PROXY_GROUP,
	...
	/**
	 * @dataProvider dataProviderInvalidHostMonitoredByFieldsUpdate
	 * @dataProvider dataProviderValidHostMonitoredByFieldsUpdate
	 */
	public function testHostMonitoredByFields_Update($hosts, $user = null, $expected_error = null) {
		CTestDataHelper::convertHostReferences($hosts);
	...
	/**
	 * Revert host templates back to original state before the update to test other cases like massremove
	 * and other methods.
	 *
