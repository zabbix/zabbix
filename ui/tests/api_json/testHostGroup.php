	...
	public static function hostgroup_delete() {
		return [
			...
			[
				...
				'expected_error' => 'Cannot delete host group "maintenance_has_only_group" because maintenance "maintenance_has_only_group" must contain at least one host group, host or trigger.'
			],
			[
				'hostgroup' => [
					'62002',
			...
			[
				...
				'expected_error' => 'Cannot delete host groups "maintenance_group_1", "maintenance_group_2" because maintenance "maintenance_two_groups" must contain at least one host group, host or trigger.'
			],
			[
				'hostgroup' => [
					'62004'
