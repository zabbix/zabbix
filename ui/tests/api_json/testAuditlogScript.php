...
class testAuditlogScript extends testAuditlogCommon {
	...
	public function testAuditlogScript_CreateSSH() {
		...
		$this->getAuditDetails('details', $this->add_actionid, $created, self::$resourceid_ssh, self::RESOURCE_TYPE);
	}
	...
	public function testAuditlogScript_UpdateSSH() {
		...
		$this->getAuditDetails('details', $this->update_actionid, $updated, self::$resourceid_ssh, self::RESOURCE_TYPE);
	}
	...
	public function testAuditlogScript_CreateWebhook() {
		...
		$this->getAuditDetails('details', $this->add_actionid, $created, self::$resourceid_webhook, self::RESOURCE_TYPE);
	}
	...
	public function testAuditlogScript_UpdateWebhook() {
		...
		$this->getAuditDetails('details', $this->update_actionid, $updated, self::$resourceid_webhook, self::RESOURCE_TYPE);
	}
	...
	public function testAuditlogScript_CreateScript() {
		...
		$this->getAuditDetails('details', $this->add_actionid, $created, self::$resourceid_script, self::RESOURCE_TYPE);
	}
	...
	public function testAuditlogScript_UpdateScript() {
		...
		$this->getAuditDetails('details', $this->update_actionid, $updated, self::$resourceid_script, self::RESOURCE_TYPE);
	}
	...
	public function testAuditlogScript_CreateAuthtype() {
		...
		$this->getAuditDetails('details', $this->add_actionid, $created, self::$resourceid_authtype, self::RESOURCE_TYPE);
	}
	...
	public function testAuditlogScript_UpdateAuthtype() {
		...
		$this->getAuditDetails('details', $this->update_actionid, $updated, self::$resourceid_authtype, self::RESOURCE_TYPE);
	}
	...
	public function testAuditlogScript_Delete() {
		...
		$this->getAuditDetails('resourcename', $this->delete_actionid, 'Updated SSH script', self::$resourceid_ssh, self::RESOURCE_TYPE);
	}
}
