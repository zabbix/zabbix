...
class testUserDirectory extends CAPITest {
	...
	public static function updateValidDataProvider() {
		...
		return [
			...
			'Test valid SAML IdP certificate' => [
				'userdirectories' => [
					['userdirectoryid' => 'API SAML', 'idp_certificate' => $saml_certificates['idp_certificate']]
				],
				'expected_error' => null
			],
			'Test valid SAML SP certificate' => [
				'userdirectories' => [
					['userdirectoryid' => 'API SAML', 'sp_certificate' =>  $saml_certificates['sp_certificate']]
				],
				'expected_error' => null
			],
			'Test valid SAML SP private key' => [
				'userdirectories' => [
					['userdirectoryid' => 'API SAML', 'sp_private_key' =>  $saml_certificates['sp_private_key']]
				],
				'expected_error' => null
			]
		];
	...
	private static function samlCertificates(): array
	{
		return [
