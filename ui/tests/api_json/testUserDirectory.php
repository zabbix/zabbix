	...
	public static function updateValidDataProvider() {
		return [
			...
			'Test valid SAML IdP certificate' => [
				'userdirectories' => [
					['userdirectoryid' => 'API SAML', 'idp_certificate' => '-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----']
			...
			'Test valid SAML SP certificate' => [
				'userdirectories' => [
					['userdirectoryid' => 'API SAML', 'sp_certificate' => '-----BEGIN CERTIFICATE-----

...
-----END CERTIFICATE-----']
			...
			'Test valid SAML SP private key' => [
				'userdirectories' => [
					['userdirectoryid' => 'API SAML', 'sp_private_key' => '-----BEGIN PRIVATE KEY-----
