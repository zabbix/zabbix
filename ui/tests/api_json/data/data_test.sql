...
-- discovery action
INSERT INTO proxy (proxyid, name, mode, description, address, port) VALUES (99000, 'API active proxy for discovery action', 0, '', '' ,'');
...
-- discovery rules
INSERT INTO proxy (proxyid, name, mode, description, address, port) VALUES (99006, 'Api active proxy for discovery', 0, '', '', '');
