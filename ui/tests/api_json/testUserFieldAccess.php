...
class testUserFieldAccess extends CAPITest {
	...
	public static function data_get_user_properties() {
		...
		return [
			...
			'User denied full info via selectMedias on oneself' => [
				...
				'expected_result' => [
					['userid' => ':user:properties.user', 'medias' => self::getUserMediaFields(':user:properties.user', CUser::LIMITED_OUTPUT_MEDIA_FIELDS)]
				]
			],
			...
			'Admin denied full info via selectMedias on oneself' => [
				...
				'expected_result' => [
					['userid' => ':user:properties.admin', 'medias' => self::getUserMediaFields(':user:properties.admin', CUser::LIMITED_OUTPUT_MEDIA_FIELDS)]
				]
			],
	...
	public static function data_get_usergroup_properties() {
		...
		return [
			...
			'User is denied private field, only usrgrpid returned' => [
				'actor' => ':user:properties.user',
				'parameters' => [
			...
			'Admin is denied private field, only usrgrpid returned' => [
				'actor' => ':user:properties.admin',
				'parameters' => [
					'output' => ['userdirectoryid'],
					'userids' => ':user:properties.admin',
			...
			'Superadmin is not denied private field' => [
				'actor' => ':user:properties.superadmin',
				'parameters' => [
					'output' => ['userdirectoryid'],
					'userids' => ':user:properties.superadmin',
			...
			'User denied filter using private field' => [
				'actor' => ':user:properties.user',
				'parameters' => [
					'output' => ['usrgrpid'],
			...
			'Admin denied filter using private field' => [
				'actor' => ':user:properties.admin',
				'parameters' => [
					'output' => ['usrgrpid'],
					'filter' => ['userdirectoryid' => array_column(self::$usergroups, 'userdirectoryid')],
			...
			'User denied filter with private field' => [
				'actor' => ':user:properties.user',
				'parameters' => [
					'output' => ['usrgrpid'],
			...
			'Admin denied filter with private field' => [
				'actor' => ':user:properties.admin',
				'parameters' => [
					'output' => ['usrgrpid'],
			...
			'User denied filter by private field, but gets match with searchByAny on common field' => [
				'actor' => ':user:properties.user',
				'parameters' => [
					'output' => ['usrgrpid'],
					'filter' => self::getUsergroupFilter(':user:properties.user', 'userdirectoryid') + [
			...
			'Admin denied filter by private field, but gets match with searchByAny on common field' => [
				'actor' => ':user:properties.admin',
				'parameters' => [
					'output' => ['usrgrpid'],
					'filter' => self::getUsergroupFilter(':user:properties.admin', 'userdirectoryid') + [
			...
			'Search using private (not text) field ignored for user' => [
				'actor' => ':user:properties.user',
				'parameters' => [
					'output' => ['usrgrpid'],
					'search' => ['userdirectoryid' => array_column(self::$usergroups, 'userdirectoryid')],
					'sortfield' => ['usrgrpid']
				],
				'expected_result' => self::getUsergroupFields(':user:properties.user', ['usrgrpid'])
			],
			'Search using private (not text) field ignored for admin' => [
				'actor' => ':user:properties.admin',
				'parameters' => [
					'output' => ['usrgrpid'],
					'search' => ['userdirectoryid' => array_column(self::$usergroups, 'userdirectoryid')],
			...
			'Search using private (not text) field ignored for superadmin' => [
				'actor' => ':user:properties.superadmin',
				'parameters' => [
					'output' => 'extend',
					'filter' => ['usrgrpid' => array_column(self::$usergroups, 'usrgrpid')],
			...
			'User groups returned for non-match mix of private and common fields with searchByAny' => [
				'actor' => ':user:properties.user',
				'parameters' => [
					'output' => ['usrgrpid'],
					'search' => [
						'userdirectoryid' => array_column(self::$usergroups, 'userdirectoryid'),
						'usrgrpid' => '999999999'
					],
					'searchByAny' => true,
					'sortfield' => ['usrgrpid']
			...
			'Admin groups returned for non-match mix of private and common fields with searchByAny' => [
				'actor' => ':user:properties.admin',
				'parameters' => [
					'output' => ['usrgrpid'],
					'search' => [
			...
			'Superadmin gets all groups for non-match mix of private and common fields with searchByAny' => [
				'actor' => ':user:properties.superadmin',
				'parameters' => [
					'output' => 'extend',
					'filter' => ['usrgrpid' => array_column(self::$usergroups, 'usrgrpid')],
