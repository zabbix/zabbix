...
class CTimeUnitValidatorTest extends TestCase {
	public function dataProvider(): array {
		return [
			...
			['9126d',		['min' => null, 'max' => SEC_PER_YEAR],							'value must be less than or equal to 31536000s (365d)'],
			['9126d',		['min' => null, 'max' => SEC_PER_YEAR, 'with_year' => true],	'value must be less than or equal to 31536000s (1y)'],
			['0',			['min' => SEC_PER_YEAR, 'max' => null],							'value must be greater than or equal to 31536000s (365d)'],
			['0',			['min' => SEC_PER_YEAR, 'max' => null, 'with_year' => true],	'value must be greater than or equal to 31536000s (1y)']
		];
	}
