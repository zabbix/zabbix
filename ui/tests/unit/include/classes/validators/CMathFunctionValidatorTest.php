...
class CMathFunctionValidatorTest extends TestCase {
	...
	public function dataProvider() {
		return [
			...
			['count()', ['calculated' => true], ['rc' => false, 'error' => 'invalid number of parameters in function "count"']],
			['count(1)', ['calculated' => true], ['rc' => true, 'error' => null]],
			['count(1, 1)', ['calculated' => true], ['rc' => false, 'error' => 'invalid number of parameters in function "count"']],
	 ...
	 */
	public function testMathFunctionValidator(string $source, array $options, array $expected) {
		$expression_parser = new CExpressionParser();
		$math_function_validator = new CMathFunctionValidator([
			'parameters' => (new CMathFunctionData($options))->getParameters()
		]);
