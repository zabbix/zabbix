...
class CHistFunctionValidatorTest extends TestCase {
	...
	public function dataProvider() {
		return [
			...
			['avg(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "avg". Invalid second parameter.']],
			['avg(/host/key, #2147483647)', [], ['rc' => true, 'error' => null]],
			['avg(/host/key, #2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "avg". Invalid second parameter.']],
			['avg(/host/key, 2147483647)', [], ['rc' => true, 'error' => null]],
			['avg(/host/key, 2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "avg". Invalid second parameter.']],
			...
			['min(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "min". Invalid second parameter.']],
			['min(/host/key, #2147483647)', [], ['rc' => true, 'error' => null]],
			['min(/host/key, #2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "min". Invalid second parameter.']],
			['min(/host/key, 2147483647)', [], ['rc' => true, 'error' => null]],
			['min(/host/key, 2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "min". Invalid second parameter.']],
			...
			['max(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "max". Invalid second parameter.']],
			['max(/host/key, #2147483647)', [], ['rc' => true, 'error' => null]],
			['max(/host/key, #2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "max". Invalid second parameter.']],
			['max(/host/key, 2147483647)', [], ['rc' => true, 'error' => null]],
			['max(/host/key, 2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "max". Invalid second parameter.']],
			...
			['sum(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "sum". Invalid second parameter.']],
			['sum(/host/key, #2147483647)', [], ['rc' => true, 'error' => null]],
			['sum(/host/key, #2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "sum". Invalid second parameter.']],
			['sum(/host/key, 2147483647)', [], ['rc' => true, 'error' => null]],
			['sum(/host/key, 2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "sum". Invalid second parameter.']],
			...
			['last(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "last". Invalid second parameter.']],
			...
			['logseverity(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "logseverity". Invalid second parameter.']],
			...
			['logeventid(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "logeventid". Invalid second parameter.']],
			...
			['logsource(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "logsource". Invalid second parameter.']],
			...
			['count(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "count". Invalid second parameter.']],
			['count(/host/key, #2147483647)', [], ['rc' => true, 'error' => null]],
			['count(/host/key, #2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "count". Invalid second parameter.']],
			['count(/host/key, 2147483647)', [], ['rc' => true, 'error' => null]],
			['count(/host/key, 2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "count". Invalid second parameter.']],
			...
			['find(/host/key, #5:now/M)', [], ['rc' => false, 'error' => 'Incorrect usage of function "find". Invalid second parameter.']],
			['find(/host/key, #2147483647)', [], ['rc' => true, 'error' => null]],
			['find(/host/key, #2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "find". Invalid second parameter.']],
			['find(/host/key, 2147483647)', [], ['rc' => true, 'error' => null]],
			['find(/host/key, 2147483648)', [], ['rc' => false, 'error' => 'Incorrect usage of function "find". Invalid second parameter.']],
			...
			['forecast(/host/key, #5:now/M, 1w)', [], ['rc' => false, 'error' => 'Incorrect usage of function "forecast". Invalid second parameter.']],
			...
			['timeleft(/host/key, #5:now/M, 1w)', [], ['rc' => false, 'error' => 'Incorrect usage of function "timeleft". Invalid second parameter.']],
			...
			['avg_foreach(/host/key, 1)', ['calculated' => true], ['rc' => false, 'error' => 'Incorrect usage of function "avg_foreach". Invalid second parameter.']],
			['avg_foreach(/host/key, 1h)', ['calculated' => true], ['rc' => false, 'error' => 'Incorrect usage of function "avg_foreach". Invalid second parameter.']],
			['avg_foreach(/host/key, 1h:now-1h)', ['calculated' => true], ['rc' => true, 'error' => null]],
			['avg_foreach(/host/key, 1d:now-1h)', ['calculated' => true], ['rc' => true, 'error' => null]],
			['avg_foreach(/host/key, 1y:now/M-1h)', ['calculated' => true], ['rc' => true, 'error' => null]],
			['avg_foreach(/host/key, {$PERIOD}:{$TIMESHIFT})', ['calculated' => true], ['rc' => true, 'error' => null]],
			['avg_foreach(/host/key, {$PERIOD}:now-{$TIMESHIFT})', ['calculated' => true], ['rc' => true, 'error' => null]],
			...
			['avg_foreach(/host/key, 1y:now/y,)', ['calculated' => true], ['rc' => false, 'error' => 'Incorrect usage of function "avg_foreach". Invalid number of parameters.']],
			...
			['last_foreach(/host/key, 1)', ['calculated' => true], ['rc' => false, 'error' => 'Incorrect usage of function "last_foreach". Invalid second parameter.']],
			['last_foreach(/host/key, 1h)', ['calculated' => true], ['rc' => false, 'error' => 'Incorrect usage of function "last_foreach". Invalid second parameter.']],
			['last_foreach(/host/key, 1h:now-1h)', ['calculated' => true], ['rc' => true, 'error' => null]],
			['last_foreach(/host/key, 1d:now-1h)', ['calculated' => true], ['rc' => true, 'error' => null]],
			['last_foreach(/host/key, 1y:now/M-1h)', ['calculated' => true], ['rc' => true, 'error' => null]],
			['last_foreach(/host/key, {$PERIOD}:{$TIMESHIFT})', ['calculated' => true], ['rc' => true, 'error' => null]],
			['last_foreach(/host/key, {$PERIOD}:now-{$TIMESHIFT})', ['calculated' => true], ['rc' => true, 'error' => null]],
			...
			['last_foreach(/host/key, 1y:now/y,)', ['calculated' => true], ['rc' => false, 'error' => 'Incorrect usage of function "last_foreach". Invalid number of parameters.']]
		];
	}
