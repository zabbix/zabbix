...
class function_formatFloatTest extends TestCase {
	...
	public static function dataProvider() {
		return [
			...
			[PHP_FLOAT_MIN,			[],	'2E-308'],
			[-PHP_FLOAT_MIN,		[],	'-2E-308'],
			[PHP_FLOAT_MAX,			[],	'2E+308'],
			[-PHP_FLOAT_MAX,		[],	'-2E+308'],

			[0.1,					['decimals' => 2],	'0.1'],
			[0.11,					['decimals' => 2],	'0.11'],
			[0.111,					['decimals' => 2],	'0.11'],
			[0.01,					['decimals' => 2],	'0.01'],
			[0.011,					['decimals' => 2],	'0.011'],
			[0.0111,				['decimals' => 2],	'0.011'],
			[0.9,					['decimals' => 2],	'0.9'],
			[0.99,					['decimals' => 2],	'0.99'],
			[0.999,					['decimals' => 2],	'1'],
			[0.09,					['decimals' => 2],	'0.09'],
			[0.099,					['decimals' => 2],	'0.099'],
			[0.0999,				['decimals' => 2],	'0.1'],
			[0,						['decimals' => 4],	'0'],
			[1.1,					['decimals' => 4],	'1.1'],
			...
			[PHP_FLOAT_MIN,			['decimals' => 2],	'2.23E-308'],
			[-PHP_FLOAT_MIN,		['decimals' => 2],	'-2.23E-308'],
			[PHP_FLOAT_MAX,			['decimals' => 2],	'1.8E+308'],
			[-PHP_FLOAT_MAX,		['decimals' => 2],	'-1.8E+308'],
			...
			[0.0129,				['precision' => 4, 'decimals' => 2],	'0.013'],
			[0.00129,				['precision' => 4, 'decimals' => 2],	'0.0013'],
			[0.000129,				['precision' => 4, 'decimals' => 2],	'0.00013'],
			[0.0000129,				['precision' => 4, 'decimals' => 2],	'1.29E-5'],
			...
			[0.1,					['decimals' => 2, 'decimals_exact' => true],	'0.10'],
			[0.11,					['decimals' => 2, 'decimals_exact' => true],	'0.11'],
			[0.111,					['decimals' => 2, 'decimals_exact' => true],	'0.11'],
			[0.01,					['decimals' => 2, 'decimals_exact' => true],	'0.01'],
			[0.011,					['decimals' => 2, 'decimals_exact' => true],	'1.10E-2'],
			[0.0111,				['decimals' => 2, 'decimals_exact' => true],	'1.11E-2'],
			[0.9,					['decimals' => 2, 'decimals_exact' => true],	'0.90'],
			[0.99,					['decimals' => 2, 'decimals_exact' => true],	'0.99'],
			[0.999,					['decimals' => 2, 'decimals_exact' => true],	'1.00'],
			[0.09,					['decimals' => 2, 'decimals_exact' => true],	'0.09'],
			[0.099,					['decimals' => 2, 'decimals_exact' => true],	'9.90E-2'],
			[0.0999,				['decimals' => 2, 'decimals_exact' => true],	'9.99E-2'],
			...
			[PHP_FLOAT_MIN,			['decimals' => 2, 'decimals_exact' => true],	'2.23E-308'],
			[-PHP_FLOAT_MIN,		['decimals' => 2, 'decimals_exact' => true],	'-2.23E-308'],
			[PHP_FLOAT_MAX,			['decimals' => 2, 'decimals_exact' => true],	'1.80E+308'],
			[-PHP_FLOAT_MAX,		['decimals' => 2, 'decimals_exact' => true],	'-1.80E+308'],
			...
			[PHP_FLOAT_MIN,			['small_scientific' => false],	'0'],
			[-PHP_FLOAT_MIN,		['small_scientific' => false],	'0'],
			[PHP_FLOAT_MAX,			['small_scientific' => false],	'2E+308'],
			[-PHP_FLOAT_MAX,		['small_scientific' => false],	'-2E+308'],
