			...
			[
				[
					...
					'api_list' => [
						...
						'module.update', 'problem.get', 'proxy.create', 'proxy.delete', 'proxy.get', 'proxy.update',
						'proxygroup.create', 'proxygroup.delete', 'proxygroup.get', 'proxygroup.update','regexp.create',
