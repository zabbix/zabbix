			...
			[
				[
					...
					'api_list' => [
						...
						'host.get', 'hostdashboard.get', 'hostgroup.get', 'hostinterface.get', 'hostprototype.get', 'housekeeping.get',
						'httptest.get', 'iconmap.get', 'image.get', 'item.get', 'itemprototype.get', 'maintenance.get', 'map.create',
			...
			[
				[
					...
					'api_list' => [
						...
						'host.get', 'host.massadd',	'host.massremove', 'host.massupdate', 'host.update', 'hostdashboard.get',
						'hostgroup.delete','hostgroup.get', 'hostgroup.massadd', 'hostgroup.massremove', 'hostgroup.massupdate',
			...
			[
				[
					...
					'api_list' => [
						...
						'host.massadd', 'host.massremove', 'host.massupdate', 'host.update', 'hostdashboard.get',
						'hostgroup.create', 'hostgroup.delete', 'hostgroup.get', 'hostgroup.massadd', 'hostgroup.massremove',
