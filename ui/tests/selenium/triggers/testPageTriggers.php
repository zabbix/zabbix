		...
		return [
			...
			[
				[
					...
					'result' => [
						['text' => 'Dependent trigger ONE', 'selector' => 'xpath:./a[@class="js-trigger-edit wordbreak"]'],
						['text' => 'Discovered trigger one', 'selector' => 'xpath:./a[@class="js-trigger-edit wordbreak"]'],
						['text' => 'Inheritance trigger with tags', 'selector' => 'xpath:./a[@class="js-trigger-edit wordbreak"]'],
				...
				[
					...
					'result' => [
						[
							...
							'Name' => ['text' => 'Dependent trigger ONE', 'selector' => 'xpath:./a[@class="js-trigger-edit wordbreak"]']
						],
						[
							'Host' => 'Host for triggers filtering',
							'Name' => ['text' => 'Discovered trigger one', 'selector' => 'xpath:./a[@class="js-trigger-edit wordbreak"]']
						],
						[
							'Host' => 'Host for triggers filtering',
							'Name' => ['text' => 'Inheritance trigger with tags', 'selector' => 'xpath:./a[@class="js-trigger-edit wordbreak"]']
						],
						[
							'Host' => 'Host for triggers filtering',
