				...
				[
					...
					'result' => [
						[
							...
							'Name' => ['text' => 'Dependent trigger ONE', 'selector' => 'xpath:./a[@class="js-trigger-edit wordwrap"]']
						],
						[
							'Host' => 'Host for triggers filtering',
							'Name' => ['text' => 'Discovered trigger one', 'selector' => 'xpath:./a[@class="js-trigger-edit wordwrap"]']
						],
						[
							'Host' => 'Host for triggers filtering',
