...
require_once dirname(__FILE__).'/dataDisplay/testDataDisplayInGraphs.php';
// require_once dirname(__FILE__).'/dataDisplay/testDataDisplayInWidgets.php';
...
//		$suite->addTestSuite('testDataDisplayInWidgets');
