...
require_once dirname(__FILE__).'/testFormHostsFilterSave.php';
...
require_once dirname(__FILE__).'/testFormProblemsFilterSave.php';
...
//		$suite->addTestSuite('testFormAdministrationGeneralImages');
		...
		$suite->addTestSuite('testFormHostsFilterSave');
		...
		$suite->addTestSuite('testFormProblemsFilterSave');
