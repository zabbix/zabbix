		...
		return [
			...
			[
				[
					'replace' => true,
					'db' => 'SELECT * FROM hstgrp',
					'link' => 'zabbix.php?action=hostgroup.edit&groupid={groupid}'
				]
			],
			...
			[
				[
					'replace' => true,
					'db' => 'SELECT * FROM graphs',
					'link' => 'graphs.php?hostid={hostid}&form=create&context=host',
					'incorrect_request' => true
				]
			],
		...
		return [
			...
			[
				[
					'token' => true,
					'replace' => true,
					'token_url' => 'graphs.php?hostid={hostid}&form=create&context=host',
					'db' => 'SELECT * FROM graphs',
