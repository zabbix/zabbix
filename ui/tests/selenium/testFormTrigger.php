		...
		if (isset($data['constructor'])) {
			...
			if (isset($constructor['errors']) && !array_key_exists('elementError', $constructor)) {
				...
				if (isset($constructor['elementError'])) {
					...
					$this->assertEquals($count, $this->query('xpath://a[@class="icon-info zi-i status-red"]')->all()->count());
					...
					$this->zbxTestAssertElementNotPresentXpath('//a[@class="icon-info zi-i status-red"]');
				}
			}
		}
