...
INSERT INTO items (itemid, type, hostid, name, key_, description) VALUES (400700, 0, 99130, 'Test DNS macro', 'dns_macro', 'The item is needed for dynamic host check. Hosts without items do not appear in the search');
