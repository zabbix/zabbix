...
-- test discovery rule
INSERT INTO drules (druleid, proxy_hostid, name, iprange, delay, status) VALUES (3, NULL, 'External network', '192.168.3.1-255', 600, 0, 0);
...
INSERT INTO drules (druleid, proxy_hostid, name, iprange, delay, status) VALUES (4, 20003, 'Discovery rule for update', '192.14.3.1-255', 600, 0, 0);
...
INSERT INTO drules (druleid, proxy_hostid, name, iprange, delay, status) VALUES (5, 20003, 'Disabled discovery rule for update', '192.15.3.1-255', 600, 0, 1);
...
INSERT INTO drules (druleid, proxy_hostid, name, iprange, delay, status) VALUES (6, 20003, 'Discovery rule to check delete', '192.16.3.1-255', 600, 0, 1);
