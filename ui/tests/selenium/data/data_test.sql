...
INSERT INTO items (itemid, type, hostid, name, description, key_, delay, interfaceid, params, formula, url, posts, query_fields, headers) VALUES (990070, 2, 90001, 'Master Item', '', 'graph[1]', 0, NULL, '', '', 'zabbix.com', '', '','');
