...
class Actions {
	...
	public static function load() {
		...
		DBexecute("INSERT INTO alerts (alertid, actionid, eventid, userid, clock, mediatypeid, sendto, subject, ".
			...
			zbx_dbstr($actionids['Trigger action 2']).", 101, 1, 1329724800, 1, 'igor.danoshaites@zabbix.com',".
		...
		DBexecute("INSERT INTO alerts (alertid, actionid, eventid, userid, clock, mediatypeid, sendto, subject, ".
			...
			zbx_dbstr($actionids['Trigger action 2']).", 101, 1, 1329724810, 1, 'igor.danoshaites@zabbix.com', ".
		...
		DBexecute("INSERT INTO alerts (alertid, actionid, eventid, userid, clock, mediatypeid, sendto, subject,"
			...
			zbx_dbstr($actionids['Trigger action 2']).", 101, 1, 1329724820, 1, 'igor.danoshaites@zabbix.com',".
		...
		DBexecute("INSERT INTO alerts (alertid, actionid, eventid, userid, clock, mediatypeid, sendto, subject, ".
			...
			zbx_dbstr($actionids['Trigger action 2']).", 101, 1, 1329724830, 1, 'igor.danoshaites@zabbix.com',".
		...
		DBexecute("INSERT INTO alerts (alertid, actionid, eventid, userid, clock, mediatypeid, sendto, subject,".
			...
			zbx_dbstr($actionids['Trigger action 2']).", 101, 1, 1329724840, 1, 'igor.danoshaites@zabbix.com', ".
		...
		DBexecute("INSERT INTO alerts (alertid, actionid, eventid, userid, clock, mediatypeid, sendto, subject, ".
			...
			zbx_dbstr($actionids['Trigger action 3']).", 101, 1, 1597439400, 3, 'igor.danoshaites@zabbix.com',".
