...
class DiscoveredHosts {
	...
	public static function load() {
		...
		DBexecute("INSERT INTO group_discovery (group_discoveryid, groupid, parent_group_prototypeid, name, lastcheck, ts_delete) VALUES(1, ".
				zbx_dbstr(self::DISCOVERED_GROUPID).", ".$group_prototypeid.", ".zbx_dbstr(self::DISCOVERED_GROUP).", '1672831234', '1677670843')"
		);
		DBexecute("INSERT INTO group_discovery (group_discoveryid, groupid, parent_group_prototypeid, name, lastcheck, ts_delete) VALUES(2, ".
