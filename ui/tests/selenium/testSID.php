...
class testSID extends CWebTest {
	...
	public static function getLinksData() {
		return [
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=tabfilter.profile.update&value_int=1&'.
							'idx=web.monitoring.hosts.selected'
				]
			],
			// Monitoring hosts, tab filter collapse.
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=tabfilter.profile.update&value_int=0&'.
							'idx=web.monitoring.hosts.expanded'
				]
			],
			[
				[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=tabfilter.profile.update&value_str=0%2C2%2C1&'.
							'idx=web.monitoring.hosts.taborder'
				]
			],
			[
				[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=popup.tabfilter.update&idx=web.monitoring.hosts&'.
							'idx2=1&create=0&support_custom_time=0&filter_name=Untitled'
				]
			],
			[
				[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=popup.tabfilter.delete&idx=web.monitoring.hosts&idx2=1'
				]
			],
			[
				[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=tabfilter.profile.update&value_int=1&'.
							'idx=web.monitoring.problem.selected'
				]
			],
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=tabfilter.profile.update&value_int=0&'.
							'idx=web.monitoring.problem.expanded'
				]
			],
			[
				[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=tabfilter.profile.update&'.
							'value_str=0%2C2%2C1%2C3&idx=web.monitoring.problem.taborder'
				]
			],
			[
				[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=popup.tabfilter.update&idx=web.monitoring.problem&'.
							'idx2=1&create=0&support_custom_time=1&filter_name=Untitled_2'
				]
			],
			[
				[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&action=popup.tabfilter.delete&idx=web.monitoring.problem&idx2=1'
				]
			],
			[
				[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&form_refresh=1&action=popup.massupdate.host&'.
							'ids%5B0%5D=50011&ids%5B1%5D=50012&tls_accept=0&update=1&location_url=hosts.php&'.
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&form_refresh=1&ids%5B0%5D=99086&ids%5B1%5D=99091&'.
							'action=popup.massupdate.item&prototype=0&update=1&location_url=items.php%3Fcontext%3Dhost&'.
							'context=host&visible%5Bstatus%5D=1&status=1'
				]
			],
			[
				[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&form_refresh=1&action=popup.massupdate.template&update=1&'.
							'ids%5B0%5D=10076&ids%5B1%5D=10207&location_url=templates.php&visible%5Bdescription%5D=1&'.
							'description=%2C'
				]
			],
			[
			...
			[
				[
					'link' => 'zabbix.php?sid=test111116666666&form_refresh=1&action=popup.massupdate.trigger&'.
							'ids%5B0%5D=100034&ids%5B1%5D=100036&update=1&location_url=triggers.php%3Fcontext%3Dhost&'.
							'context=host&visible%5Bmanual_close%5D=1&manual_close=1'
				]
			],
			[
				[
