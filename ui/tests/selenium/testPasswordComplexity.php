...
class testPasswordComplexity extends CWebTest {
	...
	/**
	 * Check user changes his/her own password accordingly to complexity rules.
	 *
	 * @dataProvider getCommonPasswordData
	 * @dataProvider getUserPasswordData
	 */
	...
	/**
	 * Check Admin changes his/her own password accordingly to complexity rules.
	 *
	 * @dataProvider getCommonPasswordData
	 ...
	 * @param $own      $own               true if user changes his/her password oneself
	 */
