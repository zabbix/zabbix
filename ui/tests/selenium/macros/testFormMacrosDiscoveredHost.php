...
class testFormMacrosDiscoveredHost extends testFormMacros {
	...
	const DISCOVERED_HOST_UPDATE = 'Discovered host with macros {#KEY} for update';
	...
	const DISCOVERED_HOST_REMOVE = 'Discovered host with macros {#KEY} for remove';
	...
	const DISCOVERED_INHERIT_HOSTID = 90000086;
	const DISCOVERED_INHERIT_INTERFACEID = 90000087;
	const DISCOVERED_INHERIT_HOST_GROUPID = 90000088;
	...
	public function prepareDiscoveredHostMacrosData() {
		...
		// Create discovery rules.
		$inherit_lldids = CDataHelper::call('discoveryrule.create', [
			[
		...
		$host_prototypes = CDataHelper::call('hostprototype.create', [
			...
			[
				'host' => self::DISCOVERED_HOST_REMOVE,
				'ruleid' => $lldid,
				'groupLinks' => [['groupid' => 4]],
				'macros' => [
					[
			...
			[
				'host' => self::DISCOVERED_HOST_INHERIT,
		...
		$host_prototype_inherit_id = $host_prototypes['hostids'][2];
		...
		DBexecute("INSERT INTO hostmacro (hostmacroid, hostid, macro, value, description, automatic) VALUES (990108, "
				.zbx_dbstr(self::DISCOVERED_INHERIT_HOSTID).", '\{\$PROTO_MACRO\}', 'host_macro_value', '', 1)"
		);
		DBexecute("INSERT INTO hostmacro (hostmacroid, hostid, macro, value, description, automatic, type) VALUES (990109, "
				.zbx_dbstr(self::DISCOVERED_INHERIT_HOSTID).", '\{\$PROTO_SECRET\}', 'host_macro_secret', '', 1, 1)"
		);
		DBexecute("INSERT INTO hostmacro (hostmacroid, hostid, macro, value, description, automatic, type) VALUES (990110, "
				.zbx_dbstr(self::DISCOVERED_INHERIT_HOSTID).", '\{\$PROTO_VAULT\}', 'host_macro_vault', '', 1, 2)"
		);
	}
...
//			]
	...
	public function testFormMacrosDiscoveredHost_Update($data) {
		$this->checkMacros($data, 'host', self::DISCOVERED_HOST_UPDATE, true);
	}
	 ...
	 */
	public function testFormMacrosDiscoveredHost_ResolveSecretMacro($data) {
