...
class testPageServicesServices extends CWebTest {
	...
	private function cancelDelete($mass = false) {
		...
		if ($mass) {
			...
			$table->findRow('Name', $name)->query('xpath:.//button[contains(@class, "js-delete-service")]')->one()
	...
	public function testPageServicesServices_DeleteParentFromRow() {
		...
		$table->findRow('Name', $name, true)->query('xpath:.//button[contains(@class, "js-delete-service")]')->one()
				->waitUntilClickable()->click();
