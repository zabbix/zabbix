...
class testFormUserLdapMediaJit extends CWebTest {
	...
	public function prepareJitMedia() {
		...
		CDataHelper::call('authentication.update', [
				'authentication_type' => SMTP_AUTHENTICATION_PASSWORD,
