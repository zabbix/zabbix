...
define('ZABBIX_DB_VERSION',		5030051);
...
define('ZBX_STYLE_DASHBRD_NAVIGATION_TABS', 'dashbrd-navigation-tabs');
define('ZBX_STYLE_DASHBRD_PREVIOUS_PAGE', 'dashbrd-previous-page');
define('ZBX_STYLE_DASHBRD_NEXT_PAGE', 'dashbrd-next-page');
define('ZBX_STYLE_DASHBRD_TOGGLE_SLIDESHOW', 'dashbrd-toggle-slideshow');
