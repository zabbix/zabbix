...
define('ZABBIX_DB_VERSION',		6010025);
...
define('ZBX_MACRO_DISCOVERY_MANUAL', 0); // Macro value controlled by user.
define('ZBX_MACRO_DISCOVERY_AUTOMATIC', 1); // Macro value controlled by discovery rule.
