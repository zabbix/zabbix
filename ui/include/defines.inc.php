...
define('ZBX_STYLE_BTN_DASHBOARD_CONF', 'btn-dashbrd-conf');
define('ZBX_STYLE_BTN_DASHBOARD_NORMAL', 'btn-dashbrd-normal');
...
define('ZBX_STYLE_DASHBOARD', 'dashbrd');
define('ZBX_STYLE_DASHBOARD_IS_MULTIPAGE', 'dashbrd-is-multipage');
define('ZBX_STYLE_DASHBOARD_IS_EDIT_MODE', 'dashbrd-is-edit-mode');
define('ZBX_STYLE_DASHBOARD_GRID', 'dashbrd-grid-container');
define('ZBX_STYLE_DASHBOARD_NAVIGATION', 'dashbrd-navigation');
define('ZBX_STYLE_DASHBOARD_NAVIGATION_CONTROLS', 'dashbrd-navigation-controls');
define('ZBX_STYLE_DASHBOARD_NAVIGATION_TABS', 'dashbrd-navigation-tabs');
define('ZBX_STYLE_DASHBOARD_PREVIOUS_PAGE', 'dashbrd-previous-page');
define('ZBX_STYLE_DASHBOARD_NEXT_PAGE', 'dashbrd-next-page');
define('ZBX_STYLE_DASHBOARD_TOGGLE_SLIDESHOW', 'dashbrd-toggle-slideshow');
define('ZBX_STYLE_DASHBOARD_WIDGET', 'dashbrd-widget');
define('ZBX_STYLE_DASHBOARD_WIDGET_FLUID', 'dashbrd-widget-fluid');
define('ZBX_STYLE_DASHBOARD_WIDGET_HEAD', 'dashbrd-widget-head');
define('ZBX_STYLE_DASHBOARD_WIDGET_FOOT', 'dashbrd-widget-foot');
define('ZBX_STYLE_DASHBOARD_EDIT', 'dashbrd-edit');
define('ZBX_STYLE_DASHBOARD_WIDGET_GRAPH_LINK', 'dashbrd-widget-graph-link');
