...
if ($data['can_edit_source_timeouts'] && (($data['limited'] && !$data['has_custom_timeout']) || !$data['limited'])) {
...
$item_tab->addItem([
	...
	(new CFormField([
		(new CTextBox('timeout', $data['timeout'], $data['limited'] || !$data['has_custom_timeout']))
			->setWidth(ZBX_TEXTAREA_SMALL_WIDTH)
			->setAriaRequired(),
		!$data['limited']
