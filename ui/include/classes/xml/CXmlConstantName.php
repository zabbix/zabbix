...
class CXmlConstantName {
	...
	public const GLOBAL_REGEX_TYPE_INCLUDED = 'EXPRESSION_TYPE_INCLUDED';
	public const GLOBAL_REGEX_TYPE_ANY_INCLUDED = 'EXPRESSION_TYPE_ANY_INCLUDED';
	public const GLOBAL_REGEX_TYPE_NOT_INCLUDED = 'EXPRESSION_TYPE_NOT_INCLUDED';
	public const GLOBAL_REGEX_TYPE_TRUE = 'EXPRESSION_TYPE_TRUE';
	public const GLOBAL_REGEX_TYPE_FALSE = 'EXPRESSION_TYPE_FALSE';
}
