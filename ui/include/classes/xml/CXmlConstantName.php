...
class CXmlConstantName {
	...
	const APM_SIGNAL_TYPE_TRACES = 'APM_TRACES';
	const APM_SIGNAL_TYPE_METRICS = 'APM_METRICS';
	const APM_SIGNAL_TYPE_LOGS = 'APM_LOGS';

	const APM_METRICS_POINT_TYPE_SUM = 'SUM';
	const APM_METRICS_POINT_TYPE_GAUGE = 'GAUGE';
	const APM_METRICS_POINT_TYPE_HISTOGRAM = 'HISTOGRAM';
	const APM_METRICS_POINT_TYPE_EXPHISTOGRAM = 'EXP_HISTOGRAM';
