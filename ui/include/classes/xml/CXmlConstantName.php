...
class CXmlConstantName {
	...
	const DASHBOARD_WIDGET_CLOCK = 'CLOCK';
	const DASHBOARD_WIDGET_GRAPH_CLASSIC = 'GRAPH_CLASSIC';
	const DASHBOARD_WIDGET_GRAPH_PROTOTYPE = 'GRAPH_PROTOTYPE';
	const DASHBOARD_WIDGET_PLAIN_TEXT = 'PLAIN_TEXT';
	const DASHBOARD_WIDGET_URL = 'URL';

	const DASHBOARD_FIELD_TYPE_INTEGER = 'INTEGER';
	const DASHBOARD_FIELD_TYPE_STRING = 'STRING';
	const DASHBOARD_FIELD_TYPE_HOST = 'HOST';
	const DASHBOARD_FIELD_TYPE_ITEM = 'ITEM';
	const DASHBOARD_FIELD_TYPE_ITEM_PROTOTYPE = 'ITEM_PROTOTYPE';
	const DASHBOARD_FIELD_TYPE_GRAPH = 'GRAPH';
	const DASHBOARD_FIELD_TYPE_GRAPH_PROTOTYPE = 'GRAPH_PROTOTYPE';
}
