...
class CXmlConstantValue {
	...
	const DASHBOARD_WIDGET_TYPE_CLOCK = CWidget::CLOCK;
	const DASHBOARD_WIDGET_TYPE_GRAPH_CLASSIC = CWidget::GRAPH;
	const DASHBOARD_WIDGET_TYPE_GRAPH_PROTOTYPE = CWidget::GRAPH_PROTOTYPE;
	const DASHBOARD_WIDGET_TYPE_ITEM = CWidget::ITEM;
	const DASHBOARD_WIDGET_TYPE_PLAIN_TEXT = CWidget::PLAIN_TEXT;
	const DASHBOARD_WIDGET_TYPE_URL = CWidget::URL;
