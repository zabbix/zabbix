...
class CXmlConstantValue {
	...
	const AGGREGATE_MIN = AGGREGATE_MIN;
	const AGGREGATE_MAX = AGGREGATE_MAX;
	const AGGREGATE_AVG = AGGREGATE_AVG;
	const AGGREGATE_COUNT = AGGREGATE_COUNT;
	const AGGREGATE_SUM = AGGREGATE_SUM;
	const AGGREGATE_PERCENTILE = AGGREGATE_PERCENTILE;
	...
	const ITEM_TYPE_NESTED = ITEM_TYPE_NESTED;
	const ITEM_TYPE_TELEMETRY_QUERY = ITEM_TYPE_TELEMETRY_QUERY;

	const TQ_SIGNAL_TYPE_TRACES = CItemTypeTelemetryQuery::SIGNAL_TYPE_TRACES;
	const TQ_SIGNAL_TYPE_METRICS = CItemTypeTelemetryQuery::SIGNAL_TYPE_METRICS;
	const TQ_SIGNAL_TYPE_LOGS = CItemTypeTelemetryQuery::SIGNAL_TYPE_LOGS;

	const TQ_METRICS_POINT_TYPE_SUM = CItemTypeTelemetryQuery::METRICS_POINT_SUM;
	const TQ_METRICS_POINT_TYPE_GAUGE = CItemTypeTelemetryQuery::METRICS_POINT_GAUGE;
	const TQ_METRICS_POINT_TYPE_HISTOGRAM = CItemTypeTelemetryQuery::METRICS_POINT_HISTOGRAM;
	const TQ_METRICS_POINT_TYPE_EXPONENTIAL_HISTOGRAM = CItemTypeTelemetryQuery::METRICS_POINT_EXPONENTIAL_HISTOGRAM;
	...
	const MEDIA_TYPE_PUSH = MEDIA_TYPE_PUSH;
	...
	const SMTP_AUTHENTICATION_PASSWORD = SMTP_AUTHENTICATION_PASSWORD;
	const SMTP_AUTHENTICATION_OAUTH = SMTP_AUTHENTICATION_OAUTH;
	...
	const MACRO_CONFIG_TYPE_NOCONF = ZBX_WIZARD_FIELD_NOCONF;
	const MACRO_CONFIG_TYPE_TEXT = ZBX_WIZARD_FIELD_TEXT;
	const MACRO_CONFIG_TYPE_LIST = ZBX_WIZARD_FIELD_LIST;
	const MACRO_CONFIG_TYPE_CHECKBOX = ZBX_WIZARD_FIELD_CHECKBOX;
	...
	const LLD_OVERRIDE_OPERATION_OBJECT_LLD_RULE_PROTOTYPE = OPERATION_OBJECT_LLD_RULE_PROTOTYPE;
	...
	const CONDITION_OPERATOR_EXISTS = CONDITION_OPERATOR_EXISTS;
	...
	const DASHBOARD_WIDGET_FIELD_TYPE_GROUP = ZBX_WIDGET_FIELD_TYPE_GROUP;
	...
	public const REGEX_TYPE_CONTAINS_STRING = REGEX_TYPE_CONTAINS_STRING;
	public const REGEX_TYPE_CONTAINS_ANY_SUBSTRING = REGEX_TYPE_CONTAINS_ANY_SUBSTRING;
	public const REGEX_TYPE_NOT_CONTAINS_STRING = REGEX_TYPE_NOT_CONTAINS_STRING;
	public const REGEX_TYPE_MATCHES_REGEX = REGEX_TYPE_MATCHES_REGEX;
	public const REGEX_TYPE_NOT_MATCHES_REGEX = REGEX_TYPE_NOT_MATCHES_REGEX;
}
