...
class CXmlConstantValue {
	...
	const APM_SIGNAL_TYPE_TRACES = APM_SIGNAL_TYPE_TRACES;
	const APM_SIGNAL_TYPE_METRICS = APM_SIGNAL_TYPE_METRICS;
	const APM_SIGNAL_TYPE_LOGS = APM_SIGNAL_TYPE_LOGS;

	const APM_METRICS_POINT_TYPE_SUM = APM_METRICS_POINT_SUM;
	const APM_METRICS_POINT_TYPE_GAUGE = APM_METRICS_POINT_GAUGE;
	const APM_METRICS_POINT_TYPE_HISTOGRAM = APM_METRICS_POINT_HISTOGRAM;
	const APM_METRICS_POINT_TYPE_EXPHISTOGRAM = APM_METRICS_POINT_EXPHISTOGRAM;
