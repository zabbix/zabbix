...
// Tags filter list.
$form_list->addRow(CWidgetHelper::getLabel($fields['host_tags']), CWidgetHelper::getTags($fields['host_tags']));
$scripts[] = $fields['host_tags']->getJavascript();
$jq_templates['tag-row-tmpl'] = CWidgetHelper::getTagsTemplate($fields['host_tags']);
