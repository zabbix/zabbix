...
class CWidgetFormGeoMap extends CWidgetForm {
	...
	public function __construct($data, $templateid) {
		...
		// Default view.
		$field_default_view = (new CWidgetFieldLatLng('default_view', _('Default view')))
			->setHelpText(_('Comma separated center coordinates to display when the widget is initially loaded.'));
