...
use Zabbix\Widgets\Fields\CWidgetFieldItemPatternSelect;

class CWidgetFieldItemPatternSelectView extends CWidgetFieldView {

	private string $placeholder = '';

	public function __construct(CWidgetFieldItemPatternSelect $field) {
		$this->field = $field;
	}
