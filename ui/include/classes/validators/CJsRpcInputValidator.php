...
class CJsRpcInputValidator {
	...
	public static function validate(array $data): bool {
		...
		$rules = ['type' => API_OBJECT, 'flags' => API_ALLOW_UNEXPECTED, 'fields' => [
			'method' => ['type' => API_STRING_UTF8, 'flags' => API_REQUIRED, 'in' => implode(',', ['search',
				...
				'item_value_type.get', 'item_prototype_value_type.get', 'get_scripts_by_hosts', 'get_scripts_by_events',
				'link_thresholds.validate'
			])]
		]];
	...
	/**
	 * Validate the input parameters for "item_value_type.get" and "item_prototype_value_type.get".
	 *
	 * @param array $data  Input data to validate.
	 *
	 * @return bool
	...
	private static function validateItemValueTypeGet(array $data): bool {
		...
		$rules = ['type' => API_OBJECT, 'fields' => [
			'method' => ['type' => API_STRING_UTF8, 'flags' => API_REQUIRED, 'in' => implode(',', [
				'item_value_type.get', 'item_prototype_value_type.get'
			])],
			'type' => ['type' => API_INT32, 'flags' => API_REQUIRED, 'in' => PAGE_TYPE_TEXT_RETURN_JSON],
			'itemid' => ['type' => API_ID]
		]];
