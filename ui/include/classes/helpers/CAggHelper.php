...
class CAggHelper {
	 ...
	 * @param string           $units
	 * @param array            $options
	 * @param bool             $options['force_units']		Whether to keep units despite the aggregation function
	 *                                 						not supporting it.
	 * @param bool             $options['trim']				Whether to trim non-numeric value to a length of 20 characters.
	 * @param array            $options['valuemap']
	 * @param array            $options['convert_options']	Options for unit conversion. See @convertUnitsRaw.
	 *
	 * @return array
	 */
