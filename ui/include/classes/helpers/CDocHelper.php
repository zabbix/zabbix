...
class CDocHelper {
	...
	const ADMINISTRATION_AUDIT_SETTINGS_EDIT =				'web_interface/frontend_sections/administration/audit_log';
	const ADMINISTRATION_AUTHENTICATION_EDIT =				'web_interface/frontend_sections/users/authentication';
	...
	const ADMINISTRATION_MEDIATYPE_LIST =					'web_interface/frontend_sections/alerts/mediatypes';
	...
	const ADMINISTRATION_SCRIPT_EDIT =						'web_interface/frontend_sections/alerts/scripts#configuring-a-global-script';
	const ADMINISTRATION_SCRIPT_LIST =						'web_interface/frontend_sections/alerts/scripts';
	const ADMINISTRATION_TOKEN_LIST =						'web_interface/frontend_sections/users/api_tokens';
	...
	const ADMINISTRATION_USER_LIST =						'web_interface/frontend_sections/users/user_list';
	...
	const ADMINISTRATION_USERGROUP_LIST =					'web_interface/frontend_sections/users/user_groups';
	const ADMINISTRATION_USERPROFILE_EDIT =					'web_interface/user_profile#user-profile';
	const ADMINISTRATION_USERROLE_EDIT =					'web_interface/frontend_sections/users/user_roles#default-user-roles';
	const ADMINISTRATION_USERROLE_LIST =					'web_interface/frontend_sections/users/user_roles';
	const CONFIGURATION_ACTION_EDIT =						'config/notifications/action#configuring-an-action';
	const CONFIGURATION_ACTION_LIST =						'web_interface/frontend_sections/alerts/actions';
	const CONFIGURATION_CORRELATION_EDIT =					'config/event_correlation/global#configuration';
	const CONFIGURATION_CORRELATION_LIST =					'web_interface/frontend_sections/data_collection/correlation';
	const CONFIGURATION_DASHBOARD_EDIT =					'web_interface/frontend_sections/dashboards#creating-a-dashboard';
	...
	const CONFIGURATION_DISCOVERY_LIST =					'web_interface/frontend_sections/data_collection/discovery';
	const CONFIGURATION_GRAPH_EDIT =						'config/visualization/graphs/custom#configuring-custom-graphs';
	const CONFIGURATION_HOST_GRAPH_PROTOTYPE_LIST = 		'web_interface/frontend_sections/data_collection/hosts/discovery/graph_prototypes';
	const CONFIGURATION_HOST_DISCOVERY_EDIT =				'discovery/low_level_discovery#discovery-rule';
	const CONFIGURATION_HOST_DISCOVERY_LIST =				'web_interface/frontend_sections/data_collection/hosts/discovery';
	const CONFIGURATION_HOST_GRAPH_LIST =					'web_interface/frontend_sections/data_collection/hosts/graphs';
	const CONFIGURATION_HOST_HTTPCONF_LIST =				'web_interface/frontend_sections/data_collection/hosts/web';
	const CONFIGURATION_HOST_ITEM_LIST =					'web_interface/frontend_sections/data_collection/hosts/items';
	const CONFIGURATION_HOST_ITEM_PROTOTYPE_LIST =			'web_interface/frontend_sections/data_collection/hosts/discovery/item_prototypes';
	const CONFIGURATION_HOST_EDIT =							'config/hosts/host#configuration';
	const CONFIGURATION_HOST_LIST =							'web_interface/frontend_sections/data_collection/hosts';
	const CONFIGURATION_HOST_PROTOTYPE_EDIT =				'vm_monitoring#host-prototypes';
	const CONFIGURATION_HOST_PROTOTYPE_LIST =				'web_interface/frontend_sections/data_collection/hosts/discovery/host_prototypes';
	const CONFIGURATION_HOST_TRIGGERS_LIST =				'web_interface/frontend_sections/data_collection/hosts/triggers';
	const CONFIGURATION_HOST_TRIGGER_PROTOTYPE_LIST =		'web_interface/frontend_sections/data_collection/hosts/discovery/trigger_prototypes';
	const CONFIGURATION_HOSTGROUPS_EDIT =					'config/hosts/host#creating-a-host-group';
	const CONFIGURATION_HOSTGROUPS_LIST =					'web_interface/frontend_sections/data_collection/hostgroups';
	...
	const CONFIGURATION_MAINTENANCE_LIST =					'web_interface/frontend_sections/data_collection/maintenance';
	const CONFIGURATION_PROTOTYPE_GRAPH_EDIT =				'discovery/low_level_discovery/graph_prototypes';
	const CONFIGURATION_TEMPLATE_GRAPH_LIST =				'web_interface/frontend_sections/data_collection/templates/graphs';
	const CONFIGURATION_TEMPLATES_GRAPH_PROTOTYPE_LIST =	'web_interface/frontend_sections/data_collection/templates/discovery/graph_prototypes';
	const CONFIGURATION_TEMPLATE_ITEM_LIST =				'web_interface/frontend_sections/data_collection/templates/items';
	const CONFIGURATION_TEMPLATES_ITEM_PROTOTYPE_LIST =		'web_interface/frontend_sections/data_collection/templates/discovery/item_prototypes';
	const CONFIGURATION_TEMPLATE_TRIGGERS_LIST =			'web_interface/frontend_sections/data_collection/templates/triggers';
	const CONFIGURATION_TEMPLATES_TRIGGER_PROTOTYPE_LIST =	'web_interface/frontend_sections/data_collection/templates/discovery/trigger_prototypes';
	const CONFIGURATION_TEMPLATES_DISCOVERY_LIST =			'web_interface/frontend_sections/data_collection/templates/discovery';
	const CONFIGURATION_TEMPLATES_EDIT =					'config/templates/template#creating-a-template';
	const CONFIGURATION_TEMPLATES_HTTPCONF_LIST =			'web_interface/frontend_sections/data_collection/templates/web';
	const CONFIGURATION_TEMPLATES_LIST =					'web_interface/frontend_sections/data_collection/templates';
	const CONFIGURATION_TRIGGER_PROTOTYPE_EDIT =			'discovery/low_level_discovery/trigger_prototypes';
	const CONFIGURATION_TEMPLATES_PROTOTYPE_LIST =			'web_interface/frontend_sections/data_collection/templates/discovery/host_prototypes';
	const CONFIGURATION_TRIGGERS_EDIT =						'config/triggers/trigger#configuration';
	const DASHBOARD_PAGE_PROPERTIES_EDIT =					'web_interface/frontend_sections/dashboards#adding-pages';
	const DASHBOARD_PROPERTIES_EDIT =						'web_interface/frontend_sections/dashboards#creating-a-dashboard';
	const DASHBOARD_SHARE_EDIT =							'web_interface/frontend_sections/dashboards#sharing';
	...
	const MONITORING_DASHBOARD_LIST =						'web_interface/frontend_sections/dashboards';
	const MONITORING_DASHBOARD_VIEW =						'web_interface/frontend_sections/dashboards';
	const MONITORING_DASHBOARD_WIDGET_EDIT =				'web_interface/frontend_sections/dashboards/widgets';
	...
	const POPUP_ACKNOWLEDGE_EDIT =							'acknowledgment/#updating-problems';
