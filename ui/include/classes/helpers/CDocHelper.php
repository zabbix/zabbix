...
class CDocHelper {
	...
	const ADMINISTRATION_MISCCONFIG_EDIT =						'web_interface/frontend_sections/administration/general#other';
	...
	const USERS_DEVICE_LIST =									'web_interface/frontend_sections/users/device#list';
	const USERS_DEVICE =										'web_interface/frontend_sections/users/device#create';
