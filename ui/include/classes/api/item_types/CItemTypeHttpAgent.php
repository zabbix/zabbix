	...
	public static function getCreateValidationRules(array $item): array {
		...
		return [
			...
			'query_fields' =>		['type' => API_OBJECTS, 'fields' => [
				'name' =>				['type' => API_STRING_UTF8, 'flags' => API_NOT_EMPTY, 'length' => DB::getFieldLength('item_field', 'name')],
				'value' =>				['type' => API_STRING_UTF8, 'length' => DB::getFieldLength('item_field', 'value')]
			]],
