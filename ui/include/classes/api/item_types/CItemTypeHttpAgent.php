...
class CItemTypeHttpAgent extends CItemType {
	...
	public static function getCreateValidationRules(array $item): array {
		...
		return [
			...
			'posts' =>				['type' => API_MULTIPLE, 'rules' => [
										...
										['if' => ['field' => 'post_type', 'in' => ZBX_POSTTYPE_JSON], 'type' => API_STRING_UTF8, 'flags' => API_REQUIRED | API_NOT_EMPTY, 'length' => DB::getFieldLength('items', 'posts')],
										['if' => ['field' => 'post_type', 'in' => ZBX_POSTTYPE_XML], 'type' => API_STRING_UTF8, 'flags' => API_REQUIRED | API_NOT_EMPTY, 'length' => DB::getFieldLength('items', 'posts')]
			]],
	...
	public static function getUpdateValidationRules(array $db_item): array {
		...
		return [
			...
			'posts' =>				['type' => API_MULTIPLE, 'rules' => [
										['if' => ['field' => 'post_type', 'in' => ZBX_POSTTYPE_RAW], 'type' => API_STRING_UTF8, 'length' => DB::getFieldLength('items', 'posts')],
										['if' => ['field' => 'post_type', 'in' => ZBX_POSTTYPE_JSON], 'type' => API_STRING_UTF8, 'flags' => API_NOT_EMPTY, 'length' => DB::getFieldLength('items', 'posts')],
										['if' => ['field' => 'post_type', 'in' => ZBX_POSTTYPE_XML], 'type' => API_STRING_UTF8, 'flags' => API_NOT_EMPTY, 'length' => DB::getFieldLength('items', 'posts')]
			]],
			'headers' =>			['type' => API_OBJECTS, 'fields' => [
				'name' =>				['type' => API_STRING_UTF8, 'flags' => API_REQUIRED | API_NOT_EMPTY],
				'value' =>				['type' => API_STRING_UTF8, 'flags' => API_REQUIRED]
