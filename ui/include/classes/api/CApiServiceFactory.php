...
class CApiServiceFactory extends CRegistryFactory {
	...
	public const API_SERVICES = [
		...
		'apmtrace' => CApmTrace::class,
		'apmspan' => CApmSpan::class,
		'apmlog' => CApmLog::class,
		'apmmetric' => CApmMetric::class,
