...
class CAuthentication extends CApiService {
	...
	protected function validateUpdate(array &$auth, array &$db_auth = null) {
		$api_input_rules = ['type' => API_OBJECT, 'flags' => API_NOT_EMPTY, 'fields' => [
			...
			'saml_username_attribute' =>	['type' => API_STRING_UTF8, 'length' => 128],
			'saml_sp_entityid' =>			['type' => API_STRING_UTF8, 'length' => 1024],
			'saml_nameid_format' =>			['type' => API_STRING_UTF8, 'length' => 2048],
