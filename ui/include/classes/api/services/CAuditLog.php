...
class CAuditLog extends CApiService {
	...
	public function get(array $options) {
		...
		$resourcetype = [
			...
			CAudit::RESOURCE_TEMPLATE_GROUP, CAudit::RESOURCE_SCHEDULED_REPORT, CAudit::RESOURCE_SCRIPT,
			CAudit::RESOURCE_SETTINGS, CAudit::RESOURCE_SLA, CAudit::RESOURCE_TEMPLATE,
			CAudit::RESOURCE_TEMPLATE_DASHBOARD, CAudit::RESOURCE_TRIGGER, CAudit::RESOURCE_TRIGGER_PROTOTYPE,
			CAudit::RESOURCE_USER, CAudit::RESOURCE_USER_GROUP, CAudit::RESOURCE_USER_ROLE, CAudit::RESOURCE_VALUE_MAP,
