...
class CAuditLog extends CApiService {
	...
	public function get(array $options) {
		...
		$actions = [
			CAudit::ACTION_ADD, CAudit::ACTION_UPDATE, CAudit::ACTION_DELETE, CAudit::ACTION_LOGIN, CAudit::ACTION_LOGOUT,
			CAudit::ACTION_EXECUTE
		];
		$resourcetype = [
			CAudit::RESOURCE_USER, CAudit::RESOURCE_MEDIA_TYPE, CAudit::RESOURCE_HOST,
			CAudit::RESOURCE_ACTION, CAudit::RESOURCE_GRAPH, CAudit::RESOURCE_USER_GROUP, CAudit::RESOURCE_TRIGGER,
			CAudit::RESOURCE_HOST_GROUP, CAudit::RESOURCE_ITEM, CAudit::RESOURCE_IMAGE, CAudit::RESOURCE_VALUE_MAP,
			CAudit::RESOURCE_IT_SERVICE, CAudit::RESOURCE_MAP, CAudit::RESOURCE_SCENARIO, CAudit::RESOURCE_DISCOVERY_RULE,
			CAudit::RESOURCE_SCRIPT, CAudit::RESOURCE_PROXY, CAudit::RESOURCE_MAINTENANCE, CAudit::RESOURCE_REGEXP,
			CAudit::RESOURCE_MACRO, CAudit::RESOURCE_TEMPLATE, CAudit::RESOURCE_TRIGGER_PROTOTYPE, CAudit::RESOURCE_ICON_MAP,
			CAudit::RESOURCE_DASHBOARD, CAudit::RESOURCE_CORRELATION, CAudit::RESOURCE_GRAPH_PROTOTYPE,
			CAudit::RESOURCE_ITEM_PROTOTYPE, CAudit::RESOURCE_HOST_PROTOTYPE, CAudit::RESOURCE_AUTOREGISTRATION,
			CAudit::RESOURCE_MODULE, CAudit::RESOURCE_SETTINGS, CAudit::RESOURCE_HOUSEKEEPING, CAudit::RESOURCE_AUTHENTICATION,
		...
		$api_input_rules = ['type' => API_OBJECT, 'fields' => [
			...
			'filter' =>					['type' => API_OBJECT, 'flags' => API_ALLOW_NULL, 'default' => null, 'fields' => [
				...
				'recordsetid' =>			['type' => API_STRINGS_UTF8, 'flags' => API_ALLOW_NULL | API_NORMALIZE]
			]],
