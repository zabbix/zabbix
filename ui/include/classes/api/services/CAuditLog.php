...
class CAuditLog extends CApiService {
	...
	public function get(array $options) {
		...
		$resourcetype = [
			AUDIT_RESOURCE_USER, AUDIT_RESOURCE_AUTHENTICATION, AUDIT_RESOURCE_MEDIA_TYPE, AUDIT_RESOURCE_HOST,
			...
			AUDIT_RESOURCE_MODULE, AUDIT_RESOURCE_SETTINGS, AUDIT_RESOURCE_HOUSEKEEPING
		];
