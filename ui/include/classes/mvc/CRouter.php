...
class CRouter {
	...
	private $routes = [
		...
		'templategroups.create'						=> ['CControllerTemplateGroupsCreate',					null,					null],
		'templategroups.delete'						=> ['CControllerTemplateGroupsDelete',					null,					null],
		'templategroups.edit'						=> ['CControllerTemplateGroupsEdit',					'layout.htmlpage',		'configuration.templategroups.edit'],
		'templategroups.list'						=> ['CControllerTemplateGroupsList',					'layout.htmlpage',		'configuration.templategroups.list'],
		'templategroups.update'						=> ['CControllerTemplateGroupsUpdate',					null,					null],
