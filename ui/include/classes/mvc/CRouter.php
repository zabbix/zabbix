...
class CRouter {
	...
	private array $routes = [
		...
		'maintenance.list'							=> ['CControllerMaintenanceList',						'layout.htmlpage',		'configuration.maintenance.list'],
		...
		'popup.maintenance.edit'					=> ['CControllerPopupMaintenanceEdit',					'layout.json',			'popup.maintenance.edit'],
