...
class CRouter {
	...
	private array $routes = [
		...
		'correlation.condition.edit'				=> ['CControllerCorrelationConditionEdit',				'layout.json',			'configuration.condition.edit'],
		...
		'correlation.edit'							=> ['CControllerCorrelationEdit',						'layout.json',			'configuration.correlation.edit'],
