...
class CRouter {
	...
	private $routes = [
		...
		'templategroup.create'						=> ['CControllerTemplateGroupCreate',					null,					null],
		'templategroup.delete'						=> ['CControllerTemplateGroupDelete',					null,					null],
		...
		'templategroup.update'						=> ['CControllerTemplateGroupUpdate',					null,					null],
