...
final class CRouter {
	...
	private array $routes = [
		...
		'ceprule.create'							=> [CControllerCepRuleCreate::class,							ZBX_LAYOUT_JSON,		null],
		'ceprule.delete'							=> [CControllerCepRuleDelete::class,							ZBX_LAYOUT_JSON,		null],
		'ceprule.disable'							=> [CControllerCepRuleDisable::class,							ZBX_LAYOUT_JSON,		null],
		'ceprule.edit'								=> [CControllerCepRuleEdit::class,								ZBX_LAYOUT_JSON,		'ceprule.edit'],
		'ceprule.enable'							=> [CControllerCepRuleEnable::class,							ZBX_LAYOUT_JSON,		null],
		'ceprule.list'								=> [CControllerCepRuleList::class,								ZBX_LAYOUT_HTMLPAGE,	'ceprule.list'],
		'ceprule.resettimewindows'					=> [CControllerCepRuleResetTimeWindows::class,					ZBX_LAYOUT_JSON,		null],
		'ceprule.update'							=> [CControllerCepRuleUpdate::class,							ZBX_LAYOUT_JSON,		null],
