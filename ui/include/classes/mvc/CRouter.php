...
class CRouter {
	...
	private $routes = [
		...
		'popup.service.rule.edit'					=> ['CControllerPopupServiceRuleEdit',					'layout.json',			'popup.service.rule.edit'],
		...
		'service.rule.validate'						=> ['CControllerServiceRuleValidate',					'layout.json',			'service.rule.validate'],
