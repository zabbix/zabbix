...
class CRouter {
	...
	private array $routes = [
		...
		'ceprule.create'							=> [CControllerCepRuleCreate::class,								'layout.json',			null],
		'ceprule.delete'							=> [CControllerCepRuleDelete::class,								'layout.json',			null],
		'ceprule.disable'							=> [CControllerCepRuleDisable::class,								'layout.json',			null],
