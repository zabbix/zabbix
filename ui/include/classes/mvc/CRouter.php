...
class CRouter {
	...
	private $routes = [
		...
		'hintbox.sla_schedule'						=> ['CControllerHintboxSlaScheduleList',				'layout.json',			'hintbox.sla.schedule.list'],
		...
		'services.sla.edit'							=> ['CControllerServiceSlaEdit',						'layout.json',			null],
		'services.sla.update'						=> ['CControllerServiceSlaUpdate',						'layout.json',			null],
		'services.sla.massupdate'					=> ['CControllerServiceSlaMassUpdate',					'layout.json',			null],
		'services.sla.delete'						=> ['CControllerServiceSlaDelete',						'layout.json',			null],
		'services.sla.list'							=> ['CControllerServiceSlaList',						'layout.htmlpage',		'services.sla.list'],
		'services.sla.list.refresh'					=> ['CControllerServiceSlaListRefresh',					'layout.json',			'services.sla.list.refresh'],
		'popup.sla.edit'							=> ['CControllerServiceSlaEdit',						'layout.json',			'popup.sla.edit'],
		'popup.sla.downtime.edit'					=> ['CControllerPopupSlaDowntimeEdit',					'layout.json',			'popup.sla.downtime.edit'],
		'popup.sla.downtime.update'					=> ['CControllerPopupSlaDowntimeUpdate',				'layout.json',			null],
