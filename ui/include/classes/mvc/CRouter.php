...
class CRouter {
	...
	private array $routes = [
		...
		'graph.edit'								=> ['CControllerGraphEdit',								'layout.json',			'graph.edit'],
		'graph.create'								=> ['CControllerGraphCreate',							'layout.json',			null],
		'graph.delete'								=> ['CControllerGraphDelete',							'layout.json',			null],
		'graph.list'								=> ['CControllerGraphList',								'layout.htmlpage',		'graph.list'],
		'graph.update'								=> ['CControllerGraphUpdate',							'layout.json',			null],
		'graph.prototype.create'					=> ['CControllerGraphPrototypeCreate',					'layout.json',			null],
		'graph.prototype.delete'					=> ['CControllerGraphPrototypeDelete',					'layout.json',			null],
		...
		'macros.update'								=> ['CControllerMacrosUpdate',							'layout.json',			null],
		...
		'popup.media.check'							=> ['CControllerPopupMediaCheck',						'layout.json',			null],
		'popup.media.edit'							=> ['CControllerPopupMediaEdit',						'layout.json',			'popup.media.edit'],
		...
		'popup.valuemap.edit'						=> ['CControllerValueMapEdit',							'layout.json',			'popup.valuemap.edit'],
		'popup.valuemap.check'						=> ['CControllerValueMapCheck',							'layout.json',			null],
		...
		'userprofile.edit'							=> ['CControllerUserProfileEdit',						'layout.htmlpage',		'userprofile.edit'],
		'userprofile.update'						=> ['CControllerUserProfileUpdate',						null,					null],
		'userprofile.notification.edit'				=> ['CControllerUserProfileNotificationEdit',			'layout.htmlpage',		'userprofile.notification.edit'],
		'userprofile.notification.update'			=> ['CControllerUserProfileNotificationUpdate',			null,					null],
		...
		'validate'									=> ['CControllerValidate',								'layout.json',			null],
