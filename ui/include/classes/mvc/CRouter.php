...
class CRouter {
	...
	private $routes = [
		...
		'dashboard.sharing.edit'		=> ['CControllerDashboardSharingEdit',				'layout.json',			'dashboard.sharing.edit'],
		'dashboard.sharing.update'		=> ['CControllerDashboardSharingUpdate',			'layout.json',			null],
