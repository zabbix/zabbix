...
class CRouter {
	...
	private $routes = [
		...
		'popup.hostgroup.edit'						=> ['CControllerPopupHostGroupEdit',					'layout.json',			'popup.hostgroup.edit'],
		...
		'popup.templategroup.edit'					=> ['CControllerPopupTemplateGroupEdit',				'layout.json',			'popup.templategroup.edit'],
