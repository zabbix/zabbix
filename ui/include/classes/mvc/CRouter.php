...
class CRouter {
	...
	private array $routes = [
		...
		'oauth.authorize'							=> ['CControllerOauthAuthorize',						'layout.htmlpage',		'oauth.authorize'],
		'oauth.edit'								=> ['CControllerOauthEdit',								'layout.json',			'oauth.edit'],
		'oauth.check'								=> ['CControllerOauthCheck',							'layout.json',			null],
