...
class CRouter {
	...
	private array $routes = [
		...
		'popup.telemetry.aggregatedcolumn.edit'		=> [CControllerPopupTelemetryAggregatedColumnEdit::class,			'layout.json',			'popup.telemetry.aggregatedcolumn.edit'],
		'popup.telemetry.aggregatedcolumn.check'	=> [CControllerPopupTelemetryAggregatedColumnCheck::class,			'layout.json',			null],
		'popup.telemetry.condition.edit'			=> [CControllerPopupTelemetryConditionEdit::class,					'layout.json',			'popup.telemetry.condition.edit'],
		'popup.telemetry.condition.check'			=> [CControllerPopupTelemetryConditionCheck::class,					'layout.json',			null],
