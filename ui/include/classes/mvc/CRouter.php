...
class CRouter {
	...
	private $routes = [
		...
		'popup.widget.columnlist.edit'				=> ['CControllerPopupColumnListEdit',					'layout.json',			'popup.widget.columnlist.edit'],
		...
		'widget.tophostsdata.view'					=> ['CControllerWidgetTopHostsDataView',				'layout.widget',		'monitoring.widget.tophostsdata.view'],
