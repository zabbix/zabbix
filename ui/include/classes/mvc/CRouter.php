...
class CRouter {
	...
	private array $routes = [
		...
		'regex.create'								=> ['CControllerRegExCreate',							'layout.json',			null],
		...
		'regex.test'								=> ['CControllerRegExTest',								'layout.json',			null],
		'regex.update'								=> ['CControllerRegExUpdate',							'layout.json',			null],
