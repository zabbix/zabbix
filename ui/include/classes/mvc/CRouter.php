...
final class CRouter {
	...
	private array $routes = [
		...
		'host.view.refresh'							=> [CControllerHostViewRefresh::class,							ZBX_LAYOUT_JSON,		'monitoring.host.view.refresh'],
		...
		'latest.view.refresh'						=> [CControllerLatestViewRefresh::class,						ZBX_LAYOUT_JSON,		'monitoring.latest.view.refresh'],
		...
		'popup.scheduledreport.create'				=> [CControllerPopupScheduledReportCreate::class,				ZBX_LAYOUT_JSON,		null],
		'popup.scheduledreport.edit'				=> [CControllerPopupScheduledReportEdit::class,					ZBX_LAYOUT_JSON,		'popup.scheduledreport.edit'],
		...
		'popup.triggerexpr'							=> [CControllerPopupTriggerExpr::class,							ZBX_LAYOUT_JSON,		'popup.triggerexpr'],
		...
		'problem.view.csv'							=> [CControllerProblemView::class,								ZBX_LAYOUT_DOWNLOAD,	'monitoring.problem.view'],
		'problem.view.refresh'						=> [CControllerProblemViewRefresh::class,						ZBX_LAYOUT_JSON,		'monitoring.problem.view.refresh'],
		...
		'scheduledreport.edit'						=> [CControllerScheduledReportEdit::class,						ZBX_LAYOUT_HTMLPAGE,	'reports.scheduledreport.edit'],
		...
		'validate'									=> [CControllerValidate::class,									ZBX_LAYOUT_JSON,		null],
