	...
	private static function get(): array {
		return [
			'agent.hostmetadata' => [
				...
				'documentation_link' => '/zabbix_agent#agent.hostmetadata'
			],
			'agent.hostname' => [
				'description' => _('Agent host name. Returns string'),
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => '/zabbix_agent?hl=agent.hostname#agent.hostname'
			],
			'agent.ping' => [
				'description' => _('Agent availability check. Returns nothing - unavailable; 1 - available'),
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => '/zabbix_agent?hl=agent.hostname#agent.ping'
			],
			'agent.variant' => [
				'description' => _('Agent variant check. Returns 1 - for Zabbix agent; 2 - for Zabbix agent 2'),
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => '/zabbix_agent?hl=agent.hostname#agent.variant'
			],
			'agent.version' => [
				'description' => _('Version of Zabbix agent. Returns string'),
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => '/zabbix_agent?hl=agent.hostname#agent.version'
			],
			'db.odbc.discovery[<unique short description>,<dsn>,<connection string>]' => [
			...
			'mqtt.get[<broker_url>,topic,<username>,<password>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => '/zabbix_agent/zabbix_agent2?hl=mqtt.get#mqtt.get'
			],
			'net.dns.record[<ip>,name,<type>,<timeout>,<count>,<protocol>]' => [
				'description' => _('Performs a DNS query. Returns character string with the required type of information'),
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => '/zabbix_agent#net.dns.record'
			],
			'net.dns[<ip>,name,<type>,<timeout>,<count>,<protocol>]' => [
			...
			'net.tcp.service.perf[service,<ip>,<port>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => [
					ITEM_TYPE_ZABBIX => '/zabbix_agent#net.tcp.service.perf',
					ITEM_TYPE_ZABBIX_ACTIVE => '/simple_checks#nettcpserviceperf',
					ITEM_TYPE_SIMPLE => '/simple_checks#nettcpserviceperf'
				]
			],
			'net.tcp.service[service,<ip>,<port>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => [
					ITEM_TYPE_ZABBIX => '/zabbix_agent#net.tcp.service',
					ITEM_TYPE_ZABBIX_ACTIVE => '/simple_checks#nettcpservice',
					ITEM_TYPE_SIMPLE => '/simple_checks#nettcpservice'
				]
			],
			'net.tcp.socket.count[<laddr>,<lport>,<raddr>,<rport>,<state>]' => [
				'description' => _('Returns number of TCP sockets that match parameters. Returns integer'),
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => '/zabbix_agent#net.tcp.socket.count'
			],
			'net.udp.listen[port]' => [
				'description' => _('Checks if this UDP port is in LISTEN state. Returns 0 - it is not in LISTEN state; 1 - it is in LISTEN state'),
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => '/zabbix_agent#net.udp.listen'
			],
			'net.udp.service.perf[service,<ip>,<port>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => [
					ITEM_TYPE_ZABBIX => '/zabbix_agent#net.udp.service.perf',
					ITEM_TYPE_ZABBIX_ACTIVE => '/zabbix_agent#net.udp.service.perf',
					ITEM_TYPE_SIMPLE => '/simple_checks#netudpserviceperf'
				]
			],
			'net.udp.service[service,<ip>,<port>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => [
					ITEM_TYPE_ZABBIX => '/zabbix_agent#net.udp.service',
					ITEM_TYPE_ZABBIX_ACTIVE => '/zabbix_agent#net.udp.service',
					ITEM_TYPE_SIMPLE => '/simple_checks#netudpservice'
				]
			],
			'net.udp.socket.count[<laddr>,<lport>,<raddr>,<rport>,<state>]' => [
				'description' => _('Returns number of UDP sockets that match parameters. Returns integer'),
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => '/zabbix_agent#net.udp.socket.count'
			],
			'perf_counter[counter,<interval>]' => [
				'description' => _('Value of any Windows performance counter. Returns integer, float, string or text (depending on the request)'),
				'value_type' => null,
				'documentation_link' => '/zabbix_agent/win_keys#perf.counter'
			],
			'perf_counter_en[counter,<interval>]' => [
				...
				'value_type' => null,
				'documentation_link' => '/zabbix_agent/win_keys#perf.counter.en'
			],
			'perf_instance.discovery[object]' => [
				'description' => _('List of object instances of Windows performance counters. Returns JSON'),
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => '/zabbix_agent/win_keys#perf.instance.discovery'
			],
			'perf_instance_en.discovery[object]' => [
			...
			'vmware.alarms.get[url]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.alarms'
			],
			'vmware.cl.perfcounter[url,id,path,<instance>]' => [
			...
			'vmware.datastore.alarms.get[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.datastore.alarms'
			],
			'vmware.datastore.discovery[url]' => [
				'description' => _('Discovery of VMware datastores, "url" - VMware service URL. Returns JSON'),
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.datastore.discovery'
			],
			'vmware.datastore.hv.list[url,datastore]' => [
				'description' => _('VMware datastore hypervisors list, "url" - VMware service URL, "datastore" - datastore name'),
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.datastore.hv.list'
			],
			'vmware.datastore.perfcounter[url,uuid,path,<instance>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.datastore.perfcounter'
			],
			'vmware.datastore.property[url,uuid,prop]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.datastore.property'
			],
			'vmware.datastore.read[url,datastore,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.datastore.read'
			],
			'vmware.datastore.size[url,datastore,<mode>]' => [
				...
				'value_type' => null,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.datastore.size'
			],
			'vmware.datastore.tags.get[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.datastore.tags'
			],
			'vmware.datastore.write[url,datastore,<mode>]' => [
			...
			'vmware.dvswitch.fetchports.get[url,uuid,<filter>,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.dvswitch.fetchports'
			],
			'vmware.eventlog[url,<mode>]' => [
				'description' => _('VMware event log, "url" - VMware service URL, "mode"- all (default), skip - skip processing of older data'),
				'value_type' => ITEM_VALUE_TYPE_LOG,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.eventlog'
			],
			'vmware.fullname[url]' => [
				'description' => _('VMware service full name, "url" - VMware service URL'),
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.fullname'
			],
			'vmware.hv.alarms.get[url,uuid]' => [
			...
			'vmware.hv.cpu.usage.perf[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.cpu.perf'
			],
			'vmware.hv.cpu.usage[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.cpu'
			],
			'vmware.hv.cpu.utilization[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.cpu.utilization'
			],
			'vmware.hv.datacenter.name[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.datacenter'
			],
			'vmware.hv.datastore.discovery[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.datastore.discovery'
			],
			'vmware.hv.datastore.list[url,uuid]' => [
				'description' => _('VMware hypervisor datastores list, "url" - VMware service URL, "uuid" - VMware hypervisor global unique identifier'),
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.datastore.list'
			],
			'vmware.hv.datastore.multipath[url,uuid,<datastore>,<partitionid>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.datastore.multipath'
			],
			'vmware.hv.datastore.read[url,uuid,datastore,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.datastore.read'
			],
			'vmware.hv.datastore.size[url,uuid,datastore,<mode>]' => [
				...
				'value_type' => null,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.datastore.size'
			],
			'vmware.hv.datastore.write[url,uuid,datastore,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.datastore.write'
			],
			'vmware.hv.discovery[url]' => [
				'description' => _('Discovery of VMware hypervisors, "url" - VMware service URL. Returns JSON'),
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.discovery'
			],
			'vmware.hv.diskinfo.get[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.diskinfo'
			],
			'vmware.hv.fullname[url,uuid]' => [
				'description' => _('VMware hypervisor name, "url" - VMware service URL, "uuid" - VMware hypervisor global unique identifier'),
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.fullname'
			],
			'vmware.hv.hw.cpu.freq[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.hw.cpu.freq'
			],
			'vmware.hv.hw.cpu.model[url,uuid]' => [
				'description' => _('VMware hypervisor processor model, "url" - VMware service URL, "uuid" - VMware hypervisor global unique identifier'),
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.hw.cpu.model'
			],
			'vmware.hv.hw.cpu.num[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.hw.cpu.num'
			],
			'vmware.hv.hw.cpu.threads[url,uuid]' => [
			...
			'vmware.hv.maintenance[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.maintenance'
			],
			'vmware.hv.memory.size.ballooned[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.memory.size.ballooned'
			],
			'vmware.hv.memory.used[url,uuid]' => [
				'description' => _('VMware hypervisor used memory size, "url" - VMware service URL, "uuid" - VMware hypervisor global unique identifier'),
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.memory.used'
			],
			'vmware.hv.net.if.discovery[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.net.if.discovery'
			],
			'vmware.hv.network.in[url,uuid,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.network.in'
			],
			'vmware.hv.network.linkspeed[url,uuid,ifname]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.network.linkspeed'
			],
			'vmware.hv.network.out[url,uuid,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.network.out'
			],
			'vmware.hv.perfcounter[url,uuid,path,<instance>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.perfcounter'
			],
			'vmware.hv.power[url,uuid,<max>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.power'
			],
			'vmware.hv.property[url,uuid,prop]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.property'
			],
			'vmware.hv.sensor.health.state[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.sensor.health'
			],
			'vmware.hv.sensors.get[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.sensors'
			],
			'vmware.hv.status[url,uuid]' => [
				'description' => _('VMware hypervisor status, "url" - VMware service URL, "uuid" - VMware hypervisor global unique identifier'),
				'value_type' => null,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.status'
			],
			'vmware.hv.tags.get[url,uuid]' => [
			...
			'vmware.hv.vm.num[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.hv.vm.num'
			],
			'vmware.rp.cpu.usage[url,rpid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.rp.cpu'
			],
			'vmware.rp.memory[url,rpid,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.rp.memory'
			],
			'vmware.version[url]' => [
				'description' => _('VMware service version, "url" - VMware service URL'),
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.version'
			],
			'vmware.vm.alarms.get[url,uuid]' => [
			...
			'vmware.vm.attribute[url,uuid,name]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.attribute'
			],
			'vmware.vm.cluster.name[url,uuid]' => [
				'description' => _('VMware virtual machine name, "url" - VMware service URL, "uuid" - VMware virtual machine global unique identifier'),
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.cluster.name'
			],
			'vmware.vm.consolidationneeded[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.consolidationneeded'
			],
			'vmware.vm.cpu.latency[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.cpu.latency'
			],
			'vmware.vm.cpu.num[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.cpu.num'
			],
			'vmware.vm.cpu.readiness[url,uuid,<instance>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.cpu.readiness'
			],
			'vmware.vm.cpu.ready[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.cpu.ready'
			],
			'vmware.vm.cpu.swapwait[url,uuid,<instance>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.cpu.swapwait'
			],
			'vmware.vm.cpu.usage.perf[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.cpu.usage.perf'
			],
			'vmware.vm.cpu.usage[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.cpu.usage'
			],
			'vmware.vm.datacenter.name[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.datacenter.name'
			],
			'vmware.vm.discovery[url]' => [
				'description' => _('Discovery of VMware virtual machines, "url" - VMware service URL. Returns JSON'),
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.discovery'
			],
			'vmware.vm.guest.memory.size.swapped[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.guest.memory.size.swapped'
			],
			'vmware.vm.guest.osuptime[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.guest.osuptime'
			],
			'vmware.vm.hv.name[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.hv.name'
			],
			'vmware.vm.memory.size.ballooned[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.size.ballooned'
			],
			'vmware.vm.memory.size.compressed[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.size.compressed'
			],
			'vmware.vm.memory.size.consumed[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.size.consumed'
			],
			'vmware.vm.memory.size.private[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.size.private'
			],
			'vmware.vm.memory.size.shared[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.size.shared'
			],
			'vmware.vm.memory.size.swapped[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.size.swapped'
			],
			'vmware.vm.memory.size.usage.guest[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.size.usage.guest'
			],
			'vmware.vm.memory.size.usage.host[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.size.usage.host'
			],
			'vmware.vm.memory.size[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.size'
			],
			'vmware.vm.memory.usage[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.memory.usage'
			],
			'vmware.vm.net.if.discovery[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.net.if.discovery'
			],
			'vmware.vm.net.if.in[url,uuid,instance,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.net.if.in'
			],
			'vmware.vm.net.if.out[url,uuid,instance,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.net.if.out'
			],
			'vmware.vm.net.if.usage[url,uuid,<instance>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.net.if.usage'
			],
			'vmware.vm.perfcounter[url,uuid,path,<instance>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.perfcounter'
			],
			'vmware.vm.powerstate[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.powerstate'
			],
			'vmware.vm.property[url,uuid,prop]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.property'
			],
			'vmware.vm.snapshot.get[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.snapshot'
			],
			'vmware.vm.state[url,uuid]' => [
				'description' => _('VMware virtual machine state, "url" - VMware service URL, "uuid" - VMware virtual machine global unique identifier'),
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.state'
			],
			'vmware.vm.storage.committed[url,uuid]' => [
				...
				'value_type' => null,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.storage.committed'
			],
			'vmware.vm.storage.readoio[url,uuid,instance]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.storage.readoio'
			],
			'vmware.vm.storage.totalreadlatency[url,uuid,instance]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.storage.totalreadlatency'
			],
			'vmware.vm.storage.totalwritelatency[url,uuid,instance]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.storage.totalwritelatency'
			],
			'vmware.vm.storage.uncommitted[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.storage.uncommitted'
			],
			'vmware.vm.storage.unshared[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.storage.unshared'
			],
			'vmware.vm.storage.writeoio[url,uuid,instance]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.storage.writeoio'
			],
			'vmware.vm.tags.get[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.tags'
			],
			'vmware.vm.tools[url,uuid,mode]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_STR,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.tools'
			],
			'vmware.vm.uptime[url,uuid]' => [
				'description' => _('VMware virtual machine uptime, "url" - VMware service URL, "uuid" - VMware virtual machine global unique identifier'),
				'value_type' => ITEM_VALUE_TYPE_UINT64,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.uptime'
			],
			'vmware.vm.vfs.dev.discovery[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.vfs.dev.discovery'
			],
			'vmware.vm.vfs.dev.read[url,uuid,instance,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.vfs.dev.read'
			],
			'vmware.vm.vfs.dev.write[url,uuid,instance,<mode>]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_FLOAT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.vfs.dev.write'
			],
			'vmware.vm.vfs.fs.discovery[url,uuid]' => [
				...
				'value_type' => ITEM_VALUE_TYPE_TEXT,
				'documentation_link' => 'vm_monitoring/vmware_keys#vmware.vm.vfs.fs.discovery'
			],
			'vmware.vm.vfs.fs.size[url,uuid,fsname,<mode>]' => [
			...
			'zabbix[wcache,<cache>,<mode>]' => [
				...
				'value_type' => null,
				'documentation_link' => '/itemtypes/internal#wcache'
			]
		];
	}
}
