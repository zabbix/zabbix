...
$mediatype_form_grid
	...
	->addItem([
		...
		(new CFormField(
			CTemporaryMobileFeatureHelper::isConfigured() ? _('Configured') : _('Not configured')
		))
			->setId('bridge_adapter_field')
			->addClass(CTemporaryMobileFeatureHelper::isConfigured() ? ZBX_STYLE_GREEN : ZBX_STYLE_RED)
	]);
