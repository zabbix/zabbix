		...
		_getActionsByResource(resource) {
			...
			const resources = <?php echo json_encode([
				...
				CAudit::ACTION_DELETE => [
					CAudit::RESOURCE_ACTION, CAudit::RESOURCE_AUTH_TOKEN, CAudit::RESOURCE_CONNECTOR,
					CAudit::RESOURCE_CORRELATION, CAudit::RESOURCE_DASHBOARD, CAudit::RESOURCE_DEVICE,
					...
					CAudit::RESOURCE_HOST_PROTOTYPE, CAudit::RESOURCE_ICON_MAP, CAudit::RESOURCE_IMAGE,
					CAudit::RESOURCE_IT_SERVICE, CAudit::RESOURCE_ITEM, CAudit::RESOURCE_ITEM_PROTOTYPE,
					CAudit::RESOURCE_LLD_RULE, CAudit::RESOURCE_MACRO, CAudit::RESOURCE_MAINTENANCE,
				...
				CAudit::ACTION_INIT => [CAudit::RESOURCE_DEVICE],
				CAudit::ACTION_ONBOARD => [CAudit::RESOURCE_DEVICE]
			]); ?>
