...
<script type="text/javascript">
	const OPTION_ALL_VALUE = '-1';

	class resourceInputManage {
		constructor() {
			this.action_elem = document.getElementById('auditlog_action');
			this.action_options = this.action_elem.querySelectorAll('option');
			this.resource_elem = document.getElementById('resourcetype');
		...
		update(resourceid) {
			...
			if (resourceid == OPTION_ALL_VALUE) {
		...
		getActionsByResource(resource) {
			...
			const resources = <?php echo json_encode([
					...
					AUDIT_ACTION_ADD => [AUDIT_RESOURCE_USER, AUDIT_RESOURCE_MEDIA_TYPE, AUDIT_RESOURCE_HOST,
					...
					AUDIT_ACTION_UPDATE => [AUDIT_RESOURCE_USER, AUDIT_RESOURCE_ZABBIX_CONFIG,
					...
					AUDIT_ACTION_DELETE => [AUDIT_RESOURCE_USER, AUDIT_RESOURCE_MEDIA_TYPE, AUDIT_RESOURCE_HOST,
						AUDIT_RESOURCE_HOST_PROTOTYPE, AUDIT_RESOURCE_ACTION, AUDIT_RESOURCE_GRAPH,
						AUDIT_RESOURCE_GRAPH_PROTOTYPE, AUDIT_RESOURCE_GRAPH_ELEMENT, AUDIT_RESOURCE_USER_GROUP,
						AUDIT_RESOURCE_APPLICATION, AUDIT_RESOURCE_TRIGGER, AUDIT_RESOURCE_TRIGGER_PROTOTYPE,
						AUDIT_RESOURCE_HOST_GROUP, AUDIT_RESOURCE_ITEM, AUDIT_RESOURCE_ITEM_PROTOTYPE,
