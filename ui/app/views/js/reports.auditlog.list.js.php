		...
		getActionsByResource(resource) {
			...
			const resources = <?php echo json_encode([
					...
					CAudit::ACTION_ADD => [
						...
						CAudit::RESOURCE_GRAPH_PROTOTYPE, CAudit::RESOURCE_HOST, CAudit::RESOURCE_HOST_GROUP,
						CAudit::RESOURCE_HOST_PROTOTYPE, CAudit::RESOURCE_ICON_MAP, CAudit::RESOURCE_ITEM,
						...
						CAudit::RESOURCE_MODULE, CAudit::RESOURCE_PROXY, CAudit::RESOURCE_REGEXP,
						CAudit::RESOURCE_SCENARIO, CAudit::RESOURCE_SCHEDULED_REPORT, CAudit::RESOURCE_SCRIPT,
					...
					CAudit::ACTION_UPDATE => [
						...
						CAudit::RESOURCE_AUTOREGISTRATION, CAudit::RESOURCE_DASHBOARD, CAudit::RESOURCE_DISCOVERY_RULE,
						...
						CAudit::RESOURCE_MODULE, CAudit::RESOURCE_PROXY, CAudit::RESOURCE_REGEXP,
						CAudit::RESOURCE_SCENARIO, CAudit::RESOURCE_SCHEDULED_REPORT, CAudit::RESOURCE_SCRIPT,
						CAudit::RESOURCE_SETTINGS, CAudit::RESOURCE_TEMPLATE, CAudit::RESOURCE_TEMPLATE_DASHBOARD,
