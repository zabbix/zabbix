...
foreach ($data['users'] as $user) {
	...
	$table->addRow([
		...
		(new CCol($username))->addClass(ZBX_STYLE_WORDWRAP),
		(new CCol($user['name']))->addClass(ZBX_STYLE_WORDWRAP),
		(new CCol($user['surname']))->addClass(ZBX_STYLE_WORDWRAP),
		(new CCol($user['role']['name']))->addClass(ZBX_STYLE_WORDWRAP),
		(new CCol($users_groups))->addClass(ZBX_STYLE_WORDWRAP),
		$online,
		$blocked,
