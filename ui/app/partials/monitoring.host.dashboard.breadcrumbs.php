...
$url_list = (new CUrl('zabbix.php'))->setArgument('action', 'host.view');

(new CSpan())
	->addItem(new CLink(_('All hosts'), $url_list->getUrl()))
	->show();

if (!empty($data['host']['hostid'])) {
