...
class CControllerLldRulePrototypeDelete extends CController {
	...
	public function doAction(): void {
		...
		$result = API::DiscoveryRulePrototype()->delete($items);
		$messages = array_column(get_and_clear_messages(), 'message');
		$count = count($items);
		...
		if ($result) {
			...
			$output['error'] = [
				'title' => _n('Cannot delete discovery prototype', 'Cannot delete discovery prototypes', $count),
				'messages' => $messages
			];
		}
