...
class CControllerTriggerEnable extends CController {
	...
	protected function doAction(): void {
		...
		if ($result) {
			$output['success']['title'] = _n('Trigger enabled', 'Triggers enabled', $triggers_count);
			...
			$output['error'] = [
				'title' => _n('Cannot enable trigger', 'Cannot enable triggers', $triggers_count),
				'messages' => array_column(get_and_clear_messages(), 'message')
			];
