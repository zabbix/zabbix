...
class CControllerUserProfileEdit extends CControllerUserEditGeneral {
	...
	protected function checkPermissions(): bool {
		...
		$users = API::User()->get([
			'output' => ['username', 'name', 'surname', 'lang', 'theme', 'autologin', 'autologout', 'refresh',
				'default_maintenance_period', 'rows_per_page', 'url', 'timezone', 'provisioned'
			],
	...
	protected function doAction(): void {
		...
		$data = [
			...
			'js_validation_rules' => (new CFormValidator(CControllerUserProfileUpdate::getValidationRules()))
				->getRules()
		];
