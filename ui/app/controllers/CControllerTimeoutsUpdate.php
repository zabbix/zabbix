...
class CControllerTimeoutsUpdate extends CController {
	...
	protected function checkInput(): bool {
		$fields = [
			...
			'socket_timeout' =>				'required|not_empty|setting socket_timeout|time_unit 1:300',
			'connect_timeout' =>			'required|not_empty|setting connect_timeout|time_unit 1:30',
			'media_type_test_timeout' =>	'required|not_empty|setting media_type_test_timeout|time_unit 1:300',
			'script_timeout' =>				'required|not_empty|setting script_timeout|time_unit 1:300',
			'item_test_timeout' =>			'required|not_empty|setting item_test_timeout|time_unit 1:600',
			'report_test_timeout' =>		'required|not_empty|setting report_test_timeout|time_unit 1:300'
		];
