...
abstract class CControllerCepRuleGeneral extends CController {
	...
	protected function init(): void {
		$this->disableCsrfValidation(); // TEMP
		...
		return ['object', 'api_uniq' => $api_uniq, 'fields' => [
			...
			'window' => ['object', 'fields' => [
				...
				'group_by_host_group' => ['integer', 'in' => [ZBX_CEP_GROUP_BY_YES, ZBX_CEP_GROUP_BY_NO],
					'when' => ['../window_type', 'in' => [ZBX_CEP_WINDOW_SIMPLE, ZBX_CEP_WINDOW_CAUSE_SYMPTOM, ZBX_CEP_WINDOW_PATTERN_MATCH]]
				],
				...
				'tag' => ['db cep_window.tag', 'required', 'not_empty',
					'when' => [
						['group_by_tag', 'in' => [ZBX_CEP_GROUP_BY_YES]],
			...
			'stop' => ['db cep_rule.stop', 'required', 'in' => [ZBX_CEP_EXECUTION_CONTINUE, ZBX_CEP_EXECUTION_STOP]],
