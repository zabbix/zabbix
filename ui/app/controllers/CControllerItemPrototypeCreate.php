...
class CControllerItemPrototypeCreate extends CControllerItemPrototype {
	...
	public static function getValidationRules(): array {
		...
		return ['object', 'api_uniq' => $api_uniq, 'fields' => [
			...
			'master_itemid' => ['db items.master_itemid', 'required', 'when' => ['type', 'in' => [
						ITEM_TYPE_DEPENDENT
			]]],
			...
			'delay' => [
				...
				['db items.delay', 'required', 'not_empty',
					...
					'when' => ['type', 'in' => [ITEM_TYPE_CALCULATED, ITEM_TYPE_DB_MONITOR, ITEM_TYPE_EXTERNAL,
							ITEM_TYPE_HTTPAGENT, ITEM_TYPE_INTERNAL, ITEM_TYPE_IPMI, ITEM_TYPE_JMX, ITEM_TYPE_SCRIPT,
							ITEM_TYPE_SIMPLE, ITEM_TYPE_SNMP, ITEM_TYPE_SSH, ITEM_TYPE_TELNET, ITEM_TYPE_ZABBIX,
							ITEM_TYPE_BROWSER
					]]
				],
				['db items.delay', 'required', 'not_empty',
