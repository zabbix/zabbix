...
class CControllerTriggerPrototypeDelete extends CController {
	...
	protected function doAction(): void {
		...
		$result = API::TriggerPrototype()->delete($triggerids);
		...
		if ($result) {
			...
			$output['error'] = [
				'title' => _n('Cannot delete trigger prototype', 'Cannot delete trigger prototypes', $triggers_count),
				'messages' => array_column(get_and_clear_messages(), 'message')
			];
