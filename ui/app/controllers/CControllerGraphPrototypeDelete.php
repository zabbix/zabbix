...
class CControllerGraphPrototypeDelete extends CController {
	...
	protected function doAction(): void {
		...
		if ($result) {
			$output['success']['title'] = _n('Graph prototype deleted', 'Graph prototypes deleted', $graphs_count);
			...
			$output['error'] = [
				'title' => _n('Cannot delete graph prototype', 'Cannot delete graph prototypes', $graphs_count),
				'messages' => array_column(get_and_clear_messages(), 'message')
			];
