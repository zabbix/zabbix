...
class CControllerConnectorEnable extends CController {
	...
	protected function doAction(): void {
		...
		if ($result) {
			$output['success']['title'] = _n('Connector enabled', 'Connectors enabled', count($connectorids));
			...
			$output['error'] = [
				'title' => _n('Cannot enable connector', 'Cannot enable connectors', count($connectorids)),
				'messages' => array_column(get_and_clear_messages(), 'message')
			];
