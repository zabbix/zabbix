		...
		return ['object', 'api_uniq' => $api_uniq, 'fields' => [
			...
			'delay' => [
				...
				['db items.delay', 'required', 'not_empty',
					'use' => [CTimeUnitValidator::class,
						['max' => SEC_PER_DAY, 'usermacros' => true, 'lldmacros' => true]
					],
					'when' => ['type',
			...
			'timeout' => [
				['db items.timeout', 'required', 'not_empty',
					'use' => [CTimeUnitValidator::class,
						['min' => 1, 'max' => 10 * SEC_PER_MIN, 'usermacros' => true, 'lldmacros' => true]
					],
					'when' => [
			...
			'history' => ['db items.history', 'required', 'not_empty',
				'use' => [CTimeUnitValidator::class,
					['min' => SEC_PER_HOUR, 'max' => 25 * SEC_PER_YEAR, 'usermacros' => true, 'lldmacros' => true]
				],
			...
			'trends' => ['db items.trends', 'required', 'not_empty',
				'use' => [CTimeUnitValidator::class,
					['min' => SEC_PER_DAY, 'max' => 25 * SEC_PER_YEAR, 'usermacros' => true, 'lldmacros' => true]
				],
				'when' => [
			...
			'time_shift' => ['db items.time_shift', 'required', 'not_empty',
				'use' => [CTimeUnitValidator::class,
					['min' => 0, 'max' => SEC_PER_DAY, 'usermacros' => true, 'lldmacros' => true]
				],
				'when' => ['type', 'in' => [ITEM_TYPE_TELEMETRY_QUERY]]
			],
			'lookback_limit' => ['db items.lookback_limit', 'required', 'not_empty',
				'use' => [CTimeUnitValidator::class,
					['min' => 1, 'max' => 3 * SEC_PER_DAY, 'usermacros' => true, 'lldmacros' => true]
				],
				'when' => ['type', 'in' => [ITEM_TYPE_TELEMETRY_QUERY]]
			],
			'granularity' => ['db items.granularity', 'required', 'not_empty',
				'use' => [CTimeUnitValidator::class,
					['min' => 1, 'max' => SEC_PER_DAY, 'usermacros' => true, 'lldmacros' => true]
				],
				'when' => ['type', 'in' => [ITEM_TYPE_TELEMETRY_QUERY]]
			],
			'signal_type' => ['integer',
