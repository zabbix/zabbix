...
class CControllerLldRulePrototypeEnable extends CController {
	...
	public function doAction(): void {
		...
		if ($result) {
			$output['success']['title'] = _n('Discovery prototype enabled', 'Discovery prototypes enabled', $count);
			...
			$output['error'] = [
				'title' => _n('Cannot enable discovery prototype', 'Cannot enable discovery prototypes', $count),
				'messages' => $messages
			];
		}
