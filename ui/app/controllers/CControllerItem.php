...
abstract class CControllerItem extends CController {
	...
	protected static function getValidationFields(): array {
		return [
			...
			'time_shift'			=> 'db items.time_shift',
			'lookback_limit'		=> 'db items.lookback_limit',
			'granularity'			=> 'db items.granularity',
			'signal_type'			=> 'in '.implode(',', [APM_SIGNAL_TYPE_TRACES, APM_SIGNAL_TYPE_METRICS, APM_SIGNAL_TYPE_LOGS]),
			'metric_point_type'		=> 'in '.implode(',', [APM_METRICS_POINT_SUM, APM_METRICS_POINT_GAUGE, APM_METRICS_POINT_HISTOGRAM, APM_METRICS_POINT_EXPHISTOGRAM]),
			'columns'				=> 'array',
