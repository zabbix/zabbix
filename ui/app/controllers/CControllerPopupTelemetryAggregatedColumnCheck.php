...
class CControllerPopupTelemetryAggregatedColumnCheck extends CController {
	...
	protected function checkInput(): bool {
		...
		if (!$ret) {
			...
			$response = $form_errors
				...
				: ['error' => [
					'title' => _('Cannot add aggregated column'),
	...
	protected function doAction(): void {
		$function = (int) $this->getInput('function');

		$this->setResponse(
			(new CControllerResponseData(['main_block' => json_encode([
				'row_index' => $this->getInput('row_index'),
				'column' => $function == AGGREGATE_COUNT ? '' : $this->getInput('column', ''),
				'function' => $function,
				'percentile' => $function == AGGREGATE_PCTILE ? $this->getInput('percentile', '') : '',
