...
class CControllerAuthenticationEdit extends CController {
	...
	protected function checkInput() {
		$fields = [
			...
			'passwd_check_rules' =>				'ge 0|le '.(PASSWD_CHECK_CASE | PASSWD_CHECK_DIGITS | PASSWD_CHECK_SPECIAL | PASSWD_CHECK_SIMPLE),
	...
	protected function doAction() {
		...
		$data = [
			...
			'is_http_auth_allowed' => CFeatureFlagHelper::isFeatureDisabled(CFeatureFlagHelper::HTTP_AUTH_FEATURE_FLAG),
