...
link.exe /OUT:"../../../bin/win64/zabbix_agentd.exe" /INCREMENTAL:NO /MANIFEST /MANIFESTFILE:"Win64\zabbix_agentd\zabbix_agentd.exe.intermediate.manifest" /MANIFESTUAC:"level='asInvoker' uiAccess='false'" /PDB:"Win64\zabbix_agentd\zabbix_agentd.pdb" /SUBSYSTEM:CONSOLE /DYNAMICBASE:NO /MACHINE:X64 libiconv.lib ws2_32.lib pdh.lib psapi.lib odbc32.lib odbccp32.lib Wldap32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib @link.tmp /NOLOGO
