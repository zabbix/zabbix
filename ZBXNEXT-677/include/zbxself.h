...
#define ZBX_PROCESS_TYPE_PROXYPOLLER	7
#define ZBX_PROCESS_TYPE_ESCALATOR	8
#define ZBX_PROCESS_TYPE_HISTSYNCER	9
#define ZBX_PROCESS_TYPE_DISCOVERER	10
#define ZBX_PROCESS_TYPE_ALERTER	11
#define ZBX_PROCESS_TYPE_TIMER		12
#define ZBX_PROCESS_TYPE_NODEWATCHER	13
