...
insert into help_items values(0,'system.hw.chassis[&lt;info&gt;]','Chassis info (type, vendor, model or serial)');
insert into help_items values(0,'system.hw.cpu[&lt;cpu&gt;]','CPU info (all is default)');
insert into help_items values(0,'system.hw.devices[&lt;type&gt;]','Device list (all is default)');
insert into help_items values(0,'system.hw.macaddr[&lt;interface&gt;]','MAC address list comma delimited (all is default)');
...
insert into help_items values(0,'system.sw.arch[&lt;info&gt;]','Chassis info (type, vendor, model or serial)');
insert into help_items values(0,'system.sw.os[&lt;cpu&gt;]','CPU info (all is default)');
insert into help_items values(0,'system.sw.packages','Device list (all is default)');
...
insert into help_items values(7,'system.hw.chassis[&lt;info&gt;]','Chassis info (type, vendor, model or serial)');
insert into help_items values(7,'system.hw.cpu[&lt;cpu&gt;]','CPU info (all is default)');
insert into help_items values(7,'system.hw.devices[&lt;type&gt;]','Device list (all is default)');
insert into help_items values(7,'system.hw.macaddr[&lt;interface&gt;]','MAC address list comma delimited (all is default)');
...
insert into help_items values(7,'system.sw.arch[&lt;info&gt;]','Chassis info (type, vendor, model or serial)');
insert into help_items values(7,'system.sw.os[&lt;cpu&gt;]','CPU info (all is default)');
insert into help_items values(7,'system.sw.packages','Device list (all is default)');
