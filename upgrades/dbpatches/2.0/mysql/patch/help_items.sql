...
insert into help_items values(0,'system.hw.chassis[&lt;info&gt;]','Chassis info - returns chassis type by default');
insert into help_items values(0,'system.hw.cpu[&lt;cpu&gt;,&lt;info&gt;]','CPU info - listing full info for all CPUs by default');
insert into help_items values(0,'system.hw.devices[&lt;type&gt;]','Device list - listing PCI devices by default');
insert into help_items values(0,'system.hw.macaddr[&lt;interface&gt;]','MAC address - listing all MAC addresses by default');
...
insert into help_items values(0,'system.sw.os[&lt;info&gt;]','Current OS - returns only the name by default');
insert into help_items values(0,'system.sw.packages','Software package list');
...
insert into help_items values(7,'system.hw.chassis[&lt;info&gt;]','Chassis info - returns chassis type by default');
insert into help_items values(7,'system.hw.cpu[&lt;cpu&gt;,&lt;info&gt;]','CPU info - listing full info for all CPUs by default');
insert into help_items values(7,'system.hw.devices[&lt;type&gt;]','Device list - listing PCI devices by default');
insert into help_items values(7,'system.hw.macaddr[&lt;interface&gt;]','MAC address - listing all MAC addresses by default');
...
insert into help_items values(7,'system.sw.os[&lt;info&gt;]','Current OS - returns only the name by default');
insert into help_items values(7,'system.sw.packages','Software package list');
