...
insert into help_items values(0,'system.hw.macaddr[&lt;interface&gt;,&lt;onlymacs&gt;]','MAC address - lists all MAC addresses with interface names by default');
...
insert into help_items values(0,'system.sw.packages[&lt;package&gt;,&lt;manager&gt;,&lt;onlylist&gt;]','Software package list - lists all packages for all supported package managers by default');
...
insert into help_items values(7,'system.hw.macaddr[&lt;interface&gt;,&lt;onlymacs&gt;]','MAC address - lists all MAC addresses with interface names by default');
...
insert into help_items values(7,'system.sw.packages[&lt;package&gt;,&lt;manager&gt;,&lt;onlylist&gt;]','Software package list - lists all packages for all supported package managers by default');
