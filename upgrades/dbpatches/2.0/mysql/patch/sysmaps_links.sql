ALTER TABLE sysmaps_links MODIFY sysmapid bigint unsigned NOT NULL;
ALTER TABLE sysmaps_links MODIFY selementid1 bigint unsigned NOT NULL;
ALTER TABLE sysmaps_links MODIFY selementid2 bigint unsigned NOT NULL;
