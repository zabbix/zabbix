ALTER TABLE ONLY graphs ALTER templateid DROP DEFAULT;
ALTER TABLE ONLY graphs ALTER templateid DROP NOT NULL;
ALTER TABLE ONLY graphs ALTER ymin_itemid DROP DEFAULT;
ALTER TABLE ONLY graphs ALTER ymin_itemid DROP NOT NULL;
ALTER TABLE ONLY graphs ALTER ymax_itemid DROP DEFAULT;
ALTER TABLE ONLY graphs ALTER ymax_itemid DROP NOT NULL;
