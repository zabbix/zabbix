...
(function() {
	...
	function isArray(object) {
		if (IE)
			if (_toString.call(object) == "[object Array]") return true; else if (is_array(object)) return true; else return false; else
...
Object.extend(Selector, {
	...
	handlers: {
		...
		unmark: (function() {
			...
			return PROPERTIES_ATTRIBUTES_MAP ? function(nodes) {
				for (var i = 0, node; node = nodes[i]; i++)
