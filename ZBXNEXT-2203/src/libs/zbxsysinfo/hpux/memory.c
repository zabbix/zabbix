...
#define ZBX_PSTAT_GETSTATIC()								\
	...
	{										\
		SET_MSG_RESULT(result, zbx_strdup(NULL, "Failed pstat_getstatic."));	\
...
int	VM_MEMORY_SIZE(AGENT_REQUEST *request, AGENT_RESULT *result)
{
	...
	{
		SET_MSG_RESULT(result, zbx_strdup(NULL, "Invalid mode. Must be one of: active, available, free, pavailable, pused, total, used."));
