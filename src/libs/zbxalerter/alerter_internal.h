...
#define ZBX_OAUTH2_TOKEN_INVALID	0
#define ZBX_OAUTH2_TOKEN_ACCESS_VALID	1
#define ZBX_OAUTH2_TOKEN_REFRESH_VALID	2

#define ZBX_OAUTH2_TOKEN_VALID		(ZBX_OAUTH2_TOKEN_ACCESS_VALID | ZBX_OAUTH2_TOKEN_REFRESH_VALID)
