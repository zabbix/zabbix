...
#else
	SET_UI64_RESULT(result, kn.value.ull);
#endif
    }
...
#else
	SET_UI64_RESULT(result, kn.value.ul);
#endif
    }
...
#else
	SET_UI64_RESULT(result, ikn.value.ull + okn.value.ull);
#endif
    }
...
#else
	SET_UI64_RESULT(result, ikn.value.ul + okn.value.ul);
#endif
    }
