...
#	define ZBX_DB_MAX_PARAMS	9
	...
	if (ZBX_DB_OK == ret &&
			0 != MYSQL_OPTIONS(conn, MYSQL_INIT_COMMAND, "set @@session.auto_increment_increment=1"))
	{
	...
	if (ZBX_DB_OK == ret &&
			0 != MYSQL_OPTIONS(conn, MYSQL_INIT_COMMAND, "set @@session.auto_increment_offset=1"))
	{
