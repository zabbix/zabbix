...
/******************************************************************************
 *                                                                            *
 * Function: zbx_db_add_event_suppress_record                                 *
 *                                                                            *
...
/******************************************************************************
 *                                                                            *
 * Function: zbx_db_insert_event_suppress_records                             *
 *                                                                            *
 * Purpose: inserts event suppress records into event_suppress table          *
 *                                                                            *
 * Return value: SUCCEED - event suppress records were inserted successfully  *
 *               FAIL - otherwise                                             *
 *                                                                            *
 * Comments: To handle potential maintenance removal by frontend first used   *
 *           maintenanceids are selected for update and only suppress records *
 *           related to the returned maintenanceids are inserted.             *
 *                                                                            *
 ******************************************************************************/
int	zbx_db_insert_event_suppress_records(zbx_vector_ptr_t *records)
{
	...
	{
		record = (zbx_event_suppress_t *)records->values[i];
		zbx_vector_uint64_append(&maintenanceids, record->maintenanceid);
	}
	...
	if (0 != maintenanceids.values_num)
	{
		...
		{
			record = (zbx_event_suppress_t *)records->values[i];
			if (FAIL != zbx_vector_uint64_bsearch(&maintenanceids, record->maintenanceid,
