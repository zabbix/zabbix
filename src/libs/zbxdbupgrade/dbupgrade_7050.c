			...
			{"devices", "id", 0,
				{
					...
					{"app_identity_key", "", NULL, NULL, 255, ZBX_TYPE_CHAR, 0, 0},
					{"app_encryption_key", "", NULL, NULL, 255, ZBX_TYPE_CHAR, 0, 0},
					{"push_token", "", NULL, NULL, 255, ZBX_TYPE_CHAR, 0, 0},
					{"last_access_time", "0", NULL, NULL, 0, ZBX_TYPE_INT, 0, 0},
