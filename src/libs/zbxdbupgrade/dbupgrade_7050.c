...
static int	DBpatch_7050028(void)
{
	...
	const char	*values[] = {
		...
		"web.hosts.host_discovery.filter.enabled_lifetime_type", "web.hosts.lldrules.filter.enabled_lifetime_type",
		...
		"web.templates.host_discovery.filter.enabled_lifetime_type", "web.templates.lldrules.filter.enabled_lifetime_type",
		"web.templates.host_discovery.filter.enabled_lifetime", "web.templates.lldrules.filter.enabled_lifetime",
