...
typedef struct
{
	...
	const char *	os_full;
	const char *	os_short;
	const char *	serialno_a;
	const char *	serialno_b;
	const char *	tag;
	const char *	asset_tag;
	const char *	macaddress_a;
	const char *	macaddress_b;
	const char *	hardware;
	const char *	software;
	const char *	software_app_a;
	const char *	software_app_b;
	const char *	software_app_c;
	const char *	software_app_d;
	const char *	software_app_e;
	const char *	location_lat;
	const char *	location_lon;
	const char *	chassis;
	const char *	model;
	const char *	hw_arch;
	const char *	vendor;
	const char *	contract_number;
	const char *	installer_name;
	const char *	deployment_status;
	const char *	url_a;
	const char *	url_b;
	const char *	url_c;
	const char *	host_netmask;
	const char *	host_router;
	const char *	oob_ip;
	const char *	oob_netmask;
	const char *	oob_router;
	const char *	date_hw_purchase;
	const char *	date_hw_install;
	const char *	date_hw_expiry;
	const char *	date_hw_decomm;
	const char *	site_address_a;
	const char *	site_address_b;
	const char *	site_address_c;
	const char *	site_city;
	const char *	site_state;
	const char *	site_country;
	const char *	site_zip;
	const char *	site_rack;
	const char *	poc_1_name;
	const char *	poc_1_email;
	const char *	poc_1_phone_a;
	const char *	poc_1_phone_b;
	const char *	poc_1_cell;
	const char *	poc_1_screen;
	const char *	poc_2_name;
	const char *	poc_2_email;
	const char *	poc_2_phone_a;
	const char *	poc_2_phone_b;
	const char *	poc_2_cell;
	const char *	poc_2_screen;
	const char *	hardware_full;
	const char *	software_full;
	const char *	contact;
	const char *	location;
	const char *	notes;
	const char *	host_networks;
	const char *	site_notes;
	const char *	poc_1_notes;
	const char *	poc_2_notes;
}
