...
static void	zbx_load_config(ZBX_TASK_EX *task)
{
	zbx_cfg_line_t	cfg[] =
	{
		...
		{"HostnameItem",		&config_hostname_item,			ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"StartDBSyncers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_HISTSYNCER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	1,			100},
		{"StartDiscoverers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_DISCOVERER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartHTTPPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_HTTPPOLLER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		...
		{"StartPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_POLLER],			ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartPollersUnreachable",	&CONFIG_FORKS[ZBX_PROCESS_TYPE_UNREACHABLE],	ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartIPMIPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_IPMIPOLLER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartTrappers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_TRAPPER],			ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartJavaPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_JAVAPOLLER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		...
		{"SNMPTrapperFile",		&zbx_config_snmptrap_file,		ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"StartSNMPTrapper",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_SNMPTRAPPER],		ZBX_CFG_TYPE_INT,
		...
		{"DBUser",			&(zbx_config_dbhigh->config_dbuser),	ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"DBPassword",			&(zbx_config_dbhigh->config_dbpassword),	ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		...
		{"AllowUnsupportedDBVersions",	&config_allow_unsupported_db_versions,	ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1},
		{"DBTLSConnect",		&(zbx_config_dbhigh->config_db_tls_connect),	ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"DBTLSCertFile",		&(zbx_config_dbhigh->config_db_tls_cert_file),	ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"DBTLSKeyFile",		&(zbx_config_dbhigh->config_db_tls_key_file),	ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"DBTLSCAFile",			&(zbx_config_dbhigh->config_db_tls_ca_file),	ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"DBTLSCipher",			&(zbx_config_dbhigh->config_db_tls_cipher),	ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"DBTLSCipher13",		&(zbx_config_dbhigh->config_db_tls_cipher_13),	ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		...
		{"StatsAllowedIP",		&config_stats_allowed_ip,		ZBX_CFG_TYPE_STRING_LIST,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"StartPreprocessors",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_PREPROCESSOR],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	1,			1000},
		{"ListenBacklog",		&config_tcp_max_backlog_size,		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			INT_MAX},
		{"StartODBCPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_ODBCPOLLER],	ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		...
		{"ProxyBufferMode",		&config_proxy_buffer_mode_str,		ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,	0},
		{"StartHTTPAgentPollers",	&CONFIG_FORKS[ZBX_PROCESS_TYPE_HTTPAGENT_POLLER],	ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartAgentPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_AGENT_POLLER],	ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartSNMPPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_SNMP_POLLER],	ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"MaxConcurrentChecksPerPoller",	&config_max_concurrent_checks_per_poller,	ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	1,			1000},
		{NULL}
	};
