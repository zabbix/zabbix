...
static void	zbx_load_config(ZBX_TASK_EX *task)
{
	...
	{
		/* PARAMETER,			VAR,					TYPE,
			MANDATORY,	MIN,	MAX,	CUSTOM PARSER */
		{"ProxyMode",			&CONFIG_PROXYMODE,			TYPE_INT,
			PARM_OPT,	ZBX_PROXYMODE_ACTIVE,	ZBX_PROXYMODE_PASSIVE,	NULL},
		{"Server",			&CONFIG_SERVER,				TYPE_STRING,
			PARM_MAND,	0,	0,	NULL},
		{"ServerPort",			&CONFIG_SERVER_PORT,			TYPE_INT,
			PARM_OPT,	1024,	32767,	NULL},
		...
		{"CacheSize",			&CONFIG_CONF_CACHE_SIZE,		TYPE_UINT64,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	__UINT64_C(8) * ZBX_GIBIBYTE,	NULL},
		{"HistoryCacheSize",		&CONFIG_HISTORY_CACHE_SIZE,		TYPE_UINT64,
			PARM_OPT,	128 * ZBX_KIBIBYTE,	__UINT64_C(2) * ZBX_GIBIBYTE,	NULL},
