...
const char	*help_message[] = {
	...
	"                                 (configuration syncer, heartbeat sender,",
	"                                 data sender, ipmi manager, housekeeper,",
	"                                 http poller, discoverer, history syncer,",
	"                                 ipmi poller, java poller, snmp trapper,",
	"                                 self-monitoring, vmware collector,",
	"                                 task manager, poller, unreachable poller,",
	"                                 trapper, icmp pinger)",
