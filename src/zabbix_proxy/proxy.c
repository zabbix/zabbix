...
const char	*help_message[] = {
	...
	"        process-type             All processes of specified type (data sender,",
	"                                 poller, configuration syncer, heartbeat sender,",
	"                                 unreachable poller, trapper, icmp pinger,",
	"                                 housekeeper, http poller, discoverer,",
	"                                 history syncer, java poller, snmp trapper,",
	"                                 self-monitoring, vmware collector,",
	"                                 ipmi manager, ipmi poller, task manager)",
