...
const char	*usage_message[] = {
	...
	"[-v] -z server [-p port] [-I IP-address] -s host --tls-connect=cert --tls-ca-file=ca_file [--tls-crl-file=crl_file] [--tls-server-cert-issuer=certificate_issuer] [--tls-server-cert-subject=certificate_subject] --tls-cert-file=cert_file --tls-key-file=key_file -k key -o value",
	"[-v] -z server [-p port] [-I IP-address] [-s host] --tls-connect=cert --tls-ca-file=ca_file [--tls-crl-file=crl_file] [--tls-server-cert-issuer=certificate_issuer] [--tls-server-cert-subject=certificate_subject] --tls-cert-file=cert_file --tls-key-file=key_file [-T] [-r] -i input-file",
	"[-v] -c config-file [-z server] [-p port] [-I IP-address] [-s host] --tls-connect=cert --tls-ca-file=ca_file [--tls-crl-file=crl_file] [--tls-server-cert-issuer=certificate_issuer] [--tls-server-cert-subject=certificate_subject] --tls-cert-file=cert_file --tls-key-file=key_file -k key -o value",
	"[-v] -c config-file [-z server] [-p port] [-I IP-address] [-s host] --tls-connect=cert --tls-ca-file=ca_file [--tls-crl-file=crl_file] [--tls-server-cert-issuer=certificate_issuer] [--tls-server-cert-subject=certificate_subject] --tls-cert-file=cert_file --tls-key-file=key_file [-T] [-r] -i input-file",
	...
	"[-v] -c config-file [-z server] [-p port] [-I IP-address] [-s host] --tls-connect=psk --tls-psk-identity=psk_identity --tls-psk-file=psk_file [-T] [-r] -i input-file",
#endif
	"-h",
	"-V",
	NULL	/* end of text */
