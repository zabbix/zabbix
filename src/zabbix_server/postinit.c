...
static void	preprocess_trigger_name(DB_TRIGGER *trigger, int *historical)
{
	...
	*historical = FAIL;
	...
	substitute_simple_macros(NULL, &event, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
...
static int	process_event_update(const DB_TRIGGER *trigger, char **sql, size_t *sql_alloc, size_t *sql_offset)
{
	...
	while (SUCCEED == ret && NULL != (row = DBfetch(result)))
	{
		...
		substitute_simple_macros(NULL, &event, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, &name,
