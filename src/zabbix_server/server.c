...
static void	zbx_load_config(ZBX_TASK_EX *task)
{
	zbx_cfg_line_t	cfg[] =
	{
		...
		{"StartJavaPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_JAVAPOLLER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartEscalators",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_ESCALATOR],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	1,			100},
		...
		{"StartProxyPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_PROXYPOLLER],		ZBX_CFG_TYPE_INT,
		...
		{"SocketDir",			&CONFIG_SOCKET_PATH,			ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"StartAlerters",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_ALERTER],			ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	1,			100},
		...
		{"StartLLDProcessors",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_LLDWORKER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	1,			100},
		{"StatsAllowedIP",		&config_stats_allowed_ip,		ZBX_CFG_TYPE_STRING_LIST,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"StartHistoryPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_HISTORYPOLLER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartReportWriters",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_REPORTWRITER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			100},
		{"WebServiceURL",		&zbx_config_webservice_url,		ZBX_CFG_TYPE_STRING,
			ZBX_CONF_PARM_OPT,	0,			0},
		{"ProblemHousekeepingFrequency",	&config_problemhousekeeping_frequency,	ZBX_CFG_TYPE_INT,
		...
		{"StartODBCPollers",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_ODBCPOLLER],		ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
		{"StartConnectors",		&CONFIG_FORKS[ZBX_PROCESS_TYPE_CONNECTORWORKER],	ZBX_CFG_TYPE_INT,
			ZBX_CONF_PARM_OPT,	0,			1000},
