...
const char	*help_message[] = {
	...
	"                                 (configuration syncer, ipmi manager, alerter,",
	"                                 housekeeper, timer, http poller, discoverer,",
	"                                 history syncer, escalator, ipmi poller,",
	"                                 java poller, snmp trapper, proxy poller,",
	"                                 self-monitoring, vmware collector,",
	"                                 task manager, poller, unreachable poller,",
	"                                 trapper, icmp pinger, alert manager,",
