...
const char	*help_message[] = {
	...
	"        process-type             All processes of specified type (poller,",
	"                                 configuration syncer, unreachable poller,",
	"                                 trapper, icmp pinger, alerter,housekeeper,",
	"                                 timer, http poller, discoverer, history syncer,",
	"                                 escalator, java poller, snmp trapper,",
	"                                 proxy poller, self-monitoring,",
	"                                 vmware collector, task manager,",
	"                                 preprocessing manager, preprocessing worker,",
	"                                 ipmi manager, ipmi poller, alert manager)",
	"",
