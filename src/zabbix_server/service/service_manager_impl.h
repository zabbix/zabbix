...
#define ZBX_SERVICE_CALC_STATUS_MORE		0
#define ZBX_SERVICE_CALC_STATUS_MORE_PERC	1
#define ZBX_SERVICE_CALC_STATUS_LESS		2
#define ZBX_SERVICE_CALC_STATUS_LESS_PERC	3
#define ZBX_SERVICE_CALC_WEIGHT_MORE		4
#define ZBX_SERVICE_CALC_WEIGHT_MORE_PERC	5
#define ZBX_SERVICE_CALC_WEIGHT_LESS		6
#define ZBX_SERVICE_CALC_WEIGHT_LESS_PERC	7
