...
static void	zbx_load_config(int requirement, ZBX_TASK_EX *task)
{
	...
	struct cfg_line	cfg[] =
	{
		...
		{"RefreshActiveChecks",		&CONFIG_REFRESH_ACTIVE_CHECKS,		TYPE_INT,
			PARM_OPT,	SEC_PER_MIN,	SEC_PER_HOUR,	NULL},
		...
		{"TLSPSKFile",			&CONFIG_TLS_PSK_FILE,			TYPE_STRING,
			PARM_OPT,	0,	0,	NULL},
		{"AllowKey",			NULL,					TYPE_MULTISTRING,
			PARM_OPT,	0,	0,	load_key_access_rule},
		{"DenyKey",			NULL,					TYPE_MULTISTRING,
			PARM_OPT,	0,	0,	load_key_access_rule},
		{NULL}
	};
