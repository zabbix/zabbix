...
func (_mock *Scheduler) FinishTask(task any) {
	_mock.Called(task)
	return
}
...
func (_c *Scheduler_FinishTask_Call) Run(run func(task any)) *Scheduler_FinishTask_Call {
...
func (_c *Scheduler_FinishTask_Call) RunAndReturn(run func(task any)) *Scheduler_FinishTask_Call {
	_c.Run(run)
	return _c
}
