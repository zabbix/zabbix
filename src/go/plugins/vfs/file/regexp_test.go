...
func TestFileRegexpOutput(t *testing.T) {
	...
	// iso-8859-5 encoded
	fileContents_ISO_8859_5 := []byte{0xd2, 0xeb, 0xe5, 0xe3, 0xe5, 0xde, 0xdb, 0xec, 0x0a, 0x0a,
		0x62, 0x61, 0x64, 0x67, 0x65, 0x72, 0x0a, 0x0a, 0xd2, 0xeb,
		0xe5, 0xe3, 0xe5, 0xde, 0xdb, 0xec, 0x32, 0x0a}

	// // UTF1-16LE encoded
	fileContents_UTF_16LE := []byte{0x32, 0x04, 0x4b, 0x04, 0x45, 0x04, 0x43, 0x04, 0x45, 0x04, 0x3e, 0x04,
		0x3b, 0x04, 0x4c, 0x04, 0x0a, 0x00, 0x0a, 0x00, 0x62, 0x00, 0x61, 0x00, 0x64, 0x00, 0x67, 0x00,
		0x65, 0x00, 0x72, 0x00, 0x0a, 0x00, 0x0a, 0x00, 0x32, 0x04, 0x4b, 0x04, 0x45, 0x04, 0x43, 0x04,
		0x45, 0x04, 0x3e, 0x04, 0x3b, 0x04, 0x4c, 0x04, 0x32, 0x00, 0x0a, 0x00}
	...
	tests := []*testCase{
		...
		&testCase{fileContents: fileContents_UTF_16LE, targetSearch: "хух", targetEncoding: "UTF-16LE", lineStart: "1", lineEnd: "",
			targetStringGroup: "", targetContents: "выхухоль\n"},

		&testCase{fileContents: fileContents_UTF_16LE, targetSearch: "выхухоль2\n", targetEncoding: "UTF-16LE", lineStart: "", lineEnd: "2",
			targetStringGroup: "", targetContents: ""},
