...
const (
	...
	cannotMarshalJSON = "cannot marshal JSON"
	connectionFailed  = "connection failed"
	unsupportedMetric = "unsupported metric"
	emptyResult       = "empty result"
	unknownSession    = "unknown session"
)

var (
	ErrorInvalidParams     = New(invalidParams)
	ErrorTooManyParameters = New(tooManyParameters)
	ErrorCannotFetchData   = New(cannotFetchData)
	ErrorCannotMarshalJSON = New(cannotMarshalJSON)
	ErrorConnectionFailed  = New(connectionFailed)
	ErrorUnsupportedMetric = New(unsupportedMetric)
	ErrorEmptyResult       = New(emptyResult)
	ErrorUnknownSession    = New(unknownSession)
)
