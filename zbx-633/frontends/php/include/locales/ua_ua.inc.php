...
<?php
	...
	'S_ITEM_SLASH_FUNCTION'=>			'Елемент / Функція',
	...
	'S_CUSER_ERROR_ACCOUNT_IS_BLOCKED_FOR_XX_MINUTES'=>			'Обліковий запис заблоковано на %s секунд',
	...
	'S_CUSER_ERROR_USER_EXISTS'=>			'Користувач [ %1$s ] вже існує',
	'S_CUSER_ERROR_CANT_RENAME_GUEST_USER'=>			'Неможливо перейменувати користувача guest',
	'S_CUSER_ERROR_USER_UNABLE_RESTRICT_SELF_GUI_ACCESS'=>			'Користувач не може обмежити доступ до GUI для самого себе. Група \'%1$s\'',
	'S_CUSER_ERROR_USER_CANT_DISABLE_SELF'=>			'Користувач не може дезактивувати себе самого. Група \'%1$s\'',
	'S_CUSER_ERROR_INCORRECT_TIME_PERIOD'=>			'Некоректний період часу',
	'S_CUSER_ERROR_WRONG_PERIOD'=>			'Невірний період [ %1$s ]',
	'S_CUSER_ERROR_INTERNAL_ZABBIX_ERROR'=>			'Внутрішня помилка zabbix',
	'S_CONFIG_NOT_LOGGED_IN_ACCESS_DENIED'=>			'Ви не можете переглядати цей URL як ',
	...
	'S_CONFIG_WARNING_WRONG_MONTH'=>			'[Невірне значення для місяця: %1$s]',
	'S_CONFIG_WARNING_WRONG_DOW'=>			'[Невірне значення для дня тижня: %1$s]',
	'S_HELP'=>			'Допомога',
	'S_PROFILE'=>			'Профіль',
