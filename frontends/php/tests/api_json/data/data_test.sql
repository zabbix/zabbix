...
-- testTaskCreate
INSERT INTO hosts (hostid, host, name, status, description) VALUES (110001, 'Has two items', 'Has two items', 0, '');
INSERT INTO items (itemid, type, hostid, name, description, key_, delay, interfaceid, params, formula, url, posts, query_fields, headers) VALUES (110001, 7, 110001, 'Agent-active', '', 'agent.ping[]', 30, NULL, '', '', '', '', '','');
INSERT INTO items (itemid, type, hostid, name, description, key_, delay, interfaceid, params, formula, url, posts, query_fields, headers) VALUES (110002, 0, 110001, 'Agent-passive', '', 'agent.ping', 30, NULL, '', '', '', '', '','');
