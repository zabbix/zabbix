...
require_once dirname(__FILE__).'/testHostInventoryGet.php';
require_once dirname(__FILE__).'/testHostInventoryCreate.php';
require_once dirname(__FILE__).'/testHostPrototypeInventoryGet.php';
require_once dirname(__FILE__).'/testHostPrototypeInventoryCreate.php';
require_once dirname(__FILE__).'/testHostPrototypeInventoryUpdate.php';
...
class ApiJsonTests {
	public static function suite() {
		...
		$suite->addTestSuite('testHostPrototypeInventoryGet');
		$suite->addTestSuite('testHostPrototypeInventoryCreate');
		$suite->addTestSuite('testHostPrototypeInventoryUpdate');
