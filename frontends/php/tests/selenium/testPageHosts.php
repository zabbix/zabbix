...
class testPageHosts extends CLegacyWebTest {
	...
	*/
	...
	public function testPageHosts_FilterByTemplates() {
		...
		$this->zbxTestClickXpathWait('//div[contains(@class, "overlay-dialogue modal modal-popup")]//select/option[text()="Templates"]');
		$this->zbxTestClickXpathWait('//div[contains(@class, "overlay-dialogue modal modal-popup")]//a[text()="Form test template"]');
		$this->zbxTestClickButtonText('Apply');
