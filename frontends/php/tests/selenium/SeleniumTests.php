...
require_once dirname(__FILE__).'/testFormHostItemTest.php';
...
require_once dirname(__FILE__).'/testFormTemplateItemTest.php';
...
*/
		...
		$suite->addTestSuite('testFormHostItemTest');
		...
		$suite->addTestSuite('testFormTemplateItemTest');
