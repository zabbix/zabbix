...
class testPageDashboard extends CWebTest {
		...
		foreach ($users as $user) {
			switch ($user) {
				...
				case 'admin' :
					...
					$this->zbxTestCheckTitle('Dashboard');
					$this->zbxTestCheckHeader('Dashboard');
					$this->zbxTestAssertElementText("//div[@class='dashbrd-grid-widget-container']/div[9]//h4", 'Discovery status');
					$this->zbxTestAssertElementText("//div[@class='dashbrd-grid-widget-container']/div[9]//a[@href='zabbix.php?action=discovery.view&druleid=3']", 'External network');
				...
				case 'user';
					...
					$this->zbxTestCheckTitle('Dashboard');
					$this->zbxTestCheckHeader('Dashboard');
					$this->zbxTestAssertElementNotPresentXpath("//div[@class='dashbrd-grid-widget-container']/div[9]//h4");
					$this->zbxTestAssertElementNotPresentXpath("//div[@class='dashbrd-grid-widget-container']/div[10]//h4");
					break;
				case 'guest';
					$this->zbxTestOpen('zabbix.php?action=dashboard.view');
			...
			$this->zbxTestAssertElementText("//div[@class='dashbrd-grid-widget-container']/div[5]//h4", 'Last 20 issues');
			$this->zbxTestAssertElementText("//div[@class='dashbrd-grid-widget-container']/div[6]//h4", 'Web monitoring');
			$this->zbxTestAssertElementText("//div[@class='dashbrd-grid-widget-container']/div[7]//h4", 'Host status');
	...
	public function testPageDashboard_RemoveFavouriteGraphs() {
		...
		foreach ($FavouriteGraphs as $FavouriteGraph) {
			...
			$this->zbxTestClickXpath("//div[@class='dashbrd-grid-widget-container']/div[2]//button[@onclick=\"rm4favorites('graphid','".$FavouriteGraph['value_id']."')\"]");
		}
		$this->zbxTestAssertElementText("//div[@class='dashbrd-grid-widget-container']/div[2]//tr[@class='nothing-to-show']/td", 'No graphs added.');
		$this->zbxTestCheckFatalErrors();
	...
	public function testPageDashboard_RemoveFavouriteScreens() {
		...
		foreach ($FavouriteScreens as $FavouriteScreen) {
			...
			$this->zbxTestClickXpath("//div[@class='dashbrd-grid-widget-container']/div[3]//button[@onclick=\"rm4favorites('screenid','".$FavouriteScreen['value_id']."')\"]");
		}
		$this->zbxTestAssertElementText("//div[@class='dashbrd-grid-widget-container']/div[3]//tr[@class='nothing-to-show']/td", 'No screens added.');
		$this->zbxTestCheckFatalErrors();
	...
	public function testPageDashboard_RemoveFavouriteMaps() {
		...
		foreach ($FavouriteScreens as $FavouriteScreen) {
			...
			$this->zbxTestClickXpath("//div[@class='dashbrd-grid-widget-container']/div[4]//button[@onclick=\"rm4favorites('sysmapid','".$FavouriteScreen['value_id']."')\"]");
		}
		$this->zbxTestAssertElementText("//div[@class='dashbrd-grid-widget-container']/div[4]//tr[@class='nothing-to-show']/td", 'No maps added.');
		$this->zbxTestCheckFatalErrors();
