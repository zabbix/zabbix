...
$fields = [
	...
	'expandproblem' =>			[T_ZBX_INT, O_OPT, null,	BETWEEN(SYSMAP_PROBLEMS_NUMBER, SYSMAP_PROBLEMS_NUMBER_CRITICAL),	null],
...
if (hasRequest('add') || hasRequest('update')) {
	$map = [
		...
		'expandproblem' => getRequest('expandproblem', SYSMAP_SINGLE_PROBLEM),
