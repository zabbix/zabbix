...
<?php
	...
	//			}
			...
			if($_REQUEST["register"]=="update")
			{
				...
				$result=update_screen_item($_REQUEST["screenitemid"],$_REQUEST["resource"],
					$_REQUEST["resourceid"],$_REQUEST["width"],$_REQUEST["height"],
					$_REQUEST["colspan"],$_REQUEST["rowspan"],$_REQUEST["elements"]);
...
<?php
	...
	// Map
			...
			$form = new CForm("screenedit.php");
			$form->AddItem($item);
			array_push($new_cols, new CCol($form,"screen"));
		}
		echo "</TR>\n";
