...
$tranStrings = [
	...
	'dashboard.grid.js' => [
		...
		'Release to create a new widget in the selected area.' => _('Release to create a new widget in the selected area.'),
		'Click and drag to mark desired widget size.' => _('Click and drag to mark desired widget size.'),
