...
$tranStrings = [
	...
	'class.calendar.js' => [
		...
		'S_calendar_helptext' => _('Press Tab keyboard button to switch between calendar year, month and date sections. Press the arrow keys to select year, month and date. Confirm changes by pressing Space or Enter keyboard buttons. Press Escape to close calendar and cancel changes.'),
		'S_JANUARY' => _('January'),
