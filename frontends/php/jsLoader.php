...
$tranStrings = [
	...
	'multiselect.js' => [
		...
		'%1$s, read only' => pgettext(ZBX_CONTEXT_SCREEN_READER, '%1$s, read only'),
		'Can not be removed' => pgettext(ZBX_CONTEXT_SCREEN_READER, 'Can not be removed'),
		'Selected, %1$s in position %2$d of %3$d' => pgettext(ZBX_CONTEXT_SCREEN_READER, 'Selected, %1$s in position %2$d of %3$d'),
		'Selected, %1$s, read only, in position %2$d of %3$d' => pgettext(ZBX_CONTEXT_SCREEN_READER, 'Selected, %1$s, read only, in position %2$d of %3$d'),
