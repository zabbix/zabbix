...
$tranStrings = [
	...
	'multiselect.js' => [
		...
		'new' => _('new'),
		'Select' => _('Select'),
		'Added, %1$s' => _x(ZBX_CONTEXT_SCREEN_READER, 'Added, %1$s'),
		'Removed, %1$s' => _x(ZBX_CONTEXT_SCREEN_READER, 'Removed, %1$s'),
		'%1$s, read only' => _x(ZBX_CONTEXT_SCREEN_READER, '%1$s, read only'),
		'Can not be removed' => _x(ZBX_CONTEXT_SCREEN_READER, 'Can not be removed'),
		'Selected, %1$s in position %2$d of %3$d' => _x(ZBX_CONTEXT_SCREEN_READER, 'Selected, %1$s in position %2$d of %3$d'),
		'Selected, %1$s, read only, in position %2$d of %3$d' => _x(ZBX_CONTEXT_SCREEN_READER, 'Selected, %1$s, read only, in position %2$d of %3$d'),
		'More than %1$d matches for %2$s found' => _x(ZBX_CONTEXT_SCREEN_READER, 'More than %1$d matches for %2$s found'),
		'%1$d matches for %2$s found' => _x(ZBX_CONTEXT_SCREEN_READER, '%1$d matches for %2$s found'),
		'%1$s preselected, use down,up arrow keys and enter to select' => _x(ZBX_CONTEXT_SCREEN_READER, '%1$s preselected, use down,up arrow keys and enter to select')
	],
	'menupopup.js' => [
