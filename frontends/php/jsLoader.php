...
$tranStrings = [
	...
	'multiselect.js' => [
		...
		'new' => _('new'),
		'Select' => _('Select'),
		'Added, %1$s' => _x('Added, %1$s', ZBX_CONTEXT_SCREEN_READER),
		'Removed, %1$s' => _x('Removed, %1$s', ZBX_CONTEXT_SCREEN_READER),
		'%1$s, read only' => _x('%1$s, read only', ZBX_CONTEXT_SCREEN_READER),
		'Can not be removed' => _x('Can not be removed', ZBX_CONTEXT_SCREEN_READER),
		'Selected, %1$s in position %2$d of %3$d' => _x('Selected, %1$s in position %2$d of %3$d', ZBX_CONTEXT_SCREEN_READER),
		'Selected, %1$s, read only, in position %2$d of %3$d' => _x('Selected, %1$s, read only, in position %2$d of %3$d', ZBX_CONTEXT_SCREEN_READER),
		'More than %1$d matches for %2$s found' => _x('More than %1$d matches for %2$s found', ZBX_CONTEXT_SCREEN_READER),
		'%1$d matches for %2$s found' => _x('%1$d matches for %2$s found', ZBX_CONTEXT_SCREEN_READER),
		'%1$s preselected, use down,up arrow keys and enter to select' => _x('%1$s preselected, use down,up arrow keys and enter to select', ZBX_CONTEXT_SCREEN_READER)
	],
	'menupopup.js' => [
