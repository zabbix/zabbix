...
$tranStrings = [
	...
	'class.calendar.js' => [
		...
		'S_calendar_helptext' => _('Press Tab keyboard button to switch between calendar year, month, and date sections. Press the arrow keys to select date, month and year. By pressing Space bar you can select date. Press Enter to confirm selected date or Escape to close calendar.'),
		'S_JANUARY' => _('January'),
