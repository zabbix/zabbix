...
class CControllerAcknowledgeEdit extends CController {
	...
	protected function doAction() {
		...
		// Get which events are generated by editable triggers.
		...
		foreach ($events as $event) {
			...
			elseif ($event['relatedObject']['manual_close'] == ZBX_TRIGGER_MANUAL_CLOSE_NOT_ALLOWED
			...
			// Make 'Close problem' checkbox enabled.
			if ($can_be_closed) {
