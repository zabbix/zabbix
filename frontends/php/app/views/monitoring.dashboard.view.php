...
$form = (new CForm('post', (new CUrl('zabbix.php'))->setArgument('action', 'dashboard.update')->getUrl()))
...
$add_user_group_btn = ([(new CButton(null, _('Add')))
	->onClick(
		"return PopUp('popup.php?dstfrm=".$form->getName(). "&srctbl=usrgrp&srcfld1=usrgrpid&srcfld2=name&multiselect=1')"
	)
...
$form
	...
	->addItem(new CInput('hidden', 'users[no-users]', '1'))
	// indicator to help delete all user groups
	->addItem(new CInput('hidden', 'userGroups[no-groups]', '1'))
