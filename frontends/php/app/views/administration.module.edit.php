...
$module_tab = (new CFormList())
	...
	->addRow(_('Author'), $data['author'] === null ? '-' : $data['author'])
	->addRow(_('Description'), $data['description'] === null ? '-' : $data['description'])
	->addRow(_('Directory'), $data['relative_path'] === null ? '-' : $data['relative_path'])
	->addRow(_('Namespace'), $data['namespace'] === null ? '-' : $data['namespace'])
	->addRow(_('Homepage'), $data['url'] === null ? '-' : $data['url'])
	->addRow(_('Enabled'),
