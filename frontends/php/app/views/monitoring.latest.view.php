...
if ($data['filter']['showDetails']) {
	$table->setHeader([
		$toggle_all,
		$check_all,
		make_sorting_header(_('Host'), 'host', $data['sortField'], $data['sortOrder'])->addStyle('width: 13%'),
		make_sorting_header(_('Name'), 'name', $data['sortField'], $data['sortOrder'])->addStyle('width: 21%'),
		...
		make_sorting_header(_('Last check'), 'lastclock', $data['sortField'], $data['sortOrder'])->addStyle('width: 14%'),
	...
	$table->setHeader([
		$toggle_all,
		$check_all,
		make_sorting_header(_('Host'), 'host', $data['sortField'], $data['sortOrder'])->addStyle('width: 17%'),
		make_sorting_header(_('Name'), 'name', $data['sortField'], $data['sortOrder'])->addStyle('width: 40%'),
		make_sorting_header(_('Last check'), 'lastclock', $data['sortField'], $data['sortOrder'])->addStyle('width: 14%'),
		(new CColHeader(_('Last value')))->addStyle('width: 14%'),
		(new CColHeader(_x('Change', 'noun')))->addStyle('width: 10%'),
		(new CColHeader())->addStyle('width: 5%')
