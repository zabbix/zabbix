...
define('ZABBIX_DB_VERSION',		4030015);
...
define('HOST_AVAILABLE_TYPE_AGENT',	0);
define('HOST_AVAILABLE_TYPE_SNMP',	1);
define('HOST_AVAILABLE_TYPE_JMX',	2);
define('HOST_AVAILABLE_TYPE_IPMI',	3);
