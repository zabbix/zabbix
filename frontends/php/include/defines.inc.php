...
<?php
	...
	define('XML_TAG_ZABBIX_EXPORT',		'zabicom_export');
...
//	define('HOST_STATUS_UNREACHABLE',	2);
	...
	define('SYSMAP_ELEMENT_TYPE_UNDEFINED',	4);
...
/* time module tipe */
	...
	define('ZBX_EREG_SIMPLE_EXPRESSION_FORMAT_MB','(\{'.ZBX_EREG_HOST_FORMAT_MB.'\:'.ZBX_EREG_ITEM_KEY_FORMAT_MB.'\.'.ZBX_EREG_FUNCTION_FORMAT.'\})');
	...
	define('ZBX_AGENT_CONTROL_SCRIPT', "/home/zabbix/agent.sh");
