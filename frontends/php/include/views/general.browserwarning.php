...
<html>
	<head>
		...
		<link rel="apple-touch-icon-precomposed" sizes="76x76" href="<?= $data['assets_prefix'] ?>img/apple-touch-icon-76x76-precomposed.png">
		<link rel="apple-touch-icon-precomposed" sizes="120x120" href="<?= $data['assets_prefix'] ?>img/apple-touch-icon-120x120-precomposed.png">
		<link rel="apple-touch-icon-precomposed" sizes="152x152" href="<?= $data['assets_prefix'] ?>img/apple-touch-icon-152x152-precomposed.png">
		<link rel="apple-touch-icon-precomposed" sizes="180x180" href="<?= $data['assets_prefix'] ?>img/apple-touch-icon-180x180-precomposed.png">
		<link rel="icon" sizes="192x192" href="<?= $data['assets_prefix'] ?>img/touch-icon-192x192.png">
		<meta name="msapplication-TileImage" content="<?= $data['assets_prefix'] ?>img/ms-tile-144x144.png">
		<meta name="msapplication-TileColor" content="#d40000">
		<meta name="msapplication-config" content="none"/>
		<link rel="stylesheet" type="text/css" href="<?= $data['assets_prefix'] ?>styles/<?= ZBX_DEFAULT_THEME ?>.css" />
	</head>
	<body lang="en">
		<main>
