...
$delayFlexTable->setHeader([_('Interval'), _('Period'), _('Action')]);
$i = 0;
...
$itemFormList->addRow(_('New application prototype'),
	new CTextBox('new_application_prototype', $data['new_application_prototype'], ZBX_TEXTBOX_STANDARD_SIZE),
	false, null, 'new'
);
