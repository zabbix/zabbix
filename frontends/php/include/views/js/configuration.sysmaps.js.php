		...
		<table id="elementFormTable" class="formtable">
			...
			<tr id="triggerSelectRow">
				...
				<td>
					...
					<span class="link" onclick="PopUp('popup.php?writeonly=1&dstfrm=selementForm&dstfld1=elementid&dstfld2=elementNameTrigger&dstfld3=elementExpressionTrigger&srctbl=triggers&srcfld1=triggerid&srcfld2=description&srcfld3=expression&monitored_hosts=1',450,450)"><?php echo _('Select'); ?></span>
				</td>
			</tr>
			<tr id="mapSelectRow">
				...
				<td colspan="2">
					<fieldset>
						...
						<table>
							...
							<tr>
								<td colspan="4">
									<span class="link_menu" onclick="PopUp('popup.php?srctbl=triggers&srcfld1=triggerid&real_hosts=1&reference=linktrigger&multiselect=1&writeonly=1&monitored_hosts=1');"><?php echo _('Add'); ?></span>
								</td>
							</tr>
							</tfoot>
						</table>
