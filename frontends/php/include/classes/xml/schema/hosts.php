...
return (new CXmlTagIndexedArray('hosts'))->setSchema(
	(new CXmlTagArray('host'))->setSchema(
		...
		(new CXmlTagIndexedArray('interfaces'))->setSchema(
			(new CXmlTagArray('interface'))->setSchema(
				...
				(new CXmlTagString('type'))
					...
					->addConstant(CXmlConstant::ZABBIX, CXmlDefine::ZABBIX)
					->addConstant(CXmlConstant::SNMP, CXmlDefine::SNMP)
					->addConstant(CXmlConstant::IPMI, CXmlDefine::IPMI)
					->addConstant(CXmlConstant::JMX, CXmlDefine::JMX),
		...
		(new CXmlTagString('inventory_mode'))
			...
			->addConstant(CXmlConstant::DISABLED, CXmlDefine::INV_MODE_DISABLED)
			->addConstant(CXmlConstant::MANUAL, CXmlDefine::INV_MODE_MANUAL)
			->addConstant(CXmlConstant::AUTOMATIC, CXmlDefine::INV_MODE_AUTOMATIC),
		(new CXmlTagString('ipmi_authtype'))
			->setDefaultValue(CXmlDefine::XML_DEFAULT)
			->addConstant(CXmlConstant::XML_DEFAULT, CXmlDefine::XML_DEFAULT)
			->addConstant(CXmlConstant::NONE, CXmlDefine::NONE)
			->addConstant(CXmlConstant::MD2, CXmlDefine::MD2)
			->addConstant(CXmlConstant::MD5, CXmlDefine::MD5)
			->addConstant(CXmlConstant::STRAIGHT, CXmlDefine::STRAIGHT)
			->addConstant(CXmlConstant::OEM, CXmlDefine::OEM)
			->addConstant(CXmlConstant::RMCP_PLUS, CXmlDefine::RMCP_PLUS),
		new CXmlTagString('ipmi_password'),
		(new CXmlTagString('ipmi_privilege'))
			->setDefaultValue(CXmlDefine::USER)
			->addConstant(CXmlConstant::CALLBACK, CXmlDefine::CALLBACK)
			->addConstant(CXmlConstant::USER, CXmlDefine::USER)
			->addConstant(CXmlConstant::OPERATOR, CXmlDefine::OPERATOR)
			->addConstant(CXmlConstant::ADMIN, CXmlDefine::ADMIN)
			->addConstant(CXmlConstant::OEM, CXmlDefine::OEM),
		...
		(new CXmlTagString('tls_accept'))
			...
			->addConstant(CXmlConstant::NO_ENCRYPTION, CXmlDefine::NO_ENCRYPTION)
			->addConstant(CXmlConstant::TLS_PSK, CXmlDefine::TLS_PSK)
			->addConstant([CXmlConstant::NO_ENCRYPTION, CXmlConstant::TLS_PSK], 3)
			->addConstant(CXmlConstant::TLS_CERTIFICATE, CXmlDefine::TLS_CERTIFICATE)
			->addConstant([CXmlConstant::NO_ENCRYPTION, CXmlConstant::TLS_CERTIFICATE], 5)
			->addConstant([CXmlConstant::TLS_PSK, CXmlConstant::TLS_CERTIFICATE], 6)
			->addConstant([CXmlConstant::NO_ENCRYPTION, CXmlConstant::TLS_PSK, CXmlConstant::TLS_CERTIFICATE], 7)
			->setToXmlCallback(function (array $data, CXmlTag $class) {
