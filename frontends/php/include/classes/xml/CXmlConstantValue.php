...
class CXmlConstantValue {
	...
	const LLD_OVERRIDE_OPERATION_STATUS_CREATE_ENABLED = ZBX_PROTOTYPE_STATUS_CREATE_ENABLED;
	const LLD_OVERRIDE_OPERATION_STATUS_CREATE_DISABLED = ZBX_PROTOTYPE_STATUS_CREATE_DISABLED;
	const LLD_OVERRIDE_OPERATION_STATUS_NO_CREATE = ZBX_PROTOTYPE_STATUS_NO_CREATE;
}
