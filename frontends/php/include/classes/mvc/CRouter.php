...
class CRouter {
	...
	private $routes = [
		...
		'gui.update'          => ['CControllerGuiUpdate',          'layout.htmlpage', 'administration.gui.update'],
		'housekeeping.edit'   => ['CControllerHousekeepingEdit',   'layout.htmlpage', 'administration.housekeeping.edit'],
		'housekeeping.reset'  => ['CControllerHousekeepingReset',  'layout.htmlpage', 'administration.housekeeping.reset'],
		'housekeeping.update' => ['CControllerHousekeepingUpdate', 'layout.htmlpage', 'administration.housekeeping.update'],
		...
		'image.update'        => ['CControllerImageUpdate',        'layout.htmlpage', 'administration.image.update'],
		'image.delete'        => ['CControllerImageDelete',        'layout.htmlpage', 'administration.image.delete'],
		...
		'iconmap.clone'       => ['CControllerIconMapClone',       'layout.htmlpage', 'administration.iconmap.clone'],
		'iconmap.delete'      => ['CControllerIconMapDelete',      'layout.htmlpage', 'administration.iconmap.delete'],
		...
		'regex.update'        => ['CControllerRegExUpdate',        'layout.htmlpage', 'administration.regex.update'],
		'regex.delete'        => ['CControllerRegExDelete',        'layout.htmlpage', 'administration.regex.delete'],
		'regex.clone'         => ['CControllerRegExClone',         'layout.htmlpage', 'administration.regex.clone'],
		'regex.test'          => ['CControllerRegExTest',          'layout.htmlpage', 'administration.regex.test'],
		'macros.edit'         => ['CControllerMacrosEdit',         'layout.htmlpage', 'administration.macros.edit'],
		'macros.update'       => ['CControllerMacrosUpdate',       'layout.htmlpage', 'administration.macros.update'],
		...
		'valuemap.update'     => ['CControllerValuemapUpdate',     'layout.htmlpage', 'administration.valuemap.update'],
		'valuemap.delete'     => ['CControllerValuemapDelete',     'layout.htmlpage', 'administration.valuemap.delete'],
		'valuemap.clone'      => ['CControllerValuemapClone',      'layout.htmlpage', 'administration.valuemap.clone'],
		'workingtime.edit'    => ['CControllerWorkingTimeEdit',    'layout.htmlpage', 'administration.workingtime.edit'],
		'workingtime.update'  => ['CControllerWorkingTimeUpdate',  'layout.htmlpage', 'administration.workingtime.update'],
		'trigseverity.edit'   => ['CControllerTrigSeverityEdit',   'layout.htmlpage', 'administration.trigseverity.edit'],
		'trigseverity.update' => ['CControllerTrigSeverityUpdate', 'layout.htmlpage', 'administration.trigseverity.update'],
		'trigseverity.reset'  => ['CControllerTrigSeverityReset',  'layout.htmlpage', 'administration.trigseverity.reset'],
		'trigdisplay.edit'    => ['CControllerTrigDisplayEdit',    'layout.htmlpage', 'administration.trigdisplay.edit'],
		'trigdisplay.update'  => ['CControllerTrigDisplayUpdate',  'layout.htmlpage', 'administration.trigdisplay.update'],
		'trigdisplay.reset'   => ['CControllerTrigDisplayReset',   'layout.htmlpage', 'administration.trigdisplay.reset'],
		'miscconfig.edit'     => ['CControllerMiscConfigEdit',     'layout.htmlpage', 'administration.miscconfig.edit'],
		'miscconfig.update'   => ['CControllerMiscConfigUpdate',   'layout.htmlpage', 'administration.miscconfig.update'],
