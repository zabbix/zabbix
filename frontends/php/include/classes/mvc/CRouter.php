...
class CRouter {
	...
	private $routes = [
		...
		'popup.event.condition'			=> ['CControllerPopupConditionEventCorr',			'layout.json',			'popup.condition.common'],
		'popup.action.condition'		=> ['CControllerPopupConditionActions',				'layout.json',			'popup.condition.common'],
		'popup.operation.condition'		=> ['CControllerPopupConditionActionOperations',	'layout.json',			'popup.condition.common'],
