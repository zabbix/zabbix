...
class CRouter {
	...
	private $routes = [
		...
		'usergroup.add.group_right'		=> ['CControllerUsergroupAddGroupRight',	null,					null],
		'usergroup.add.tag_filter'		=> ['CControllerUsergroupAddTagFilter',		null,					null],
		'usergroup.create'				=> ['CControllerUsergroupCreate',			null,					null],
		'usergroup.delete'				=> ['CControllerUsergroupDelete',			null,					null],
		'usergroup.disable'				=> ['CControllerUsergroupDisable',			null,					null],
		'usergroup.disabledebug'		=> ['CControllerUsergroupDisableDebug',		null,					null],
		'usergroup.edit'				=> ['CControllerUsergroupEdit',				'layout.htmlpage',		'administration.usergroup.edit'],
		'usergroup.enable'				=> ['CControllerUsergroupEnable',			null,					null],
		'usergroup.enabledebug'			=> ['CControllerUsergroupEnableDebug',		null,					null],
		'usergroup.list'				=> ['CControllerUsergroupList',				'layout.htmlpage',		'administration.usergroup.list'],
		'usergroup.remove.tag_filter'	=> ['CControllerUsergroupRemoveTagFilter',	null,					null],
