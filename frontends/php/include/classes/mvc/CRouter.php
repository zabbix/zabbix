...
class CRouter {
	...
	private $routes = [
		...
		'administration.auth.edit'		=> ['CControllerAuthenticationEdit',		'layout.htmlpage',		'administration.authentication.edit'],
		'administration.auth.update'	=> ['CControllerAuthenticationUpdate',		null,					null],
