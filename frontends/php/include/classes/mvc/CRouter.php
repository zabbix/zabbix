...
class CRouter {
	...
	private $routes = [
		...
		'usergroup.add.group_right'		=> ['CControllerUsergroupAddGroupRight',			'layout.json',			null],
		'usergroup.add.tag_filter'		=> ['CControllerUsergroupAddTagFilter',				'layout.json',			null],
