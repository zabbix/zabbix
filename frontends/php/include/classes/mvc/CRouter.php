...
class CRouter {
	...
	private $routes = [
		...
		'usergroup.disable_debug'		=> ['CControllerUsergroupDisableDebug',		null,					null],
		...
		'usergroup.enable_debug'		=> ['CControllerUsergroupEnableDebug',		null,					null],
		'usergroup.list'				=> ['CControllerUsergroupList',				'layout.htmlpage',		'administration.usergroup.list'],
		'usergroup.set_gui_access'		=> ['CControllerUsergroupSetGuiAccess',		null,					null],
