...
class CHistory extends CApiService {
	...
	public function get($options = []) {
		...
		$log_value_types = [ITEM_VALUE_TYPE_LOG];
		...
		$api_input_rules = ['type' => API_OBJECT, 'fields' => [
			...
			'filter' =>					['type' => API_MULTIPLE, 'default' => null, 'rules' => [
											['if' => ['field' => 'history', 'in' => implode(',', $log_value_types)], 'type' => API_OBJECT, 'flags' => API_ALLOW_NULL, 'fields' => [
					...
					'ns' =>						['type' => API_INTS32, 'flags' => API_ALLOW_NULL | API_NORMALIZE]
											...
											['if' => ['field' => 'history', 'in' => implode(',', $common_value_types)], 'type' => API_OBJECT, 'flags' => API_ALLOW_NULL, 'fields' => [
					'itemid' =>					['type' => API_IDS, 'flags' => API_ALLOW_NULL | API_NORMALIZE],
					'clock' =>					['type' => API_INTS32, 'flags' => API_ALLOW_NULL | API_NORMALIZE],
					'ns' =>						['type' => API_INTS32, 'flags' => API_ALLOW_NULL | API_NORMALIZE]
				]]
			...
			'output' =>					['type' => API_MULTIPLE, 'default' => API_OUTPUT_EXTEND, 'rules' => [
											['if' => ['field' => 'history', 'in' => implode(',', $log_value_types)], 'type' => API_OUTPUT, 'in' => implode(',', ['itemid', 'clock', 'timestamp', 'source', 'severity', 'value', 'logeventid', 'ns'])],
