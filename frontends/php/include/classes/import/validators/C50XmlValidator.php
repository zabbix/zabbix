								...
								'override' =>				['type' => XML_ARRAY, 'rules' => [
									...
									'operations' =>				['type' => XML_INDEXED_ARRAY, 'prefix' => 'operation', 'rules' => [
										'operation' =>				['type' => XML_ARRAY, 'rules' => [
											...
											'value' =>					['type' => XML_STRING | XML_REQUIRED],
											'status' =>					['type' => XML_STRING, 'in' => [CXmlConstantValue::ENABLED => CXmlConstantName::ENABLED, CXmlConstantValue::DISABLED => CXmlConstantName::DISABLED, CXmlConstantValue::LLD_OVERRIDE_OPERATION_STATUS_NO_CREATE => CXmlConstantName::NO_CREATE]],
