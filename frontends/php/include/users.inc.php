...
/**
 * Appends common fields that are used by user edit form and user profile form.
 *
 * @param CForm $user_form           Main user form.
 * @param CFormList $user_form_list  User form list.
 * @param array $data                Data to be displayed.
 * @param bool $form_autofocus       Set autofocus or not.
 *
 * @return CFormList
 */
function commonUserform(CForm $user_form, CFormList $user_form_list, array $data, $form_autofocus) {
