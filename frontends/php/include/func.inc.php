 ...
 * - arrays with nonsequential numeric keys will be reset to plain zero-based numeric arrays;
 * - an associative array will be returned in an array as the only element.
 *
 * @param $value
 *
 * @return array
