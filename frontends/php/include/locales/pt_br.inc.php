...
<?php
	...
	'S_CONFIGURATION_OF_NODES'=>			'CONFIGURAÇÃO DE NODOS',
	'S_DM'=>			'MD',
	'S_NODE'=>			'Nodo',
	'S_NODES'=>			'Nodo',
	'S_NODES_BIG'=>			'NODO',
	'S_NEW_NODE'=>			'Novo nodo',
	'S_NO_NODES_DEFINED'=>			'Não há nodos definidos',
	'S_ALL_NODES'=>			'Todos os nodos',
	'S_DELETE_SELECTED_NODE_Q'=>			'Remover nodo selecionado?',
	...
	'S_GRAPH'=>			'Gráfico',
	'S_ZABBIX'=>			'Zabbix',
	'S_COPYRIGHT_BY'=>			'Copyright 2001-2010 por',
	...
	'S_TEMPLATED_GRAPH'=>			'Template de gráfico',
	...
	'S_EXPORT_HAVE_NO_MAPS'=>			'Exportação não contém mapas do Zabbix',
	'S_EXPORT_HAVE_NO_SCREENS'=>			'Exportação não contém telas do Zabbix',
	'S_OK_BIG'=>			'OK',
	...
	'S_CUSTOM_SLIDES'=>			'Slides customizados',
	...
	'S_SHOW_ALL_WITH_UNACKNOWLEDGED'=>			'Mostrar triggers com eventos não vistados',
	...
	'S_STATUS_OF_TRIGGERS_BIG'=>			'STATUS DoS TRIGGERS',
	'S_STATUS_OF_HOSTGROUP_TRIGGERS'=>			'Status dos triggers de grupo de hosts',
	'S_STATUS_OF_HOST_TRIGGERS'=>			'Status dos triggers de host',
	...
	'S_SCRIPT_UNKNOWN_ERROR'=>			'Ocorreu um erro desconhecido ao ler a resposta do script, por favor relate aos desenvolvedores',
	...
	'S_TIMEZONE_FOR_PHP_IS_NOT_SET_PLEASE_SET'=>			'Timezone do PHP não está definido. Por favor, defina a opção \\"date.timezone\\" no php.ini.',
	...
	'S_INCORRECT_KEY_FORMAT'=>			'Formato de chave incorreto',
	...
	'S_TYPE_INFORMATION_BUST_LOG_FOR_LOG_KEY'=>			'Tipo da informação para chave de log deve ser Log',
	'S_VALUE_TYPE_MUST_FLOAT_FOR_AGGREGATE_ITEMS'=>			'Para itens agregados, o tipo do valor deve ser Float',
	...
	'S_CHARACTERS_ONLY_SMALL'=>			'somente caracteres',
	...
	'S_NO_MEDIA_WITH'=>			'Sem mídia com',
	'S_NO_MEDIA_TYPE_WITH'=>			'Sem tipo de mídia com',
	'S_AN_ACTION_TYPE_WITH_DESCRIPTION'=>			'Um tipo de ação com descrição',
	'S_CANNOT_EXIST_WITHOUT_GROUP'=>			'não pode existir sem grupo',
	'S_ADDED_HOST_GROUP'=>			'Grupo de hosts adicionado',
	'S_UPDATED_HOST_GROUP'=>			'Grupo de hosts atualizado',
	'S_INCORRECT_CHARACTERS_USED_FOR_HOSTNAME'=>			'Uso de caracteres incorretos no Hostname',
	'S_INCORRECT_CHARACTERS_USED_FOR_DNS'=>			'Uso de caracteres incorretos para DNS',
	'S_CIRCULAR_LINK_CANNOT_BE_CREATED'=>			'Associações circulares não podem ser criadas',
	'S_MUST_LINKED_LEAST_ONE_HOST_GROUP_SMALL'=>			'deve estar associado a pelo menos um grupo de host',
	'S_ADDED_NEW_HOST'=>			'Adicionado novo host',
	...
	'S_ALREADY_EXISTS_IN_LINKED_HOSTS_SMALL'=>			'já existe em hosts associados',
	...
	'S_USED_BY_SCENARIO_SMALL'=>			'usado pelo cenário',
	...
	'S_ADDED_TRIGGER'=>			'Trigger adicionado',
	'S_TO_HOST_SMALL'=>			'para o host',
	'S_MISSING_KEY'=>			'Chave desconhecida',
	'S_INCORRECT_FUNCTION_IS_USED'=>			'Usada função incorreta',
	'S_UNKNOWN_MACRO'=>			'Macro desconhecida',
	'S_FROM_HOST_SMALL'=>			'do host',
	'S_TRIGGER_IN_TEMPLATE'=>			'Trigger no template',
	'S_HAS_DEPENDENCY_WITH_TRIGGER_IN_TEMPLATE'=>			'tem dependência com trigger no template',
	'S_IS_NOT_THE_HIGHEST_LEVEL_TEMPLATE'=>			'não é o template de nível mais alto',
	'S_NO_FUNCTION_WITH'=>			'Sem função com',
	'S_SPECIFY_THE_CONDITIONAL_EXPR_FOR_THE_TARGET'=>			'Especifique a expressão de condição para o alvo.',
	'S_0_OR_1'=>			'0 ou 1',
	...
	'S_NO_SYSMAP_ELEMENT_WITH'=>			'Sem elemento de sysmap com',
	...
	'S_SKIPPED_COPYING_OF_GRAPH'=>			'Saltar cópia do gráfico',
	...
	'S_CUSER_ERROR_ONLY_SUPER_ADMIN_CAN_DELETE_USERS'=>			'Somente Administradores Zabbix podem deletar usuários',
	...
	'S_CUSER_ERROR_CANT_DELETE_USER_MEDIAS'=>			'Impossível deletar mídias de usuário',
	...
	'S_CMEDIATYPE_ERROR_CANT_DELETE_MEDIATYPES'=>			'Não foi possível deletar tipo de mídia',
	'S_CMEDIATYPE_ERROR_CANT_UPDATE_MEDIATYPES'=>			'Não foi possível atualizar tipo de mídia',
	'S_CMEDIATYPE_ERROR_CANT_INSERT_MEDIATYPES'=>			'Não foi possível adicionar tipo de mídia',
	...
	'S_CMEDIATYPE_ERROR_ONLY_SUPER_ADMIN_CAN_UPDATE_MEDIATYPES'=>			'Somente Administradores Zabbix podem atualizar tipos de mídia',
	'S_CMEDIATYPE_ERROR_ONLY_SUPER_ADMIN_CAN_DELETE_MEDIATYPES'=>			'Somente Administradores Zabbix podem deletar tipos de mídia',
