...
<?php
	...
	'S_CHECK_EXPRESSION_PART_STARTING_FROM'=>			'Проверка части выражения начиная с \'%s\'',
	...
	'S_EXPRESSION_FUNCTION_DOES_NOT_ACCEPTS_PARAMS_ERROR'=>			'Функция \'%s\' не имеет поддерживаемых параметров',
