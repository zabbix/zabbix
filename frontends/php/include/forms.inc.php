...
function getItemFilterForm(&$items) {
	...
	$table->addRow(array(
		new CCol(array(bold(_('Host group')), ':'), 'label col1'),
		new CCol(array(
		...
		new CCol(array(bold(_('Type')), ':'), 'label col2'),
		new CCol($cmbType, 'col2'),
		new CCol(array(bold(_('Type of information')), ':'), 'label col3'),
		new CCol($cmbValType, 'col3'),
		new CCol(array(bold(_('State')), ':'), 'label'),
	...
	$table->addRow(array(
		new CCol(array(bold(_('Host')), ':'), 'label'),
		new CCol(array(
			new CMultiSelect(array(
				'name' => 'filter_hostid',
				'selectedLimit' => 1,
		...
		new CCol(array(bold(_('Status')), ':'), 'label col4'),
		new CCol($cmbStatus, 'col4')
	), 'item-list-row');
	// row 3
	$table->addRow(array(
		new CCol(array(bold(_('Application')), ':'), 'label'),
		new CCol(array(
		...
		new CCol(array(bold(_('History')), SPACE._('(in days)').':'), 'label'),
		new CCol(new CNumericBox('filter_history', $filter_history, 8, false, true)),
		new CCol(array(bold(_('Triggers')), ':'), 'label'),
	...
	$table->addRow(array(
		...
		new CCol(array(bold(_('Trends')), SPACE._('(in days)').':'), 'label'),
		new CCol(new CNumericBox('filter_trends', $filter_trends, 8, false, true)),
		new CCol(array(bold(_('Template')), ':'), 'label'),
