...
class testFormAdministrationGeneralGUI extends CWebTest {
	...
	*/
	public function testFormAdministrationGeneralGUI_CheckLayout($allValues) {
		...
		$this->zbxTestTextPresent(['CONFIGURATION OF GUI', 'GUI']);
		$this->zbxTestTextPresent(['Default theme', 'Dropdown first entry', 'remember selected', 'Search/Filter elements limit', 'Max count of elements to show inside table cell', 'Enable event acknowledges', 'Show events not older than (in days)', 'Max count of events per trigger to show']);
	...
	public function testFormAdministrationGeneralGUI_ChangeTheme() {
		...
		$this->zbxTestTextPresent(['Configuration updated', 'CONFIGURATION OF GUI', 'GUI', 'Default theme']);
	...
	public function testFormAdministrationGeneralGUI_ChangeDropdownFirstEntry() {
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent(['Configuration updated', 'CONFIGURATION OF GUI', 'GUI', 'Dropdown first entry']);
	...
	public function testFormAdministrationGeneralGUI_ChangeDropdownFirstRemember() {
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent(['Configuration updated', 'CONFIGURATION OF GUI', 'GUI', 'remember selected']);
	...
	public function testFormAdministrationGeneralGUI_ChangeSearchLimit() {
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent(['Configuration updated', 'CONFIGURATION OF GUI', 'GUI', 'Search/Filter elements limit']);
		...
		$this->zbxTestTextPresent(['CONFIGURATION OF GUI', 'GUI', 'Search/Filter elements limit']);
		$this->zbxTestTextPresent(['ERROR: Page received incorrect data', 'Incorrect value "0" for "Search/Filter elements limit" field: must be between 1 and 999999.']);
		...
		$this->zbxTestTextPresent(['CONFIGURATION OF GUI', 'GUI', 'Search/Filter elements limit']);
		$this->zbxTestTextPresent(['ERROR: Page received incorrect data', 'Incorrect value "-1" for "Search/Filter elements limit" field: must be between 1 and 999999.']);
	...
	public function testFormAdministrationGeneralGUI_EventAckEnable() {
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent(['Configuration updated', 'CONFIGURATION OF GUI', 'GUI', 'Enable event acknowledges']);
	...
	public function testFormAdministrationGeneralGUI_EventExpire() {
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent('Configuration updated');
		$this->zbxTestTextPresent(['CONFIGURATION OF GUI', 'GUI', 'Show events not older than (in days)']);
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent(['ERROR: Page received incorrect data', 'Incorrect value "100000" for "Show events not older than (in days)" field: must be between 1 and 99999.']);
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent(['ERROR: Page received incorrect data', 'Incorrect value "0" for "Show events not older than (in days)" field: must be between 1 and 99999.']);
	...
	public function testFormAdministrationGeneralGUI_EventShowMax() {
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent(['Configuration updated', 'CONFIGURATION OF GUI', 'GUI', 'Max count of events per trigger to show']);
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent(['ERROR: Page received incorrect data', 'Incorrect value "100000" for "Max count of events per trigger to show" field: must be between 1 and 99999.']);

		$this->zbxTestTextPresent(['CONFIGURATION OF GUI', 'GUI', 'Max count of events per trigger to show']);
		...
		$this->zbxTestClickWait('update');
		$this->zbxTestTextPresent(['ERROR: Page received incorrect data', 'Incorrect value "0" for "Max count of events per trigger to show" field: must be between 1 and 99999.']);
