<script type="text/x-jquery-tmpl" id="dcheckRowTPL">
	<tr id="dcheckRow_#{dcheckid}">
		...
		<td>
			<input type="button" class="input link_menu" name="remove" value=<?php echo CJs::encodeJson(_('Remove')); ?> onclick="javascript: removeDCheckRow(#{dcheckid});" />
		</td>
	</tr>
</script>
...
<script type="text/x-jquery-tmpl" id="newDCheckTPL">
	<div id="new_check_form">
		<div class="objectgroup inlineblock border_dotted ui-corner-all">
			...
			<input type="button" id="add_new_dcheck" name="add_new_dcheck" value=<?php echo CJs::encodeJson(_('Add')); ?>
				class="input button link_menu">
			&nbsp;&nbsp;
			<input type="button" id="cancel_new_dcheck" name="cancel_new_dcheck" value=<?php echo CJs::encodeJson(_('Cancel')); ?>
				class="input button link_menu">
		</div>
	</div>
</script>
