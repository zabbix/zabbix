...
ALTER TABLE config ADD problem_unack_style number(10) DEFAULT '0' NOT NULL;
ALTER TABLE config ADD problem_ack_style number(10) DEFAULT '0' NOT NULL;
ALTER TABLE config ADD ok_unack_style number(10) DEFAULT '0' NOT NULL;
ALTER TABLE config ADD ok_ack_style number(10) DEFAULT '0' NOT NULL;
