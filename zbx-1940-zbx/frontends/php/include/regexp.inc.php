...
function add_regexp($regexp=array()){
	...
	if(!check_db_fields($db_fields, $regexp)){
		error(S_INCORRECT_ARGUMENTS_PASTED_TO_FUNCTION.' [add_regexp]');
		return false;
	}
...
function update_regexp($regexpid, $regexp=array()){
	...
	if(!check_db_fields($db_fields, $regexp)){
		error(S_INCORRECT_ARGUMENTS_PASTED_TO_FUNCTION.' [update_regexp]');
		return false;
	}
...
function add_expression($regexpid, $expression = array()){
	...
	if(!check_db_fields($db_fields, $expression)){
		error(S_INCORRECT_ARGUMENTS_PASTED_TO_FUNCTION.' [add_expression]');
		return false;
	}
