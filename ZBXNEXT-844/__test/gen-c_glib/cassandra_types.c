        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val8, error)) < 0)
                return -1;
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->credentials, (gpointer) &key7, (gpointer) &val8);
            }
      ...
      case 3:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast9, error)) < 0)
            return -1;
          xfer += ret;
          this_object->index_type = (IndexType)ecast9;
  ...
  while (1)
  {
    ...
    switch (fid)
    {
        ...
        {
          {
            ...
            {
              ColumnDef * _elem10;
              _elem10 = g_object_new (TYPE_COLUMN_DEF, NULL);
              if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem10), protocol, error)) < 0)
                return -1;
              xfer += ret;
              g_ptr_array_add (this_object->column_metadata, _elem10);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
      ...
      case 21:
        if (ftype == T_I32)
        {
          if ((ret = thrift_protocol_read_i32 (protocol, &this_object->memtable_flush_after_mins, error)) < 0)
            return -1;
          xfer += ret;
          this_object->__isset_memtable_flush_after_mins = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
          xfer += ret;
      ...
      case 22:
        if (ftype == T_I32)
        {
          if ((ret = thrift_protocol_read_i32 (protocol, &this_object->memtable_throughput_in_mb, error)) < 0)
            return -1;
          xfer += ret;
          this_object->__isset_memtable_throughput_in_mb = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
          xfer += ret;
      ...
      case 23:
        if (ftype == T_DOUBLE)
        {
          if ((ret = thrift_protocol_read_double (protocol, &this_object->memtable_operations_in_millions, error)) < 0)
            return -1;
          xfer += ret;
          this_object->__isset_memtable_operations_in_millions = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
          xfer += ret;
...
cf_def_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  if (this_object->__isset_memtable_flush_after_mins == TRUE) {
    if ((ret = thrift_protocol_write_field_begin (protocol, "memtable_flush_after_mins", T_I32, 21, error)) < 0)
      return -1;
    xfer += ret;
    if ((ret = thrift_protocol_write_i32 (protocol, this_object->memtable_flush_after_mins, error)) < 0)
      return -1;
    if ((ret = thrift_protocol_write_field_end (protocol, error)) < 0)
      return -1;
    xfer += ret;
  }
  if (this_object->__isset_memtable_throughput_in_mb == TRUE) {
    if ((ret = thrift_protocol_write_field_begin (protocol, "memtable_throughput_in_mb", T_I32, 22, error)) < 0)
      return -1;
    xfer += ret;
    if ((ret = thrift_protocol_write_i32 (protocol, this_object->memtable_throughput_in_mb, error)) < 0)
      return -1;
    if ((ret = thrift_protocol_write_field_end (protocol, error)) < 0)
      return -1;
    xfer += ret;
  }
  if (this_object->__isset_memtable_operations_in_millions == TRUE) {
    if ((ret = thrift_protocol_write_field_begin (protocol, "memtable_operations_in_millions", T_DOUBLE, 23, error)) < 0)
      return -1;
    xfer += ret;
    if ((ret = thrift_protocol_write_double (protocol, this_object->memtable_operations_in_millions, error)) < 0)
      return -1;
    if ((ret = thrift_protocol_write_field_end (protocol, error)) < 0)
      return -1;
    xfer += ret;
...
cf_def_instance_init (CfDef * object)
{
  ...
  object->memtable_flush_after_mins = 0;
  object->__isset_memtable_flush_after_mins = FALSE;
  object->memtable_throughput_in_mb = 0;
  object->__isset_memtable_throughput_in_mb = FALSE;
  object->memtable_operations_in_millions = 0;
  object->__isset_memtable_operations_in_millions = FALSE;
  ...
  object->row_cache_provider = "org.apache.cassandra.cache.ConcurrentLinkedHashCacheProvider";
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              gchar * key11;
              gchar * val12;
              if ((ret = thrift_protocol_read_string (protocol, &key11, error)) < 0)
                return -1;
              xfer += ret;
              if ((ret = thrift_protocol_read_string (protocol, &val12, error)) < 0)
                return -1;
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->strategy_options, (gpointer) &key11, (gpointer) &val12);
            }
        ...
        {
          {
            ...
            {
              CfDef * _elem13;
              _elem13 = g_object_new (TYPE_CF_DEF, NULL);
              if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem13), protocol, error)) < 0)
                return -1;
              xfer += ret;
              g_ptr_array_add (this_object->cf_defs, _elem13);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            {
              Column * _elem14;
              _elem14 = g_object_new (TYPE_COLUMN, NULL);
              if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem14), protocol, error)) < 0)
                return -1;
              xfer += ret;
              g_ptr_array_add (this_object->columns, _elem14);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
      ...
      case 1:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast15, error)) < 0)
            return -1;
          xfer += ret;
          this_object->type = (CqlResultType)ecast15;
          isset_type = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
        ...
        {
          {
            ...
            {
              CqlRow * _elem16;
              _elem16 = g_object_new (TYPE_CQL_ROW, NULL);
              if ((ret = thrift_struct_read (THRIFT_STRUCT (_elem16), protocol, error)) < 0)
                return -1;
              xfer += ret;
              g_ptr_array_add (this_object->rows, _elem16);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
