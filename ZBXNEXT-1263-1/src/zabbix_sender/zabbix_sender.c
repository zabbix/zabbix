...
const char	*usage_message[] = {
	...
	"[-v] -z server [-p port] [-I IP-address] --tls-connect=cert --tls-ca-file=ca_file [--tls-crl-file=crl_file] --tls-cert-file=cert_file --tls-key-file=key_file -s host -k key -o value",
	"[-v] -z server [-p port] [-I IP-address] --tls-connect=cert --tls-ca-file=ca_file [--tls-crl-file=crl_file] --tls-cert-file=cert_file --tls-key-file=key_file [-T] [-r] -i input-file",
