...
$fields = [
	...
	'tls_accept' =>		[T_ZBX_INT, O_OPT, null,			BETWEEN(0, 7), null],
	'tls_connect' =>	[T_ZBX_INT, O_OPT, null,			BETWEEN(0, 4), null],
	'tls_issuer' =>		[T_ZBX_STR, O_OPT, null,		null,		null],
	'tls_psk' =>		[T_ZBX_STR, O_OPT, null,			HEX(),		null],
		...
		if ($data['hostid'] != 0) {
			$dbHosts = API::Host()->get([
				'output' => ['hostid', 'proxy_hostid', 'host', 'name', 'status', 'ipmi_authtype', 'ipmi_privilege',
					'ipmi_username', 'ipmi_password', 'flags', 'description', 'tls_connect', 'tls_accept', 'tls_psk',
					'tls_psk_identity', 'tls_issuer', 'tls_subject'
				],
