...
<?php
	...
	'S_DELETE_SELECTED_MEDIATYPES_Q'=>			'Удалить выбранные типы средств передачи?',
	...
	'S_CUSER_ERROR_ONLY_ADMIN_CAN_ADD_USER_MEDIAS'=>			'Только Администраторы Zabbix могут добавлять средства передачи данных к пользователю',
	'S_CUSER_ERROR_ONLY_ADMIN_CAN_REMOVE_USER_MEDIAS'=>			'Только Администраторы Zabbix могут удалять средства передачи данных у пользователя',
	'S_CUSER_ERROR_ONLY_ADMIN_CAN_CHANGE_USER_MEDIAS'=>			'Только Администраторы Zabbix могут изменять средства передачи данных у пользователя',
	'S_CUSER_ERROR_CANT_DELETE_USER_MEDIAS'=>			'Невозможно удалить средства передачи данных у пользователя',
	'S_CUSER_ERROR_CANT_UPDATE_USER_MEDIAS'=>			'Невозможно обновить средства передачи данных у пользователя',
	'S_CUSER_ERROR_CANT_INSERT_USER_MEDIAS'=>			'Невозможно добавить средства передачи данных у пользователя',
	...
	'S_CMEDIATYPE_ERROR_WRONG_FIELD_FOR_MEDIATYPE'=>			'Ошибочные поля для типа средств передачи',
	'S_CMEDIATYPE_ERROR_CANT_DELETE_MEDIATYPES'=>			'Не удалось удалить типы средств передачи',
	'S_CMEDIATYPE_ERROR_CANT_UPDATE_MEDIATYPES'=>			'Не удалось обновить типы средств передачи',
	'S_CMEDIATYPE_ERROR_CANT_INSERT_MEDIATYPES'=>			'Не удалось добавить типы средств передачи',
	'S_MEDIATYPE_ALREADY_EXISTS'=>			'Тип средств передачи уже существует:',
	'S_MEDIATYPE_USED_BY_ACTIONS'=>			'Типы средств передачи используются в действии:',
	'S_CMEDIATYPE_ERROR_ONLY_SUPER_ADMIN_CAN_CREATE_MEDIATYPES'=>			'Только Супер Администраторы могут создавать типы средств передачи',
	'S_CMEDIATYPE_ERROR_ONLY_SUPER_ADMIN_CAN_UPDATE_MEDIATYPES'=>			'Только Супер Администраторы могут обновлять типы средств передачи',
	'S_CMEDIATYPE_ERROR_ONLY_SUPER_ADMIN_CAN_DELETE_MEDIATYPES'=>			'Только Супер Администраторы могут удалять типы средств передачи',
