	...
	// add condition value
			switch($new_condition['type'])
			{
				...
				case CONDITION_TYPE_MAINTENANCE:
					$rowCondition[] = new CTextBox('',S_MAINTENANCE_SMALL,20,'yes');
					break;
...
//-------			
	...
	function get_maintenance_hosts_form(&$form){
		...
		$available_hosts = get_accessible_hosts_by_user($USER_DETAILS,PERM_READ_WRITE,PERM_MODE_GE,PERM_RES_IDS_ARRAY);
