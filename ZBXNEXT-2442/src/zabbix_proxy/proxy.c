...
int	CONFIG_EMAIL_ALERTER_FORKS		= 0;
int	CONFIG_SCRIPT_ALERTER_FORKS		= 0;
int	CONFIG_SMS_ALERTER_FORKS		= 0;
int	CONFIG_JABBER_ALERTER_FORKS		= 0;
int	CONFIG_EZ_TEXTING_ALERTER_FORKS		= 0;
