...
echo '<header role="banner">
		<nav role="navigation">
			...
			<ul class="top-nav"><li class="selected" onMouseOver="menu_mouseover(\'menu-monitoring\')"><a href="dashboard.php">Monitoring</a></li><li onMouseOver="menu_mouseover(\'menu-inventory\')"><a href="hostinventoriesoverview.php">Inventory</a></li><li onMouseOver="menu_mouseover(\'menu-reports\')"><a href="report1.php">Reports</a></li><li onMouseOver="menu_mouseover(\'menu-configuration\')"><a href="hosts.php">Configuration</a></li><li onMouseOver="menu_mouseover(\'menu-administration\')"><a href="proxies.php">Administration</a></li></ul><ul class="top-nav-icons"><li><form method="get" action="search.php" accept-charset="utf-8"><input class="input text search" id="search" name="search" value="za" size="20" maxlength="255" autocomplete="off" type="text"></form></li><li><a href="http://www.zabbix.com/documentation/" target="_blank" class="top-nav-help" title="Help"></a></li><li><a href="" class="top-nav-print" title="Print"></a></li><li><a href="profile.php" class="top-nav-profile" title="Profile"></a></li><li><a href="index.php?reconnect=1" class="top-nav-signout" title="Sign out"></a></li></ul>
			</div>
