		...
		<table id="elementFormTable" class="formtable">
			...
			<tr class="footer">
				<td colspan="2" class="form_row_last">
					<input id="elementApply" class="element-edit-control" type="button" name="apply" value=<?php echo CJs::encodeJson(_('Apply')); ?>>
					<input id="elementRemove" class="element-edit-control" type="button" name="remove" value=<?php echo CJs::encodeJson(_('Remove')); ?>>
					<input id="elementClose" type="button" name="close" value=<?php echo CJs::encodeJson(_('Close')); ?>>
				</td>
			</tr>
			</tbody>
		</table>
...
<script type="text/x-jquery-tmpl" id="mapMassFormTpl">
	<form id="massForm">
		<table class="formtable">
			...
			<tr class="footer">
				<td colspan="2" class="form_row_last">
					<input id="massApply" class="element-edit-control" type="button" name="apply" value=<?php echo CJs::encodeJson(_('Apply')); ?>>
					<input id="massRemove" class="element-edit-control" type="button" name="remove" value=<?php echo CJs::encodeJson(_('Remove')); ?>>
					<input id="massClose" type="button" name="close" value=<?php echo CJs::encodeJson(_('Close')); ?>>
				</td>
			</tr>
			</tbody>
		</table>
...
<script type="text/x-jquery-tmpl" id="linkFormTpl">
	...
	<form id="linkForm" name="linkForm">
		...
		<table class="formtable">
			...
			<tr class="footer">
				<td colspan="2" class="form_row_last">
					<input id="formLinkApply" type="button" value=<?php echo CJs::encodeJson(_('Apply')); ?>>
					<input id="formLinkRemove" type="button" value=<?php echo CJs::encodeJson(_('Remove')); ?>>
					<input id="formLinkClose" type="button" value=<?php echo CJs::encodeJson(_('Close')); ?>>
				</td>
			</tr>
			</tbody>
		</table>
