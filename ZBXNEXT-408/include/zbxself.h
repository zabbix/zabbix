...
#define ZBX_STATE_IDLE	0
#define ZBX_STATE_BUSY	1
#define ZBX_STATE_COUNT	2	/* number of process states */

#define ZBX_PROCESS_TYPE_POLLER		0	/* == ZBX_POLLER_TYPE_NORMAL */
#define ZBX_PROCESS_TYPE_UNREACHABLE	1	/* == ZBX_POLLER_TYPE_UNREACHABLE */
#define ZBX_PROCESS_TYPE_IPMI		2	/* == ZBX_POLLER_TYPE_IPMI */
#define ZBX_PROCESS_TYPE_PINGER		3	/* == ZBX_POLLER_TYPE_PINGER */
#define ZBX_PROCESS_TYPE_HTTP		4
