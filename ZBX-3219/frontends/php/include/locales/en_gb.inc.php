...
//scripts.php
	...
	'S_IP_NOT_AVAILABLE'=>'Zabbix server "localhost" can not be reached. Possible reasons: 1. Incorrect server IP/DNS in the "zabbix.conf.php"; 2. Incorrect network configuration.',
	'S_TIME_OUT'=>'Connection to Zabbix server "localhost" timed out. Possible reasons: 1. Incorrect server IP/DNS in the "zabbix.conf.php"; 2. Firewall is blocking TCP connection',
