...
<?php
	...
	'S_SCRIPT_ERROR_BIG'=>			'Возможные причины: 1. неверный IP-сервер / DNS в "zabbix.conf.php"; 2. программа, отвечающая за безопасность, например SELinux, блокирует соединение; 3. сервис Zabbix не запущен.',
	'S_NOT_RUN'=>' Сервер  %s или сервис Zabbix не запущен',
	'S_IP_NOT_AVAILABLE'=>' IP-адрес в той же локальной сети и не доступны',
	'S_TIME_OUT'=>' Правильное имя DNS сервера %s, но недоступен за пределами локальной сети',
