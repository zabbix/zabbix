...
//----------
			...
			if($interval == SEC_PER_DAY) $date_format = S_CCHARTS_TIMELINE_DAYS_FORMAT;
			else if($interval > SEC_PER_DAY) $date_format = S_CCHARTS_TIMELINE_MONTHDAYS_FORMAT;
			else if($interval < SEC_PER_DAY) $date_format = S_CCHARTS_TIMELINE_HOURS_FORMAT;
