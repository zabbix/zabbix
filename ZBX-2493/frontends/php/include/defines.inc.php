...
//	define('HOST_STATUS_DELETED',		4);
	...
	define('ACTION_DEFAULT_SUBJ_TRIGGER', '{TRIGGER.NAME}: {TRIGGER.STATUS}');
	define('ACTION_DEFAULT_SUBJ_AUTOREG', 'Host {HOSTNAME} auto-registered');
	define('ACTION_DEFAULT_SUBJ_DISCOVERY', '{DISCOVERY.DEVICE.IPADDRESS}: {DISCOVERY.DEVICE.STATUS}');

	define('ACTION_DEFAULT_MSG_TRIGGER', "{TRIGGER.NAME}: {TRIGGER.STATUS}\nLast value: {ITEM.LASTVALUE}\n\n{TRIGGER.URL}");
	define('ACTION_DEFAULT_MSG_AUTOREG', 'Host {HOSTNAME} auto-registered');
	define('ACTION_DEFAULT_MSG_DISCOVERY', "Discovery by \"{DISCOVERY.RULE.NAME}\" of {DISCOVERY.DEVICE.IPADDRESS}: {DISCOVERY.DEVICE.STATUS}\n\nDiscovered {DISCOVERY.SERVICE.UPTIME}");
