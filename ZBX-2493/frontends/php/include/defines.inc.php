...
//	define('HOST_STATUS_DELETED',		4);
	...
	define('ACTION_DEFAULT_SUBJ_AUTOREG', 'AUTOREG');
	define('ACTION_DEFAULT_SUBJ_DISCOVERY', 'DISCOVERY');

	define('ACTION_DEFAULT_MSG_TRIGGER', "{TRIGGER.NAME}: {TRIGGER.STATUS}\nLast value: {ITEM.LASTVALUE}\n\n{TRIGGER.URL}");
	define('ACTION_DEFAULT_MSG_AUTOREG', 'AUTOREG');
	define('ACTION_DEFAULT_MSG_DISCOVERY', 'DISCOVERY');
