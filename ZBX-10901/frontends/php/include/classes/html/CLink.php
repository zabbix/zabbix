	...
	public function toString($destroy = true) {
		...
		if ($this->use_sid) {
			...
			$confirm_script = ($this->confirm_message !== '')
				? 'Confirm('.CJs::encodeJson(htmlspecialchars($this->confirm_message)).') && '
				: '';
			...
			if ($this->confirm_message !== '') {
				$this->onClick('javascript: return Confirm('.CJs::encodeJson(htmlspecialchars($this->confirm_message)).');');
			}
		}
