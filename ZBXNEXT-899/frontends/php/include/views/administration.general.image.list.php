...
include_js('js/jquery/jquery.ui.widget.js');
include_js('js/jquery/jquery.ui.position.js');
include_js('js/jquery/jquery.ui.tooltip.js');
insert_js('<script type="text/javascript">
