...
calendar.prototype = {
	...
	calendarcreate: function(parentNodeid) {
		...
		this.clndr_yeardown.appendChild(document.createTextNode('&laquo;'));
		...
		this.clndr_yearup.appendChild(document.createTextNode('&raquo;'));
		...
		this.clndr_monthdown.appendChild(document.createTextNode('&laquo;'));
		...
		this.clndr_monthup.appendChild(document.createTextNode('&raquo;'));
