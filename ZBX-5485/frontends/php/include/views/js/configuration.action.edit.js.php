...
<td>
	<input type="button" class="input link_menu" name="remove" value="<?php echo CJs::encodeJson(_('Remove')); ?>" onclick="removeOpGroupRow(#{groupid});" />
</td>
</tr>
</script>
...
<td>
	<input type="button" class="input link_menu" name="remove" value="<?php echo CJs::encodeJson(_('Remove')); ?>" onclick="removeOpTemplateRow(#{templateid});" />
</td>
</tr>
</script>
...
<td>
	<input type="button" class="input link_menu" name="remove" value="<?php echo CJs::encodeJson(_('Remove')); ?>" onclick="removeOpmsgUsrgrpRow(#{usrgrpid});" />
</td>
</tr>
</script>
...
<td>
	<input type="button" class="input link_menu" name="remove" value="<?php echo CJs::encodeJson(_('Remove')); ?>" onclick="removeOpmsgUserRow(#{userid});" />
</td>
</tr>
</script>
...
<td>
	<input type="button" class="input link_menu" name="remove" value="<?php echo CJs::encodeJson(_('Remove')); ?>" onclick="removeOpCmdRow(#{groupid}, 'groupid');" />
</td>
</tr>
</script>
...
<td>
	<input type="button" class="input link_menu" name="remove" value="<?php echo CJs::encodeJson(_('Remove')); ?>" onclick="removeOpCmdRow(#{hostid}, 'hostid');" />
</td>
</tr>
</script>
...
<tr>
	<td><?php echo CJs::encodeJson(_('Target')); ?></td>
	<td>
		<select name="opCmdTarget" class="input select">
			<option value="0"><?php echo CJs::encodeJson(_('Current host')); ?></option>
			<option value="1"><?php echo CJs::encodeJson(_('Host')); ?></option>
			<option value="2"><?php echo CJs::encodeJson(_('Host group')); ?></option>
		</select>
		<div id="opCmdTargetSelect" class="inlineblock">
			...
			<input type="button" class="input link_menu" name="select" value="<?php echo CJs::encodeJson(_('Select')); ?>" />
		</div>
	</td>
</tr>
<tr>
	<td colspan="2">
		...
		<input type="button" class="input link_menu" name="cancel" value="<?php echo CJs::encodeJson(_('Cancel')); ?>" />
	</td>
</tr>
</tbody></table>
</div>
...
<td>
	<?php echo CJs::encodeJson(_('Execute on')); ?>
</td>
<td>
	<div class="objectgroup inlineblock border_dotted ui-corner-all" id="uniqList">
		<div>
			...
			<label for="execute_on_agent"><?php echo CJs::encodeJson(_('Zabbix agent')); ?></label>
		</div>

		<div>
			<input type="radio" id="execute_on_server" name="execute_on" value="1" class="input radio">
			<label for="execute_on_server"><?php echo CJs::encodeJson(_('Zabbix server')); ?></label>
		</div>
	</div>
</td>
</tr>
