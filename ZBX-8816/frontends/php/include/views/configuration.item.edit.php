...
if ($data['config']['hk_history_global'] && $data['parent_discoveryid'] == 0 && $host['status'] != HOST_STATUS_TEMPLATE) {
...
if ($data['config']['hk_trends_global'] && $data['parent_discoveryid'] == 0 && $host['status'] != HOST_STATUS_TEMPLATE) {
