...
<?php
	...
	'S_ADD_GRAPH_ITEMS'=>			'добавить элементы графика первыми',
	'S_TITLE'=>			'Заголовок',
	...
	'S_SCREEN_SHOULD_CONTAIN_ONE_ROW_AND_COLUMN'=>			'Комплексный отчет должен содержать по крайней мере одну строку или колонку',
	...
	'S_ITEM_SLASH_FUNCTION'=>			'Элемент данных / Функция',
	...
	'S_CUSER_ERROR_ACCOUNT_IS_BLOCKED_FOR_XX_MINUTES'=>			'Аккаунт заблокирован на %s секунд.',
	...
	'S_CUSER_ERROR_ATTEMP_FAILED'=>			'%1$s ошибочных попыток входа в систему. Последняя ошибочная попытка входа с %2$s на %3$s.',
	...
	'S_CUSER_ERROR_USER_EXISTS'=>			'Пользователь [ %1$s ] уже существует',
	'S_CUSER_ERROR_CANT_RENAME_GUEST_USER'=>			'Невозможно переименовать гостевого пользователя',
	'S_CUSER_ERROR_USER_UNABLE_RESTRICT_SELF_GUI_ACCESS'=>			'Пользователь не может ограничить доступ к GUI самому себе. Группа \"%1$s\"',
	'S_CUSER_ERROR_USER_CANT_DISABLE_SELF'=>			'Пользователь не может отключить себя. Группа \"%1$s\"',
	'S_CUSER_ERROR_INCORRECT_TIME_PERIOD'=>			'Некорректный период времени',
	'S_CUSER_ERROR_WRONG_PERIOD'=>			'Неправильный период [ %1$s ]',
	'S_CUSER_ERROR_INTERNAL_ZABBIX_ERROR'=>			'Внутренняя ошибка zabbix',
	'S_CONFIG_NOT_LOGGED_IN_ACCESS_DENIED'=>			'Вы не можете просмотреть этот URL %1$s. Вы должны войти в систему, чтобы увидеть эту страницу. Если вы считаете это сообщение ошибкой, пожалуйста проконсультируйтесь с вашими администраторами по поводу получения разрешений.',
	'S_CONFIG_ERROR_HEAD'=>			'ОШИБКА',
	'S_CONFIG_WARNING_WRONG_MONTH'=>			'[Неправильное значение месяца: %1$s]',
	'S_CONFIG_WARNING_WRONG_DOW'=>			'[Неправильное значение дня недели: %1$s]',
	'S_HELP'=>			'Помощь',
	'S_PROFILE'=>			'Профиль',
