...
INSERT INTO items VALUES (10072,0,'','',161,10001,'Average number of bytes received on interface lo (1min)','netloadin1[lo]',5,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10073,0,'','',161,10001,'Average number of bytes received on interface lo (5min)','netloadin5[lo]',10,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10074,0,'','',161,10001,'Average number of bytes received on interface lo (15min)','netloadin15[lo]',20,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10075,0,'','',161,10001,'Average number of bytes received on interface eth0 (1min)','netloadin1[eth0]',5,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10076,0,'','',161,10001,'Average number of bytes received on interface eth0 (5min)','netloadin5[eth0]',10,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10077,0,'','',161,10001,'Average number of bytes received on interface eth0 (15min)','netloadin15[eth0]',20,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10078,0,'','',161,10001,'Average number of bytes received on interface eth1 (1min)','netloadin1[eth1]',5,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10079,0,'','',161,10001,'Average number of bytes received on interface eth1 (5min)','netloadin5[eth1]',10,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10080,0,'','',161,10001,'Average number of bytes received on interface eth1 (15min)','netloadin15[eth1]',20,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10081,0,'','',161,10001,'Average number of bytes sent from interface lo (1min)','netloadout1[lo]',5,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10082,0,'','',161,10001,'Average number of bytes sent from interface lo (5min)','netloadout5[lo]',10,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10083,0,'','',161,10001,'Average number of bytes sent from interface lo (15min)','netloadout15[lo]',20,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10084,0,'','',161,10001,'Average number of bytes sent from interface eth0 (1min)','netloadout1[eth0]',5,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10085,0,'','',161,10001,'Average number of bytes sent from interface eth0 (5min)','netloadout5[eth0]',10,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10086,0,'','',161,10001,'Average number of bytes sent from interface eth0 (15min)','netloadout15[eth0]',20,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10087,0,'','',161,10001,'Average number of bytes sent from interface eth1 (1min)','netloadout1[eth1]',5,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10088,0,'','',161,10001,'Average number of bytes sent from interface eth1 (5min)','netloadout5[eth1]',10,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
INSERT INTO items VALUES (10089,0,'','',161,10001,'Average number of bytes sent from interface eth1 (15min)','netloadout15[eth1]',20,30,0,0,NULL,NULL,NULL,0,0,'','bps',0);
