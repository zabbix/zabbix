		...
		char *error, size_t max_error_len)
{
	...
	*error = '\0';
	...
	substitute_simple_macros(NULL, NULL, NULL, &host->hostid, NULL, NULL, NULL, &port, MACRO_TYPE_COMMON, NULL, 0);
		...
		char *error, size_t max_error_len)
{
	...
	*error = '\0';
	...
	substitute_simple_macros(NULL, NULL, NULL, &host->hostid, NULL, NULL, NULL,
	...
	*error = '\0';
	...
	switch (script->type)
	{
		...
		case ZBX_SCRIPT_TYPE_GLOBAL_SCRIPT:
			...
			{
				substitute_simple_macros(NULL, NULL, NULL, NULL, host, NULL, NULL,
