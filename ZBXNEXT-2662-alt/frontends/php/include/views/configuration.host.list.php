...
foreach ($data['hosts'] as $host) {
	...
	$applications = array(new CLink(_('Applications'), 'applications.php?groupid='.$data['groupId'].'&hostid='.
		$host['hostid']), CViewHelper::showNum($host['applications'])
	);
...
$form->addItem(array($table, $data['paging'], get_table_header(new CActionButtonList('action', 'hosts',
	array(
