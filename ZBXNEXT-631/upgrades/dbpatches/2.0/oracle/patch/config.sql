...
ALTER TABLE config ADD severity_color_0 nvarchar2(6) DEFAULT 'AADDAA';
ALTER TABLE config ADD severity_color_1 nvarchar2(6) DEFAULT 'CCE2CC';
ALTER TABLE config ADD severity_color_2 nvarchar2(6) DEFAULT 'EFEFCC';
ALTER TABLE config ADD severity_color_3 nvarchar2(6) DEFAULT 'DDAAAA';
ALTER TABLE config ADD severity_color_4 nvarchar2(6) DEFAULT 'FF8888';
ALTER TABLE config ADD severity_color_5 nvarchar2(6) DEFAULT 'FF0000';
