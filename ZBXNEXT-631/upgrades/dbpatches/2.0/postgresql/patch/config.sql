ALTER TABLE ONLY config 
	...
	ADD severity_color_0 char(6) DEFAULT 'DBDBDB' NOT NULL,
	ADD severity_color_1 char(6) DEFAULT 'D6F6FF' NOT NULL,
	ADD severity_color_2 char(6) DEFAULT 'FFF6A5' NOT NULL,
	ADD severity_color_3 char(6) DEFAULT 'FFB689' NOT NULL,
	ADD severity_color_4 char(6) DEFAULT 'FF9999' NOT NULL,
	ADD severity_color_5 char(6) DEFAULT 'FF3838' NOT NULL,
