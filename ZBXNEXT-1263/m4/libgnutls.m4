# GNU TLS CHECK_CONFIG ([DEFAULT-ACTION])
# ----------------------------------------------------------
# Derived from libssh2.m4 written by
#    Alexander Vladishev                      Oct-26-2009
#    Dmitry Borovikov                         Feb-13-2010
#
# Checks for GNU TLS library libgnutls.  DEFAULT-ACTION is the string yes or no to
# specify whether to default to --with-libgnutls or --without-libgnutls.
# If not supplied, DEFAULT-ACTION is no.
#
# The minimal supported GNU TLS library libgnutls version is TODO: XXXXX.
#
...
[
  AC_ARG_WITH(gnutls,[
If you want to use encryption provided by GNU TLS libgnutls library:
AC_HELP_STRING([--with-gnutls@<:@=DIR@:>@],[use GNU TLS package @<:@default=no@:>@, DIR is the GNU TLS library libgnutls install directory.])],
    [
  ...
  if test "x$want_gnutls" = "xyes"; then
     AC_MSG_CHECKING(for GNU TLS support)
  ...
  fi # if test "x$want_gnutls" != "xno"; then
