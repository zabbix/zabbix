...
#define VER_FILEVERSION		ZABBIX_VERSION_MAJOR,ZABBIX_VERSION_MINOR,ZABBIX_VERSION_PATCH,ZABBIX_VERSION_REVISION
...
#define VER_LEGALCOPYRIGHT_STR	"Copyright (C) 2001-2019 " VER_COMPANYNAME_STR
