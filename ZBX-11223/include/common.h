...
typedef enum
{
	FUNCTION_FIND_TYPE_FULL_STRING = 0,	/* function searching in whole string */
	FUNCTION_FIND_TYPE_FIRST_CHAR,		/* string should begin with first function char */
}
zbx_function_find_type_t;
