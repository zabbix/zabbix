...
class testMetrics extends CZabbixTest
{
	...
	public static function metrics()
	{
		...
		return array(
			...
			array('vfs.dev.read[,bps]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[,bps,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[,bps,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[,bps,avg15]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[,bps,avg15,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.read[,bps,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.read[all,bps]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[all,bps,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[all,bps,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[all,bps,avg15]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[all,bps,avg15,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.read[all,bps,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.read[sda]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.read[sda,,avg1]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.read[sda,bps]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,bps,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,bps,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,bps,avg15]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,bps,avg15,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.read[sda,bps,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.read[sda,bytes]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,bytes,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,bytes,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,bytes,avg15]',	TYPE_UINT,	'',		-1,	-1),
			...
			array('vfs.dev.read[sda,operations,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,operations,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,operations,avg15]',	TYPE_UINT,	'',		-1,	-1),
			...
			array('vfs.dev.read[sda,sectors,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,sectors,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.read[sda,sectors,avg15]',	TYPE_UINT,	'',		-1,	-1),
			...
			array('vfs.dev.write[,bps]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[,bps,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[,bps,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[,bps,avg15]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[,bps,avg15,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.write[,bps,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.write[all,bps]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[all,bps,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[all,bps,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[all,bps,avg15]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[all,bps,avg15,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.write[all,bps,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.write[sda]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.write[sda,,avg1]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.write[sda,bps]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,bps,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,bps,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,bps,avg15]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,bps,avg15,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.write[sda,bps,wrong_param]',	TYPE_ANY,	ZBX_NOTSUPPORTED,		-1,	-1),
			array('vfs.dev.write[sda,bytes]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,bytes,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,bytes,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,bytes,avg15]',	TYPE_UINT,	'',		-1,	-1),
			...
			array('vfs.dev.write[sda,operations,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,operations,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,operations,avg15]',	TYPE_UINT,	'',		-1,	-1),
			...
			array('vfs.dev.write[sda,sectors,avg1]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,sectors,avg5]',	TYPE_UINT,	'',		-1,	-1),
			array('vfs.dev.write[sda,sectors,avg15]',	TYPE_UINT,	'',		-1,	-1),
...
//			array('system.cpu.load[1,avg15]',	TYPE_FLOAT,	'',		0.001,	10),
			...
			array('system.swap.size[/dev/sda5,total]',	TYPE_UINT,	'',		-1,	-1),
