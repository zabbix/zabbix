...
<?php
	...
	'S_KEY_IS_VALID'=>			'Ключ є дійсним',
	'S_INCORRECT_SYNTAX_NEAR'=>			'некоректний синтаксис біля \'%1$s\' в позиції %2$d',
	'S_INCORRECT_USAGE_OF_BRACKETS'=>			'некоректне використання символів дужок. \'%s\' знайдено після останньої дужки.',
	'S_INVALID_KEY_FORMAT'=>			'Неприпустимий формат ключа',
	'S_KEY_CANNOT_BE_EMPTY'=>			'Ключ не може бути пустим',
	'S_KEY_TOO_LARGE'=>			'Ключ занадто великий: максимум %d символів',
