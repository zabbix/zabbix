...
// group
		if(!is_null($options['group'])){
			...
			$sql_parts['where'][] = ' g.name='.zbx_dbstr(zbx_strtoupper($options['group']));
		}
...
// host
		if(!is_null($options['host'])){
			...
			$sql_parts['from']['hosts'] = 'hosts h';
			$sql_parts['where']['hi'] = 'h.hostid=i.hostid';
			$sql_parts['where'][] = ' h.host='.zbx_dbstr(zbx_strtoupper($options['host']));
		}
...
// application
		if(!is_null($options['application'])){
			...
			$sql_parts['where'][] = ' a.name='.zbx_dbstr(zbx_strtoupper($options['application']));
		}
