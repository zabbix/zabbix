...
<?php
	...
	'S_EVENT_ACTION_CMDS_DATE_FORMAT'=>			'A.M.d H:i:s',
	...
	'S_HISTORY_LOG_ITEM_DATE_FORMAT'=>			'[A.M.d H:i:s]',
	'S_HISTORY_LOG_LOCALTIME_DATE_FORMAT'=>			'A.M.d H:i:s',
	'S_HISTORY_LOG_ITEM_PLAINTEXT'=>			'A-m-d H:i:s',
	'S_HISTORY_PLAINTEXT_DATE_FORMAT'=>			'A-m-d H:i:s',
	'S_HISTORY_ITEM_DATE_FORMAT'=>			'A.M.d H:i:s',
	...
	'S_EVENTS_DATE_FORMAT'=>			'd M A H:i:s',
	'S_EVENTS_DISCOVERY_TIME_FORMAT'=>			'A.M.d H:i:s',
	'S_EVENTS_ACTION_TIME_FORMAT'=>			'A.M.d H:i:s',
	'S_EVENTS_EVENT_DETAILS_DATE_FORMAT'=>			'A.M.d H:i:s',
	'S_EVENTS_SMALL_EVENT_LIST_DATE_FORMAT'=>			'A.M.d H:i:s',
	'S_EVENTS_POPUP_EVENT_LIST_DATE_FORMAT'=>			'd M A H:i:s',
	'S_EVENTS_TRIGGERS_EVENTS_HISTORY_LIST_DATE_FORMAT'=>			'A.M.d H:i:s',
	'S_LAST_CHECK'=>			'Última checagem',
	'S_LAST_VALUE'=>			'Último valor',
	'S_LATEST_ITEMS_TRIGGERS_DATE_FORMAT'=>			'd M A H:i:s',
	...
	'S_MARK_ELEMENTS_ON_TRIGGER_STATUS_CHANGE'=>			'Marcar elementos nas mudanças de status dos triggers',
	...
	'S_NOTHING'=>			'Nada',
	'S_MAPS_DATE_FORMAT'=>			'm.d.A H:i:s',
	...
	'S_QUEUE_NODES_DATE_FORMAT'=>			'd M A H:i:s',
	...
	'S_NUMBER_OF_TRIGGERS'=>			'Número de triggers (ativas/desativadas)[problema/desconhecido/ok]',
	'S_NUMBER_OF_TRIGGERS_SHORT'=>			'Triggers (a/d)[p/d/o]',
	'S_NUMBER_OF_TRIGGERS_TOOLTIP'=>			'Somente triggers de hosts habilitados e dependentes de itens habilitados são contadas',
	'S_NUMBER_OF_ITEMS'=>			'Número de itens (monitorados/desativados/não suportado)',
	'S_NUMBER_OF_ITEMS_SHORT'=>			'Itens (m/d/n)',
	...
	'S_NUMBER_OF_HOSTS'=>			'Número de hosts (monitorados/não monitorados/templates)',
	...
	'S_CHART4_HEADER_TITLE'=>			'%s (ano %s)',
	'S_CHART4_HEADER_DATE_FORMAT'=>			'A',
	'S_CHART4_TIMELINE_DATE_FORMAT'=>			'd.M',
	'S_CHART5_HEADER_TITLE'=>			'%s (ano %s)',
	'S_CHART5_HEADER_DATE_FORMAT'=>			'A',
	'S_CHART5_TIMELINE_DATE_FORMAT'=>			'd.M',
	'S_CHARTBAR_HOURLY_DATE_FORMAT'=>			'A.m.d H:i',
	'S_CHARTBAR_DAILY_DATE_FORMAT'=>			'A.m.d',
	...
	'S_MONTHLY'=>			'Mensal',
	'S_YEARLY'=>			'Anual',
	'S_REPORT3_ANNUALLY_DATE_FORMAT'=>			'A',
	'S_REPORT3_MONTHLY_DATE_FORMAT'=>			'M A',
	'S_REPORT3_DAILY_DATE_FORMAT'=>			'd M A',
	'S_REPORT3_WEEKLY_DATE_FORMAT'=>			'd M A H:i',
	'S_SERVICES_UPTIME_DATE_FORMAT'=>			'l H:i',
	'S_SERVICES_DOWNTIME_DATE_FORMAT'=>			'l H:i',
	'S_SERVICES_ONETIME_DOWNTIME_DATE_FORMAT'=>			'd M A H:i',
	...
	'S_REPORT4_MONTHLY_DATE_FORMAT'=>			'M A',
	'S_REPORT4_DAILY_DATE_FORMAT'=>			'd M A',
	'S_REPORT4_WEEKLY_DATE_FORMAT'=>			'd M A H:i',
	...
	'S_DARKEN'=>			'Escurecer',
	'S_BRIGHTEN'=>			'Clarear',
	'S_REPORTS_BAR_REPORT_DATE_FORMAT'=>			'd M A H:i:s',
	'S_SCREENS'=>			'Telas',
	'S_SCREEN'=>			'Tela',
	...
	'S_POPUP_PERIOD_CAPTION_DATE_FORMAT'=>			'd M A H:i:s',
	...
	'S_CHECK_EXPRESSION_PART_STARTING_FROM'=>			'Verifique a parte da expressão a partir de \'%s\'',
	...
	'S_Y'=>			'Y',
	'S_YOTTA'=>			'Yotta',
	'S_FUNCT_UNIXTIMESTAMP_DATE_FORMAT'=>			'A.m.d H:i:s',
	...
	'S_HOST_HAS_BEEN_DELETED_MSG'=>			'Host %s foi removido do sistema',
	...
	'S_EXPRESSION_FUNCTION_DOES_NOT_ACCEPTS_PARAMS_ERROR'=>			'A Função \'%s\' não aceita parametros.',
	...
	'S_SCREENS_PLAIN_TEXT_DATE_FORMAT'=>			'd M A H:i:s',
	...
	'S_GRAPH_DELETED_FROM_HOSTS'=>			'Gráfico "%s" removido do host %s',
	...
	'S_WEEK_SMALL'=>			'semana',
	'S_MAINTENANCES_SCHEDULE_DATE_FORMAT'=>			'd M A',
	...
	'S_CUSER_ERROR_ACCOUNT_IS_BLOCKED_FOR_XX_MINUTES'=>			'Conta bloqueada por %s segundos',
	...
	'S_CUSER_ERROR_ATTEMP_FAILED'=>			'%1$s falhas em tentativas de login. Última falha foi de %2$s às %3$s.',
	'S_CUSER_ERROR_ONLY_ADMIN_CAN_CREATE_USERS'=>			'Somente Administradores ZABBIX podem criar Usuários',
	'S_CUSER_ERROR_ONLY_ADMIN_CAN_UPDATE_USERS'=>			'Somente Administradores ZABBIX podem atualizar Usuários',
	'S_CUSER_ERROR_ONLY_ADMIN_CAN_DELETE_USERS'=>			'Somente Administradores ZABBIX podem deletar Usuários',
	...
	'S_CUSER_ERROR_USER_EXISTS'=>			'Usuário [ %1$s ] já existe',
	'S_CUSER_ERROR_CANT_RENAME_GUEST_USER'=>			'Impossível renomear mídias de usuário',
	'S_CUSER_ERROR_USER_UNABLE_RESTRICT_SELF_GUI_ACCESS'=>			'Usuário não pode restringir seu próprio acesso a GUI. Grupo "%1$s"',
	'S_CUSER_ERROR_USER_CANT_DISABLE_SELF'=>			'Usuário não pode desabilitar a si mesmo. Grupo "%1$s"',
	'S_CUSER_ERROR_INCORRECT_TIME_PERIOD'=>			'Período de tempo incorreto',
	'S_CUSER_ERROR_WRONG_PERIOD'=>			'Período errado [ %1$s ]',
	...
	'S_CONFIG_WARNING_WRONG_MONTH'=>			'[Mês errado: %1$s]',
	'S_CONFIG_WARNING_WRONG_DOW'=>			'[Dia da semana errado: %1$s]',
	'S_HELP'=>			'Ajuda',
