ALTER TABLE ONLY drules ALTER proxy_hostid DROP DEFAULT;
ALTER TABLE ONLY drules ALTER proxy_hostid DROP NOT NULL;
ALTER TABLE ONLY drules ALTER unique_dcheckid DROP DEFAULT;
ALTER TABLE ONLY drules ALTER unique_dcheckid DROP NOT NULL;
