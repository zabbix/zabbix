...
ALTER TABLE ONLY druleuniq ADD CONSTRAINT c_druleuniq_1 FOREIGN KEY (druleid) REFERENCES drules (druleid) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY druleuniq ADD CONSTRAINT c_druleuniq_2 FOREIGN KEY (dcheckid) REFERENCES dchecks (dcheckid) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY drules ADD CONSTRAINT c_drules_1 FOREIGN KEY (proxy_hostid) REFERENCES hosts (hostid) ON UPDATE CASCADE;
