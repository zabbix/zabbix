ALTER TABLE ONLY config ALTER alert_usrgrpid DROP DEFAULT;
ALTER TABLE ONLY config ALTER alert_usrgrpid DROP NOT NULL;
ALTER TABLE ONLY config ALTER discovery_groupid DROP DEFAULT;
ALTER TABLE ONLY config ALTER discovery_groupid DROP NOT NULL;
ALTER TABLE ONLY config ADD ns_support integer DEFAULT '0' NOT NULL;
