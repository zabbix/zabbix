ALTER TABLE ONLY sysmaps_links ALTER sysmapid DROP DEFAULT;
ALTER TABLE ONLY sysmaps_links ALTER selementid1 DROP DEFAULT;
ALTER TABLE ONLY sysmaps_links ALTER selementid2 DROP DEFAULT;
