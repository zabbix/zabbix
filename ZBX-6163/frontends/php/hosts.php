...
elseif (isset($_REQUEST['form'])) {
	...
	$filterTable->addRow(array(
		array(array(bold(_('Name')), SPACE._('like').':'.SPACE), new CTextBox('filter_host', $filter['host'], 20)),
		array(array(bold(_('DNS')), SPACE._('like').':'.SPACE), new CTextBox('filter_dns', $filter['dns'], 20)),
		array(array(bold(_('IP')), SPACE._('like').':'.SPACE), new CTextBox('filter_ip', $filter['ip'], 20)),
		array(bold(_('Port')), ':'.SPACE, new CTextBox('filter_port', $filter['port'], 20))
	));
