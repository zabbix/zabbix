...
$fields = array(
	...
	'delay' =>		array(T_ZBX_INT, O_OPT, null,	BETWEEN(ZBX_MIN, SEC_PER_DAY),
		...
		_('Update interval (in sec)'), _s('must be between %1$s and %2$s',ZBX_MIN, SEC_PER_DAY)),
	...
	'history' =>		array(T_ZBX_INT, O_OPT, null,	BETWEEN(ZBX_MIN, ZBX_MER), 'isset({save})',
		_('Keep history (in days)'), _s('must be between %1$s and %2$s', ZBX_MIN, ZBX_MER)),
	...
	'trends' =>		array(T_ZBX_INT, O_OPT, null,	BETWEEN(ZBX_MIN, ZBX_MER),
		...
		_('Keep trends (in days)'), _s('must be between %1$s and %2$s', ZBX_MIN, ZBX_MER)),
	...
	'inventory_link' =>	array(T_ZBX_INT, O_OPT, null,	BETWEEN(0, 65535),
		'isset({save})&&{value_type}!='.ITEM_VALUE_TYPE_LOG),
	...
	'snmp_oid' =>		array(T_ZBX_STR, O_OPT, null,	NOT_EMPTY,
		...
		_('SNMP OID')),
	'port' =>		array(T_ZBX_STR, O_OPT, null,	BETWEEN(ZBX_MIN, ZBX_MER),
		'isset({save})&&isset({type})&&'.IN(ITEM_TYPE_SNMPV1.','.ITEM_TYPE_SNMPV2C.','.ITEM_TYPE_SNMPV3,'type'),
		_('Port'), _s('must be between %1$s and %2$s', ZBX_MIN, ZBX_MER)),
	...
	'filter_port' =>		array(T_ZBX_INT, O_OPT, P_UNSET_EMPTY,	BETWEEN(ZBX_MIN, ZBX_MER),	null,
		_('Port'), _s('must be between %1$s and %2$s', ZBX_MIN, ZBX_MER)),
	...
	'filter_delay' =>		array(T_ZBX_INT, O_OPT, P_UNSET_EMPTY,	BETWEEN(0, SEC_PER_DAY),	null,
		_('Update interval'), _s('must be between %1$s and %2$s', 0, SEC_PER_DAY)),
