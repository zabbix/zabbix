...
$fields = array(
	...
	'event_expire'=> 		array(T_ZBX_INT, O_OPT, null,	BETWEEN(1, 999999),	'isset({save})',
		_('Show events not older than (in days)')),
	'event_show_max'=> 		array(T_ZBX_INT, O_OPT, null,	BETWEEN(1, 999999),	'isset({save})',
	...
	'max_in_table' => 		array(T_ZBX_INT, O_OPT, null,	BETWEEN(1, 999999),	'isset({save})',
