...
//		VAR			TYPE	OPTIONAL FLAGS	VALIDATION	EXCEPTION
	$fields=array(
		...
		'width'=>		array(T_ZBX_INT, O_OPT,	 NULL,	BETWEEN(ZBX_MIN, ZBX_MER), 'isset({save})',
			_('Width'), _s('must be between %1$s and %2$s', ZBX_MIN, ZBX_MER)),
		'height'=>		array(T_ZBX_INT, O_OPT,	 NULL,	BETWEEN(ZBX_MIN, ZBX_MER), 'isset({save})',
			_('Height'), _s('must be between %1$s and %2$s', ZBX_MIN, ZBX_MER)),
		...
		'label_type_host'=>	array(T_ZBX_INT, O_OPT,	 NULL,
			BETWEEN(MAP_LABEL_TYPE_LABEL,MAP_LABEL_TYPE_CUSTOM), 'isset({save})'),
		'label_type_hostgroup'=>	array(T_ZBX_INT, O_OPT,	 NULL,
			BETWEEN(MAP_LABEL_TYPE_LABEL,MAP_LABEL_TYPE_CUSTOM), 'isset({save})'),
		'label_type_trigger'=>		array(T_ZBX_INT, O_OPT,	 NULL,
			BETWEEN(MAP_LABEL_TYPE_LABEL,MAP_LABEL_TYPE_CUSTOM), 'isset({save})'),
		'label_type_map'=>		array(T_ZBX_INT, O_OPT,	 NULL,
			BETWEEN(MAP_LABEL_TYPE_LABEL,MAP_LABEL_TYPE_CUSTOM), 'isset({save})'),
		'label_type_image'=>		array(T_ZBX_INT, O_OPT,	 NULL,
			BETWEEN(MAP_LABEL_TYPE_LABEL,MAP_LABEL_TYPE_CUSTOM), 'isset({save})'),
		...
		'label_type'=>		array(T_ZBX_INT, O_OPT,	 NULL,
			BETWEEN(MAP_LABEL_TYPE_LABEL,MAP_LABEL_TYPE_CUSTOM), 'isset({save})'),
