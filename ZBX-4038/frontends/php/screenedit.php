...
$fields = array(
	...
	'colspan' =>		array(T_ZBX_INT, O_OPT, null,		BETWEEN(0, 100),	null, _('Column span'),
		_s('must be between %1$s and %2$s', 0, 100)),
	...
	'x' =>			array(T_ZBX_INT, O_OPT, null,		BETWEEN(1, 100),
		'isset({save})&&(isset({form})&&({form}!="update"))'),
	'y' =>			array(T_ZBX_INT, O_OPT, null,		BETWEEN(1, 100),
		'isset({save})&&(isset({form})&&({form}!="update"))'),
