...
//		VAR			TYPE	OPTIONAL FLAGS	VALIDATION	EXCEPTION
		...
		'port'=>		array(T_ZBX_INT, O_OPT,	null,	BETWEEN(ZBX_MIN_PORT, ZBX_MAX_PORT), null, _('Port')),
		...
		'zbx_server_port'=>	array(T_ZBX_INT, O_OPT, null,	BETWEEN(ZBX_MIN_PORT, ZBX_MAX_PORT), null, _('Port')),
