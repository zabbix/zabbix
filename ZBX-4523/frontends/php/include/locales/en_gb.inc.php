...
<?php
	...
	'S_ADD_GRAPH' =>					'Add graph',
	'S_ADD_MAP' =>						'Add map',
	'S_ADD_MISSING' =>					'Add missing',
	'S_ADD_SCREEN' =>					'Add screen',
	'S_ADD_SIMPLE_GRAPH' =>				'Add simple graph',
	'S_ADD_SLIDESHOW' =>				'Add slide show',
	'S_CANNOT_UPDATE_HOSTS' =>			'Cannot update hosts',
	'S_CANNOT_UPDATE_HTTP_AUTH' =>		'Cannot update HTTP authentication',
	'S_CREATE_LOCALE' =>				'Create locale',
	'S_CREATE_LOCALE_FROM' =>			'Create locale from',
	'S_DELAY_SECOND_IN_PARENTHESES' =>	'Delay (seconds)',
	...
	'S_HOST_PROFILE_ALREADY_EXISTS' => 	'Host profile already exists',
	'S_HTTP_AUTH_ENABLED' =>			'HTTP authentication enabled',
	'S_HTTP_AUTH_UPDATED' =>			'HTTP authentication disabled',
	'S_IMPORTED_SUCCESSEFULLY' =>		'Imported successfully',
	'S_IMPORT_FAILED' =>				'Import failed',
	'S_IN_GROUP' =>						'In group',
	'S_IN_GROUPS' =>					'In groups',
	'S_IN_MAINTENANCE' =>				'In maintenance',
	'S_LDAP_AUTHENTICATION_ENABLED' =>	'LDAP authentication enabled',
	'S_LDAP_HOST' =>					'LDAP host',
	'S_LDAP_LOGIN_SUCCESSFUL_SMALL' =>	'LDAP login successful',
	'S_LDAP_LOGIN_WAS_NOT_SUCCESSFUL_SMALL' => 'LDAP login was not successful',
	'S_LDAP_UPDATED' =>					'LDAP updated',
	'S_LDAP_WAS_NOT_UPDATED' =>			'LDAP was not updated',
	'S_MIN_5_MINUTES' =>				'min 5 minutes',
	'S_MUST_BE_VALID_LDAP_USER' =>		'must be valid LDAP user',
	'S_NEW_OPERATION_CONDITION' =>		'New operation condition',
	'S_OTHER_GROUPS' =>					'Other groups',
	'S_OTHER_HOSTS' =>					'Other hosts',
	'S_PROXY_HOSTS' =>					'Proxy hosts',
	'S_REMOVE_ALL_GRAPHS' =>			'Remove all graphs',
	'S_REMOVE_ALL_MAPS' =>				'Remove all maps',
	'S_REMOVE_ALL_SCREENS' =>			'Remove all screens',
	'S_REMOVE_ALL_SIMPLE_GRAPHS' =>		'Remove all simple graphs',
	'S_REMOVE_ALL_SLIDES' =>			'Remove all slides',
	'S_REQUIRED_HOST_PERMISSIONS' =>	'Required host permissions',
	'S_SCENARIO_STEP_NAME_SHOULD_CONTAIN_PRINTABLE_ONLY' => 'Scenario step name should contain only printable characters',
	'S_SEC_IS_A_MINIMAL_LIMITATION_EXECTUTION_TIME_SMALL' => 'sec is a minimal limitation on execution time of PHP scripts',
	'S_SEC_IS_A_MINIMAL_LIMITATION_INPUT_PARSE_TIME_SMALL' => 'sec is a minimal limitation on input parse time for PHP scripts',
	'S_SHOW_EVENTS_NOT_OLDER_DAYS' =>	'Show events not older (days)',
	'S_TEST_AUTHENTICATION' =>			'Test authentication',
	'S_TIME_PERIOD_MAX_VALUE' =>		'Time period max value',
	'S_TIME_PERIOD_MIN_VALUE' =>		'Time period min value',
	'S_UPDATE_EXISTING' =>				'Update existing',
	'S_USER_PASSWORD' =>				'User password',
	'S_X_LABEL' =>						'X label',
	'S_Y_LABEL' =>						'Y label',
	'S_ZABBIX_INTERNAL_AUTH_ENABLED' => 'Zabbix Internal authentication enabled',
	'S_ZABBIX_INTERNAL_AUTH_UPDATED' => 'Zabbix Internal authentication disabled'
);
?>
