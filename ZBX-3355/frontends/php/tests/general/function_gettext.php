...
class function_gettext extends PHPUnit_Framework_TestCase
{
	public static function provider_s()
	{
		return array(
			...
			array('reverse argument oreder: %2$s, %1$s', array('first','second'), 'reverse argument oreder: second, first'),
		);
	}
	...
	public static function provider_n()
	{
		return array(
			...
			array('on table %2$s, there is %1$d cake', 'on table %2$s, there is %1$d cakes', array(1, 'table_name'), 'on table table_name, there is 1 cake'),
			array('on table %2$s, there is %1$d cake', 'on table %2$s, there is %1$d cakes', array(2, 'table_name'), 'on table table_name, there is 2 cakes'),
