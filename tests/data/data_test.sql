...
-- added web scenarios for simpleUpdate tests
INSERT INTO httptest (httptestid,name,applicationid,nextcheck,delay,status,macros,agent,authentication,http_user,http_password,hostid,templateid,http_proxy,retries) VALUES (4,'testFormWeb1',356,0,60,0,'','Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Trident/6.0)',0,'','',40001,NULL,'',1);
INSERT INTO httptest (httptestid,name,applicationid,nextcheck,delay,status,macros,agent,authentication,http_user,http_password,hostid,templateid,http_proxy,retries) VALUES (5,'testFormWeb2',357,0,60,0,'','Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Trident/6.0)',0,'','',40001,NULL,'',1);
INSERT INTO httptest (httptestid,name,applicationid,nextcheck,delay,status,macros,agent,authentication,http_user,http_password,hostid,templateid,http_proxy,retries) VALUES (6,'testFormWeb3',358,0,60,0,'','Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Trident/6.0)',0,'','',40001,NULL,'',1);
INSERT INTO httptest (httptestid,name,applicationid,nextcheck,delay,status,macros,agent,authentication,http_user,http_password,hostid,templateid,http_proxy,retries) VALUES (7,'testFormWeb4',359,0,60,0,'','Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.1; Trident/6.0)',0,'','',40001,NULL,'',1);
INSERT INTO httpstep (httpstepid,httptestid,name,no,url,timeout,posts,required,status_codes) VALUES (4,4,'testFormWeb1',1,'testFormWeb1',15,'','','');
INSERT INTO httpstep (httpstepid,httptestid,name,no,url,timeout,posts,required,status_codes) VALUES (5,5,'testFormWeb2',1,'testFormWeb2',15,'','','');
INSERT INTO httpstep (httpstepid,httptestid,name,no,url,timeout,posts,required,status_codes) VALUES (6,6,'testFormWeb3',1,'testFormWeb3',15,'','','');
INSERT INTO httpstep (httpstepid,httptestid,name,no,url,timeout,posts,required,status_codes) VALUES (7,7,'testFormWeb4',1,'testFormWeb4',15,'','','');
...
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (10,4,23400,2);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (11,4,23401,3);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (12,4,23402,4);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (13,5,23406,2);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (14,5,23407,3);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (15,5,23408,4);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (16,6,23412,2);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (17,6,23413,3);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (18,6,23414,4);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (19,7,23418,2);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (20,7,23419,3);
INSERT INTO httptestitem (httptestitemid,httptestid,itemid,type) VALUES (21,7,23420,4);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (10,4,23403,2);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (11,4,23404,1);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (12,4,23405,0);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (13,5,23409,2);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (14,5,23410,1);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (15,5,23411,0);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (16,6,23415,2);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (17,6,23416,1);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (18,6,23417,0);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (19,7,23421,2);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (20,7,23422,1);
INSERT INTO httpstepitem (httpstepitemid,httpstepid,itemid,type) VALUES (21,7,23423,0);
