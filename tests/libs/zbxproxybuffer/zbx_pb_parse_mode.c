...
/* Same wrap/stub block as zbx_pb_discovery_close.c — prevents libzbxmockdata.a
 * objects from being extracted and conflicting with the stubs below.          */
...
void	zbx_mock_test_entry(void **state)
{
	...
	expected_result = zbx_mock_get_parameter_int("out.result");
