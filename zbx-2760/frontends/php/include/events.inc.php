...
function getLastEvents($options){
	...
	if(isset($options['limit'])) $triggerOptions['limit'] = $options['limit'];
	if(isset($options['value'])) $triggerOptions['filter']['value'] = $options['value'];
	if(isset($options['priority'])) $triggerOptions['filter']['priority'] = $options['priority'];
	if(isset($options['lastChangeSince'])) $triggerOptions['lastChangeSince'] = $options['lastChangeSince']; // 15 min
	...
	if(isset($options['limit'])) $eventOptions['limit'] = $options['limit'];
	if(isset($options['value'])) $eventOptions['value'] = $options['value'];
	if(isset($options['eventid_from'])) $eventOptions['eventid_from'] = $options['eventid_from'];
	if(isset($options['lastChangeSince'])) $eventOptions['time_from'] = $options['lastChangeSince']; // 15 min
