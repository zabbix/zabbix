...
insert into help_items values(0,'net.tcp.dns.query[ip, name, type]','Performs a query for the record type specified by the parameter type');
...
insert into help_items values(7,'net.tcp.dns[ip, name]','Checks if DNS service is up. 0 - DNS is down, 1 - DNS is up.');
insert into help_items values(7,'net.tcp.dns.query[ip, name, type]','Performs a query for the record type specified by the parameter type');
