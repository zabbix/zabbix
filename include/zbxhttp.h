...
typedef size_t	(*zbx_curl_write_cb_t)(void *ptr, size_t size, size_t nmemb, void *userdata);
typedef size_t	(*zbx_curl_ignore_cb_t)(void *ptr, size_t size, size_t nmemb, void *userdata);
typedef size_t	(*zbx_curl_common_cb_t)(void *ptr, size_t size, size_t nmemb, void *userdata);

int	zbx_http_prepare_callbacks(CURL *easyhandle, zbx_http_response_t *header, zbx_http_response_t *body,
		zbx_curl_write_cb_t header_cb, zbx_curl_ignore_cb_t body_cb, char *errbuf, char **error);
