...
typedef struct
{
	...
	/* linked jobs count */
#define ZBX_VMWARE_UPDATE_CONF		0
#define ZBX_VMWARE_UPDATE_PERFCOUNTERS	1
#define ZBX_VMWARE_UPDATE_REST_TAGS	2
#define ZBX_VMWARE_UPDATE_EVENTLOG	3

#define ZBX_VMWARE_UPDATE_NUM		4
	unsigned char				jobs_num[ZBX_VMWARE_UPDATE_NUM];

	/* linked jobs types */
#define ZBX_VMWARE_REQ				(8*2)
#define ZBX_VMWARE_REQ_UPDATE_CONF		(ZBX_VMWARE_FLAG_UPDATE_CONF		<< ZBX_VMWARE_REQ)
#define ZBX_VMWARE_REQ_UPDATE_PERFCOUNTERS	(ZBX_VMWARE_FLAG_UPDATE_PERFCOUNTERS	<< ZBX_VMWARE_REQ)
#define ZBX_VMWARE_REQ_UPDATE_REST_TAGS		(ZBX_VMWARE_FLAG_UPDATE_REST_TAGS	<< ZBX_VMWARE_REQ)
#define ZBX_VMWARE_REQ_UPDATE_EVENTLOG		(ZBX_VMWARE_FLAG_UPDATE_EVENTLOG	<< ZBX_VMWARE_REQ)
...
struct zbx_vmware_job
{
	time_t				nextcheck;
	time_t				ttl;
#define ZBX_VMWARE_FLAG_UPDATE_CONF		(0x1 << ZBX_VMWARE_UPDATE_CONF)
#define ZBX_VMWARE_FLAG_UPDATE_PERFCOUNTERS	(0x1 << ZBX_VMWARE_UPDATE_PERFCOUNTERS)
#define ZBX_VMWARE_FLAG_UPDATE_REST_TAGS	(0x1 << ZBX_VMWARE_UPDATE_REST_TAGS)
#define ZBX_VMWARE_FLAG_UPDATE_EVENTLOG		(0x1 << ZBX_VMWARE_UPDATE_EVENTLOG)
	int				type;
	int				expired;
	int				revision;
