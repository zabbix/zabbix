...
#	define zbx_rwlock_create(rwlock, name, error)	zbx_mutex_create(rwlock + ZBX_MUTEX_COUNT, name, error)
#	define zbx_rwlock_wrlock(rwlock)		__zbx_mutex_lock(__FILE__, __LINE__, rwlock + ZBX_MUTEX_COUNT)
#	define zbx_rwlock_rdlock(rwlock)		__zbx_mutex_lock(__FILE__, __LINE__, rwlock + ZBX_MUTEX_COUNT)
#	define zbx_rwlock_unlock(rwlock)		__zbx_mutex_unlock(__FILE__, __LINE__, rwlock + ZBX_MUTEX_COUNT)
#	define zbx_rwlock_destroy(rwlock)		zbx_mutex_destroy(rwlock + ZBX_MUTEX_COUNT)
