...
typedef struct
{
	zbx_get_config_str_f	get_source_ip_cb;
	zbx_get_config_str_f	get_fping_location_cb;
#ifdef HAVE_IPV6
	zbx_get_config_str_f	get_fping6_location_cb;
#endif
	zbx_get_config_str_f	get_tmpdir_cb;
}
