...
typedef int (*zbx_async_task_process_task_cb_t)(short event, void *data, int *fd, struct evutil_addrinfo **current_ai,
...
void			zbx_async_poller_add_task(struct event_base *ev, struct evdns_base *dnsbase, const char *addr,
			void *data, int timeout, zbx_async_task_process_task_cb_t async_task_process_task_cb,
