...
void	zbx_interface_availability_init(zbx_interface_availability_t *availability, zbx_uint64_t hostid);
void	zbx_interface_availability_clean(zbx_interface_availability_t *ha);
