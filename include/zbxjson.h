...
#define	ZBX_PROTO_VALUE_MYSQL_SCHEMA		"mysql schema"
#define	ZBX_PROTO_VALUE_POSTGRESQL_SCHEMA	"postgresql schema"
#define	ZBX_PROTO_VALUE_ORACLE_SCHEMA		"oracle schema"
#define	ZBX_PROTO_VALUE_SQLITE3_SCHEMA		"sqlite3 schema"
#ifdef HAVE_MYSQL
#define ZBX_PROTO_VALUE_DB_SCHEMA ZBX_PROTO_VALUE_MYSQL_SCHEMA
#elif HAVE_POSTGRESQL
#define ZBX_PROTO_VALUE_DB_SCHEMA ZBX_PROTO_VALUE_POSTGRESQL_SCHEMA
#elif HAVE_ORACLE
#define ZBX_PROTO_VALUE_DB_SCHEMA ZBX_PROTO_VALUE_ORACLE_SCHEMA
#elif HAVE_SQLITE3
#define ZBX_PROTO_VALUE_DB_SCHEMA ZBX_PROTO_VALUE_SQLITE3_SCHEMA
#endif /* HAVE_SQLITE3 */
