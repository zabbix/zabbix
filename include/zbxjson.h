...
#define	ZBX_PROTO_VALUE_PROXY_MYSQL_DB		"mysql tables"
#define	ZBX_PROTO_VALUE_PROXY_POSTGRESQL_DB	"postgresql tables"
#define	ZBX_PROTO_VALUE_PROXY_ORACLE_DB		"oracle tables"
#define	ZBX_PROTO_VALUE_PROXY_SQLITE3_DB	"sqlite3 tables"
#ifdef HAVE_MYSQL
#define ZBX_PROTO_VALUE_PROXY_DB ZBX_PROTO_VALUE_PROXY_MYSQL_DB
#elif HAVE_POSTGRESQL
#define ZBX_PROTO_VALUE_PROXY_DB ZBX_PROTO_VALUE_PROXY_POSTGRESQL_DB
#elif HAVE_ORACLE
#define ZBX_PROTO_VALUE_PROXY_DB ZBX_PROTO_VALUE_PROXY_ORACLE_DB
#elif HAVE_SQLITE3
#define ZBX_PROTO_VALUE_PROXY_DB ZBX_PROTO_VALUE_PROXY_SQLITE3_DB
#endif /* HAVE_SQLITE3 */
