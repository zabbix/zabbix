...
#define ZBX_EVAL_PARSE_LLD_FILTER_EXPRESSION	(ZBX_EVAL_PARSE_LOGIC | ZBX_EVAL_PARSE_FUNCTIONID |\
						ZBX_EVAL_PARSE_GROUP)

#define ZBX_EVAL_PARSE_TQ_FILTER_EXPRESSION	(ZBX_EVAL_PARSE_LOGIC | ZBX_EVAL_PARSE_FUNCTIONID |\
						ZBX_EVAL_PARSE_GROUP)
