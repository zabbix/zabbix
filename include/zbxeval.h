...
#define ZBX_EVAL_PARSE_COMPARE		(__UINT64_C(0x00000200) | ZBX_EVAL_PARSE_COMPARE_EQ)	/* <, <=, >, >= */
...
#define ZBX_EVAL_PARSE_FUNCTION		(__UINT64_C(0x00004000) | ZBX_EVAL_PARSE_GROUP)
#define ZBX_EVAL_PARSE_PROP_TAG		__UINT64_C(0x00008000)	/* 'tag' keyword in item query filter */
#define ZBX_EVAL_PARSE_PROP_GROUP	__UINT64_C(0x00010000)	/* 'group' keyword in item query filter */
