...
int	zbx_eval_execute_ext(zbx_eval_context_t *ctx, const zbx_timespec_t *ts, zbx_eval_function_cb_t eval_function_common_cb,
		zbx_eval_function_cb_t eval_function_history_cb, void *data, zbx_variant_t *value, char **error);
