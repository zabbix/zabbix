...
INSERT INTO auditlog (auditid, userid, clock, action, resourcetype, details, ip, resourceid, resourcename) VALUES (700, 1, 1328684860, 1, 2, 'Default theme [originalblue]; Event acknowledges [1]; Show events not older than (in days) [7]; Show events max [100]; Dropdown...', '192.168.3.32', 0, '');
