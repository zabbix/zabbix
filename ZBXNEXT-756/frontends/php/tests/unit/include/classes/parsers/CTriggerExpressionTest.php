...
class CTriggerExpressionTest extends PHPUnit_Framework_TestCase {
	...
	public static function provider() {
		return array(
			...
			array('{host:key.now(0,)}', null, true),
			array('{host:key.percentile()}', null, false),
			array('{host:key.percentile(123)}', null, false),
			array('{host:key.percentile(123,)}', null, false),
			array('{host:key.percentile(123,123)}', null, false),
			array('{host:key.percentile(123,123,12)}', null, true),
			array('{host:key.percentile(123,123,12,)}', null, false),
			array('{host:key.percentile(123,123,12,12)}', null, false),
			array('{host:key.percentile(123s,123s,12)}', null, true),
			array('{host:key.percentile(#123,123,12)}', null, true),
			array('{host:key.percentile(123,#123,12)}', null, false),
			array('{host:key.percentile(,123,12)}', null, false),
			array('{host:key.percentile(123,,12)}', null, true),
			array('{host:key.percentile(123,123,)}', null, false),
			array('{host:key.percentile(0,123,12)}', null, false),
