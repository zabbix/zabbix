...
/******************************************************************************
 *                                                                            *
 * Function: DBadd_groups                                                     *
 *                                                                            *
 * Purpose: add groups to a host if not added already                         *
 *                                                                            *
 * Parameters: hostid   - [IN] host identificator to which groups will be     *
 *                             added                                          *
 *             groupids - [IN] sorted list of host groups which will be added *
 *                             to a host                                      *
 *                                                                            *
 ******************************************************************************/
void	DBadd_groups(zbx_uint64_t hostid, zbx_vector_uint64_t *groupids)
{
	const char	*__function_name = "DBadd_groups";
