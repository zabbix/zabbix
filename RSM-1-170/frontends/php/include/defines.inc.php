...
define('DNS_SERVICE_AVAILABILITY_GRAPH_1',		'DNS Service Availability 1');
...
define('TCP_DNS_RESOLUTION_RTT_TCP_GRAPH_1',	'DNS TCP Resolution RTT 1');
define('TCP_DNS_RESOLUTION_RTT_TCP_GRAPH_2',	'DNS TCP Resolution RTT 2');
define('UDP_DNS_RESOLUTION_RTT_UDP_GRAPH_1',	'DNS UDP Resolution RTT 1');
define('UDP_DNS_RESOLUTION_RTT_UDP_GRAPH_2',	'DNS UDP Resolution RTT 2');
define('DNS_UPDATE_TIME_GRAPH_1',				'DNS update time 1');
define('DNS_UPDATE_TIME_GRAPH_2',				'DNS update time 2');
define('RDDS_AVAILABILITY_GRAPH_1',				'RDDS Availability 1');
define('RDDS_QUERY_RTT_GRAPH_1',				'RDDS Query RTT 1');
define('RDDS_QUERY_RTT_GRAPH_2',				'RDDS Query RTT 2');
define('RDDS_43_QUERY_RTT_GRAPH_1',				'RDDS 43 Query RTT 1');
define('RDDS_43_QUERY_RTT_GRAPH_2',				'RDDS 43 Query RTT 2');
define('RDDS_80_QUERY_RTT_GRAPH_1',				'RDDS 80 Query RTT 1');
define('RDDS_80_QUERY_RTT_GRAPH_2',				'RDDS 80 Query RTT 2');
define('RDDS_UPDATE_TIME_GRAPH_1',				'RDDS Update Time 1');
define('RDDS_UPDATE_TIME_GRAPH_2',				'RDDS Update Time 2');
define('EPP_SERVICE_AVAILABILITY_GRAPH_1',		'EPP Service Availability 1');
define('EPP_SESSION_COMMAND_RTT_GRAPH_1',		'EPP Session-Command RTT 1');
define('EPP_SESSION_COMMAND_RTT_GRAPH_2',		'EPP Session-Command RTT 2');
define('EPP_TRANSFORM_COMMAND_RTT_GRAPH_1',		'EPP Transform-Command RTT 1');
define('EPP_TRANSFORM_COMMAND_RTT_GRAPH_2',		'EPP Transform-Command RTT 2');
define('EPP_QUERY_COMMAND_RTT_GRAPH_1',			'EPP Query-Command RTT 1');
define('EPP_QUERY_COMMAND_RTT_GRAPH_2',			'EPP Query-Command RTT 2');
