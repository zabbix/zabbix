...
// TODO limit tranlations...
if(isset($_GET['lang']) && $_GET['lang'] != 'en_gb'){
...
$tranStrings = array(
	...
	'functions.js' => array('DO_YOU_REPLACE_CONDITIONAL_EXPRESSION_Q', 'S_INSERT_MACRO', 'S_ADD_SERVICE',
		'S_EDIT_SERVICE', 'S_DELETE_SERVICE', 'S_DELETE_SELECTED_SERVICES_Q'
	),
	
);


$files = array('prototype.js', 'common.js', 'class.cdate.js', 'class.cookie.js', 'class.curl.js',
	'main.js', 'functions.js');
if(isset($_GET['files'])){
	$files = array_merge($files, $_GET['files']);
}
