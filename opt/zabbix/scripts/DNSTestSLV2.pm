...
our @EXPORT = qw($zabbix $result $dbh $tld %OPTS
		...
		zapi_connect get_macro_minns get_macro_dns_probe_online
		get_macro_rdds_probe_online get_macro_dns_rollweek_sla get_macro_rdds_rollweek_sla
		get_macro_dns_udp_rtt get_macro_dns_tcp_rtt get_macro_rdds_rtt
