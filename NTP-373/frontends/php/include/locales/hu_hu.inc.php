...
**
** Translation zabbix version: 1.4.2
** Translation version       : 0.2
** Translation date (last)   : 2007.10.01
** Translated by             : Tilla <tilla@canet.hu>
** Translation status	     : partial (Sorry) 
**/
?>
<?php
	global $TRANSLATION;
	...
	"S_DISABLE_SELECTED"=>			"A kiválasztott kikapcsolása",
	"S_DELETE_SELECTED"=>			"A kiválasztott törlése",
...
//	dicoveryconf.php
	...
	"S_CREATE_RULE"=>			"Szabály készítése",
...
//	alarms.php
	...
	"S_ALARMS_BIG"=>			"ALARMS",
	"S_SHOW_ONLY_LAST_100"=>		"Mutasd az utolsó 100-at",
...
//	actions.php
	...
	"S_SHOW_NEXT_100"=>			"Következő 100",
	"S_SHOW_PREVIOUS_100"=>			"Előző 100",
...
// Colors
	...
	"S_BLUE"=>				"Kék",
	"S_CYAN"=>				"Cián",
	"S_DARK_BLUE"=>				"Sötétkék",
	"S_DARK_GREEN"=>			"Sötétzöld",
	"S_DARK_RED"=>				"Sötétpiros",
	"S_DARK_YELLOW"=>			"Sötétsárga",
	"S_GREEN"=>				"Zöld",
	"S_RED"=>				"Piros",
	"S_WHITE"=>				"Fehér",
	"S_YELLOW"=>				"Sárga",
...
//	Latest values
	...
	"S_DESCRIPTION_LARGE"=>			"LEIRÁS",
	"S_DESCRIPTION_SMALL"=>			"Leirás",
	"S_GRAPH"=>				"Grafikon",
	"S_TREND"=>				"Trend",
	"S_COMPARE"=>				"Compare",
...
//	latest.php
	...
	"S_LAST_CHECK_BIG"=>			"ELLENÖRZÉS IDEJE",
...
//	media.php
	...
	"S_MEDIA_BIG"=>				"ÉRTESÍTÉSI MÓD",
	"S_MEDIA_ACTIVATED"=>			"Értesítési mód aktíválva",
	"S_CANNOT_ACTIVATE_MEDIA"=>		"Nem lehet aktíválni ezt az értesítési módot",
	"S_MEDIA_DISABLED"=>			"Értesítési mód tiltva",
	"S_CANNOT_DISABLE_MEDIA"=>		"Nem lehet tiltani ezt az értesítési módot",
	"S_MEDIA_ADDED"=>			"Értesítési mód rögzítve",
	...
	"S_DELETE_SELECTED_MEDIA_Q"=>		"Töröljük ezt az értesítési módot?",
	"S_CREATE_MEDIA"=>			"Új értesítési mód",
	"S_SAVE"=>				"Mentés",
	"S_CANCEL"=>				"Mégse",
...
//	screenedit.php
	...
	"S_HORISONTAL"=>			"Vízszintes",

	"S_HORISONTAL_ALIGN"=>			"Vízszintes igazítás",
	"S_LEFT"=>				"Balra",
	"S_CENTER"=>				"Középre",
	"S_RIGHT"=>				"Jobbra",
...
//	triggers.php
	...
	"S_DEPENDENCY_ADDED"=>			"Függőség hozzáadva",
...
//	tr_status.php
	...
	"S_NAME_BIG"=>				"NÉV",
	"S_SEVERITY_BIG"=>			"SZIGORÚSÁG",
	"S_LAST_CHANGE_BIG"=>			"AKTUÁLIS VÁLTOZÁS",
...
//	"S_TEMPLATES"=>				"Minták", Duplicated
	...
	"S_PERMISSION"=>			"Engedély",
	"S_RIGHT"=>				"Jobbra",
	"S_RIGHTS"=>				"Jogok",
	"S_NO_RIGHTS_DEFINED"=>			"Nincs jog definiálva",
	"S_RESOURCE_NAME"=>			"Erőforrás neve",
	...
	"S_AUTO_LOGOUT_IN_SEC"=>		"Auto-kiléptetés (másodpercben; sec=>0 - letiltva)",
