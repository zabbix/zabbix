...
|----|-----------|----------|--------|--------------------------------|
|APC Smart-UPS: Battery has an internal error condition|<p>A battery installed has an internal error condition.</p>|`last(/APC Smart-UPS SRT 5000 by SNMP/battery.status[upsBasicBatteryStatus])=4`|Average||
|APC Smart-UPS: Battery is Low|<p>The UPS will be unable to sustain the current load, and its services will be lost if power is not restored.</p>|`last(/APC Smart-UPS SRT 5000 by SNMP/battery.status[upsBasicBatteryStatus])=3`|Average||
|APC Smart-UPS: Battery has low capacity||`last(/APC Smart-UPS SRT 5000 by SNMP/battery.capacity[upsHighPrecBatteryCapacity]) < {$BATTERY.CAPACITY.MIN.WARN}`|High||
|APC Smart-UPS: Battery needs replacement|<p>A battery installed has an internal error condition.</p>|`last(/APC Smart-UPS SRT 5000 by SNMP/battery.replace_indicator[upsAdvBatteryReplaceIndicator])=2`|High||
|APC Smart-UPS: Battery has high temperature||`min(/APC Smart-UPS SRT 5000 by SNMP/battery.temperature[upsHighPrecBatteryTemperature],{$TIME.PERIOD}) > {$BATTERY.TEMP.MAX.WARN}`|High||
...
|APC Smart-UPS: Output load is high|<p>A battery installed has an internal error condition.</p>|`min(/APC Smart-UPS SRT 5000 by SNMP/output.load[upsHighPrecOutputLoad],{$TIME.PERIOD}) > {$UPS.OUTPUT.MAX.WARN}`|High||
|APC Smart-UPS: UPS is Timed Sleeping||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=5`|Average||
|APC Smart-UPS: UPS is Switched Bypass||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=9`|Average||
|APC Smart-UPS: UPS is Software Bypass||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=6`|Average||
|APC Smart-UPS: UPS is Sleeping Until Power Return||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=11`|Average||
|APC Smart-UPS: UPS is Rebooting||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=8`|Average||
|APC Smart-UPS: UPS is On Smart Trim||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=12`|Average||
|APC Smart-UPS: UPS is on Smart Boost||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=4`|Average||
|APC Smart-UPS: UPS is on battery||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=3`|Average||
|APC Smart-UPS: UPS is Off||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=7`|Average||
|APC Smart-UPS: UPS is Emergency Static Bypass||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=16`|Average||
|APC Smart-UPS: UPS is Hardware Failure Bypass||`last(/APC Smart-UPS SRT 5000 by SNMP/output.status[upsBasicOutputStatus])=10`|Average||
|APC Smart-UPS: Host has been restarted|<p>The uptime counter has decreased, which indicates that the host has been restarted.<br>A decrease is ignored if the previous value was close enough to the 32-bit SNMP counter limit (2^32 hundredths of a second, about 497 days) for the counter to have wrapped between the two readings.<br>The problem is resolved automatically once uptime exceeds {$SNMP.UPTIME.WARN}.</p>|`(last(/APC Smart-UPS SRT 5000 by SNMP/system.hw.uptime[hrSystemUptime.0])>0 and change(/APC Smart-UPS SRT 5000 by SNMP/system.hw.uptime[hrSystemUptime.0])<0 and last(/APC Smart-UPS SRT 5000 by SNMP/system.hw.uptime[hrSystemUptime.0],#2)<42949672.96-(lastclock(/APC Smart-UPS SRT 5000 by SNMP/system.hw.uptime[hrSystemUptime.0])-lastclock(/APC Smart-UPS SRT 5000 by SNMP/system.hw.uptime[hrSystemUptime.0],#2))) or (last(/APC Smart-UPS SRT 5000 by SNMP/system.hw.uptime[hrSystemUptime.0])=0 and change(/APC Smart-UPS SRT 5000 by SNMP/system.net.uptime[sysUpTime.0])<0 and last(/APC Smart-UPS SRT 5000 by SNMP/system.net.uptime[sysUpTime.0],#2)<42949672.96-(lastclock(/APC Smart-UPS SRT 5000 by SNMP/system.net.uptime[sysUpTime.0])-lastclock(/APC Smart-UPS SRT 5000 by SNMP/system.net.uptime[sysUpTime.0],#2)))`|Warning|**Manual close**: Yes<br>**Depends on**:<br><ul><li>APC Smart-UPS: No SNMP data collection</li></ul>|
...
|APC Smart-UPS: No SNMP data collection|<p>SNMP is not available for polling. Please check device connectivity and SNMP settings.</p>|`max(/APC Smart-UPS SRT 5000 by SNMP/zabbix[host,snmp,available],{$SNMP.TIMEOUT})=0`|Warning||
...
|APC Smart-UPS: {#BATTERY_PACK}.{#CARTRIDGE_INDEX}: Battery has high temperature||`min(/APC Smart-UPS SRT 5000 by SNMP/battery.temperature[upsHighPrecBatteryPackTemperature.{#BATTERY_PACK}.{#CARTRIDGE_INDEX}],{$TIME.PERIOD}) > {$BATTERY.TEMP.MAX.WARN}`|High||
...
|Name|Description|Expression|Severity|Dependencies and additional info|
|----|-----------|----------|--------|--------------------------------|
|APC Smart-UPS: {#EXTERNAL_SENSOR1_NAME}: Sensor has status Not Applicable|<p>The external sensor does not work or is not connected.</p>|`last(/APC Smart-UPS SRT 5000 by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.1.{#SNMPINDEX}])=4`|Info||
|APC Smart-UPS: {#EXTERNAL_SENSOR1_NAME}: Sensor has status Warning|<p>The external sensor has returned a value greater than the warning threshold.</p>|`last(/APC Smart-UPS SRT 5000 by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.1.{#SNMPINDEX}])=2`|Average||
|APC Smart-UPS: {#EXTERNAL_SENSOR1_NAME}: Sensor has status Critical|<p>The external sensor has returned a value greater than the critical threshold.</p>|`last(/APC Smart-UPS SRT 5000 by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.1.{#SNMPINDEX}])=3`|High||
...
|Name|Description|Expression|Severity|Dependencies and additional info|
|----|-----------|----------|--------|--------------------------------|
|APC Smart-UPS: {#EXTERNAL_SENSOR2_NAME}: Sensor has status Not Applicable|<p>The external sensor does not work or is not connected.</p>|`last(/APC Smart-UPS SRT 5000 by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.2.{#SNMPINDEX}])=4`|Info||
|APC Smart-UPS: {#EXTERNAL_SENSOR2_NAME}: Sensor has status Warning|<p>The external sensor has returned a value greater than the warning threshold.</p>|`last(/APC Smart-UPS SRT 5000 by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.2.{#SNMPINDEX}])=2`|Average||
|APC Smart-UPS: {#EXTERNAL_SENSOR2_NAME}: Sensor has status Critical|<p>The external sensor has returned a value greater than the critical threshold.</p>|`last(/APC Smart-UPS SRT 5000 by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.2.{#SNMPINDEX}])=3`|High||
