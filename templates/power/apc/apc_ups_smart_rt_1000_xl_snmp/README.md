...
|----|-----------|----------|--------|--------------------------------|
|APC Smart-UPS: Battery has an internal error condition|<p>A battery installed has an internal error condition.</p>|`last(/APC Smart-UPS RT 1000 XL by SNMP/battery.status[upsBasicBatteryStatus])=4`|Average||
|APC Smart-UPS: Battery is Low|<p>The UPS will be unable to sustain the current load, and its services will be lost if power is not restored.</p>|`last(/APC Smart-UPS RT 1000 XL by SNMP/battery.status[upsBasicBatteryStatus])=3`|Average||
|APC Smart-UPS: Battery has low capacity||`last(/APC Smart-UPS RT 1000 XL by SNMP/battery.capacity[upsHighPrecBatteryCapacity]) < {$BATTERY.CAPACITY.MIN.WARN}`|High||
|APC Smart-UPS: Battery needs replacement|<p>A battery installed has an internal error condition.</p>|`last(/APC Smart-UPS RT 1000 XL by SNMP/battery.replace_indicator[upsAdvBatteryReplaceIndicator])=2`|High||
|APC Smart-UPS: Battery has high temperature||`min(/APC Smart-UPS RT 1000 XL by SNMP/battery.temperature[upsHighPrecBatteryTemperature],{$TIME.PERIOD}) > {$BATTERY.TEMP.MAX.WARN}`|High||
...
|APC Smart-UPS: Output load is high|<p>A battery installed has an internal error condition.</p>|`min(/APC Smart-UPS RT 1000 XL by SNMP/output.load[upsHighPrecOutputLoad],{$TIME.PERIOD}) > {$UPS.OUTPUT.MAX.WARN}`|High||
|APC Smart-UPS: UPS is Timed Sleeping||`last(/APC Smart-UPS RT 1000 XL by SNMP/output.status[upsBasicOutputStatus])=5`|Average||
|APC Smart-UPS: UPS is Switched Bypass||`last(/APC Smart-UPS RT 1000 XL by SNMP/output.status[upsBasicOutputStatus])=9`|Average||
|APC Smart-UPS: UPS is Software Bypass||`last(/APC Smart-UPS RT 1000 XL by SNMP/output.status[upsBasicOutputStatus])=6`|Average||
|APC Smart-UPS: UPS is Sleeping Until Power Return||`last(/APC Smart-UPS RT 1000 XL by SNMP/output.status[upsBasicOutputStatus])=11`|Average||
|APC Smart-UPS: UPS is Rebooting||`last(/APC Smart-UPS RT 1000 XL by SNMP/output.status[upsBasicOutputStatus])=8`|Average||
|APC Smart-UPS: UPS is On Smart Trim||`last(/APC Smart-UPS RT 1000 XL by SNMP/output.status[upsBasicOutputStatus])=12`|Average||
|APC Smart-UPS: UPS is on Smart Boost||`last(/APC Smart-UPS RT 1000 XL by SNMP/output.status[upsBasicOutputStatus])=4`|Average||
|APC Smart-UPS: UPS is on battery||`last(/APC Smart-UPS RT 1000 XL by SNMP/output.status[upsBasicOutputStatus])=3`|Average||
...
|APC Smart-UPS: {#BATTERY_PACK}.{#CARTRIDGE_INDEX}: Battery has high temperature||`min(/APC Smart-UPS RT 1000 XL by SNMP/battery.temperature[upsHighPrecBatteryPackTemperature.{#BATTERY_PACK}.{#CARTRIDGE_INDEX}],{$TIME.PERIOD}) > {$BATTERY.TEMP.MAX.WARN}`|High||
...
|Name|Description|Expression|Severity|Dependencies and additional info|
|----|-----------|----------|--------|--------------------------------|
|APC Smart-UPS: {#EXTERNAL_SENSOR1_NAME}: Sensor has status Not Applicable|<p>The external sensor does not work or is not connected.</p>|`last(/APC Smart-UPS RT 1000 XL by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.1.{#SNMPINDEX}])=4`|Info||
|APC Smart-UPS: {#EXTERNAL_SENSOR1_NAME}: Sensor has status Warning|<p>The external sensor has returned a value greater than the warning threshold.</p>|`last(/APC Smart-UPS RT 1000 XL by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.1.{#SNMPINDEX}])=2`|Average||
|APC Smart-UPS: {#EXTERNAL_SENSOR1_NAME}: Sensor has status Critical|<p>The external sensor has returned a value greater than the critical threshold.</p>|`last(/APC Smart-UPS RT 1000 XL by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.1.{#SNMPINDEX}])=3`|High||
...
|Name|Description|Expression|Severity|Dependencies and additional info|
|----|-----------|----------|--------|--------------------------------|
|APC Smart-UPS: {#EXTERNAL_SENSOR2_NAME}: Sensor has status Not Applicable|<p>The external sensor does not work or is not connected.</p>|`last(/APC Smart-UPS RT 1000 XL by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.2.{#SNMPINDEX}])=4`|Info||
|APC Smart-UPS: {#EXTERNAL_SENSOR2_NAME}: Sensor has status Warning|<p>The external sensor has returned a value greater than the warning threshold.</p>|`last(/APC Smart-UPS RT 1000 XL by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.2.{#SNMPINDEX}])=2`|Average||
|APC Smart-UPS: {#EXTERNAL_SENSOR2_NAME}: Sensor has status Critical|<p>The external sensor has returned a value greater than the critical threshold.</p>|`last(/APC Smart-UPS RT 1000 XL by SNMP/external.sensor.status[uioSensorStatusAlarmStatus.2.{#SNMPINDEX}])=3`|High||
