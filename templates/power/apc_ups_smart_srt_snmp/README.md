...
# APC Smart-UPS SRT SNMP

## Overview

For Zabbix version: 5.0 and higher  
The template to monitor APC Smart-UPS SRT by Zabbix SNMP agent.
...
1\. Create a host for APC Smart-UPS SRT management IP as SNMPv2 interface.
