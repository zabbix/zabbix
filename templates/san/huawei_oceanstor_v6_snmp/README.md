...
|Huawei OceanStor V6: High ICMP ping loss|<p>ICMP packets loss detected.</p>|`min(/Huawei OceanStor V6 by SNMP/icmppingloss,5m)>{$ICMP_LOSS_WARN} and min(/Huawei OceanStor V6 by SNMP/icmppingloss,5m)<100`|Warning|**Depends on**:<br><ul><li>Huawei OceanStor V6: Unavailable by ICMP ping</li></ul>|
