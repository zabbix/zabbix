...
|Huawei OceanStor V6: Uptime (network)|<p>MIB: SNMPv2-MIB</p><p>The time (in hundredths of a second) since the network management portion of the system was last re-initialized.</p>|SNMP agent|system.net.uptime[sysUpTime.0]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `0.01`</p></li></ul>|
|Huawei OceanStor V6: Uptime (hardware)|<p>MIB: HOST-RESOURCES-MIB</p><p>The amount of time since this host was last initialized. Note that this is different from sysUpTime in the SNMPv2-MIB [RFC1907] because sysUpTime is the uptime of the network management portion of the system.</p>|SNMP agent|system.hw.uptime[hrSystemUptime.0]<p>**Preprocessing**</p><ul><li><p>Check for not supported value</p><p>⛔️Custom on fail: Set value to: `0`</p></li><li><p>Custom multiplier: `0.01`</p></li></ul>|
|Huawei OceanStor V6: SNMP traps (fallback)|<p>The item is used to collect all SNMP traps unmatched by other snmptrap items</p>|SNMP trap|snmptrap.fallback|
|Huawei OceanStor V6: System location|<p>MIB: SNMPv2-MIB</p><p>The physical location of this node (e.g., `telephone closet, 3rd floor').  If the location is unknown, the value is the zero-length string.</p>|SNMP agent|system.location[sysLocation.0]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `12h`</p></li></ul>|
|Huawei OceanStor V6: System contact details|<p>MIB: SNMPv2-MIB</p><p>The textual identification of the contact person for this managed node, together with information on how to contact this person.  If no contact information is known, the value is the zero-length string.</p>|SNMP agent|system.contact[sysContact.0]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `12h`</p></li></ul>|
|Huawei OceanStor V6: System object ID|<p>MIB: SNMPv2-MIB</p><p>The vendor's authoritative identification of the network management subsystem contained in the entity.  This value is allocated within the SMI enterprises subtree (1.3.6.1.4.1) and provides an easy and unambiguous means for determining`what kind of box' is being managed.  For example, if vendor`Flintstones, Inc.' was assigned the subtree1.3.6.1.4.1.4242, it could assign the identifier 1.3.6.1.4.1.4242.1.1 to its `Fred Router'.</p>|SNMP agent|system.objectid[sysObjectID.0]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `12h`</p></li></ul>|
|Huawei OceanStor V6: System name|<p>MIB: SNMPv2-MIB</p><p>An administratively-assigned name for this managed node.By convention, this is the node's fully-qualified domain name.  If the name is unknown, the value is the zero-length string.</p>|SNMP agent|system.name<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `12h`</p></li></ul>|
|Huawei OceanStor V6: System description|<p>MIB: SNMPv2-MIB</p><p>A textual description of the entity. This value should</p><p>include the full name and version identification of the system's hardware type, software operating-system, and</p><p>networking software.</p>|SNMP agent|system.descr[sysDescr.0]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `12h`</p></li></ul>|
|Huawei OceanStor V6: SNMP agent availability|<p>Availability of SNMP checks on the host. The value of this item corresponds to availability icons in the host list.</p><p>Possible value:</p><p>0 - not available</p><p>1 - available</p><p>2 - unknown</p>|Zabbix internal|zabbix[host,snmp,available]|
|Huawei OceanStor V6: ICMP ping||Simple check|icmpping|
|Huawei OceanStor V6: ICMP loss||Simple check|icmppingloss|
|Huawei OceanStor V6: ICMP response time||Simple check|icmppingsec|
...
|Huawei OceanStor V6: High ICMP ping response time||`avg(/Huawei OceanStor V6 by SNMP/icmppingsec,5m)>{$ICMP_RESPONSE_TIME_WARN}`|Warning|**Depends on**:<br><ul><li>Huawei OceanStor V6: High ICMP ping loss</li><li>Huawei OceanStor V6: Unavailable by ICMP ping</li></ul>|
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Huawei OceanStor V6: Enclosure [{#NAME}]: Health status|<p>Enclosure health status.</p>|SNMP agent|huawei.oceanstor.v6.enclosure.health_status["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `6h`</p></li></ul>|
|Huawei OceanStor V6: Enclosure [{#NAME}]: Running status|<p>Enclosure running status.</p>|SNMP agent|huawei.oceanstor.v6.enclosure.running_status["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `6h`</p></li></ul>|
|Huawei OceanStor V6: Enclosure [{#NAME}]: Temperature|<p>Enclosure temperature.</p>|SNMP agent|huawei.oceanstor.v6.enclosure.temperature["{#NAME}"]|
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Huawei OceanStor V6: BBU [{#ID}] on [{#LOCATION}]: Health status|<p>Health status of a BBU.</p>|SNMP agent|huawei.oceanstor.v6.bbu.health_status["{#ID}:{#LOCATION}"]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `6h`</p></li></ul>|
|Huawei OceanStor V6: BBU [{#ID}] on [{#LOCATION}]: Running status|<p>Running status of a BBU.</p>|SNMP agent|huawei.oceanstor.v6.bbu.running_status["{#ID}:{#LOCATION}"]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `6h`</p></li></ul>|
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Huawei OceanStor V6: Disk [{#MODEL}] on [{#LOCATION}]: Health status|<p>Disk health status.</p>|SNMP agent|huawei.oceanstor.v6.disk.health_status["{#ID}"]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `6h`</p></li></ul>|
|Huawei OceanStor V6: Disk [{#MODEL}] on [{#LOCATION}]: Running status|<p>Disk running status.</p>|SNMP agent|huawei.oceanstor.v6.disk.running_status["{#ID}"]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `6h`</p></li></ul>|
|Huawei OceanStor V6: Disk [{#MODEL}] on [{#LOCATION}]: Temperature|<p>Disk temperature.</p>|SNMP agent|huawei.oceanstor.v6.disk.temperature["{#ID}"]|
...
|Huawei OceanStor V6: Node [{#NODE}]: Total traffic per second|<p>Total bandwidth for the node.</p>|SNMP agent|huawei.oceanstor.v6.node.bps.total["{#NODE}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1048576`</p></li></ul>|
|Huawei OceanStor V6: Node [{#NODE}]: Read traffic per second|<p>Read bandwidth for the node.</p>|SNMP agent|huawei.oceanstor.v6.node.bps.read["{#NODE}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1048576`</p></li></ul>|
|Huawei OceanStor V6: Node [{#NODE}]: Write traffic per second|<p>Write bandwidth for the node.</p>|SNMP agent|huawei.oceanstor.v6.node.bps.write["{#NODE}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1048576`</p></li></ul>|
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Huawei OceanStor V6: LUN [{#NAME}]: Status|<p>Status of the LUN.</p>|SNMP agent|huawei.oceanstor.v6.lun.status["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `6h`</p></li></ul>|
|Huawei OceanStor V6: LUN [{#NAME}]: Average total I/O latency|<p>Average I/O latency of the node.</p>|SNMP agent|huawei.oceanstor.v6.lun.latency.total["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1e-06`</p></li></ul>|
|Huawei OceanStor V6: LUN [{#NAME}]: Average read I/O latency|<p>Average read I/O response time.</p>|SNMP agent|huawei.oceanstor.v6.lun.latency.read["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1e-06`</p></li></ul>|
|Huawei OceanStor V6: LUN [{#NAME}]: Average write I/O latency|<p>Average write I/O response time.</p>|SNMP agent|huawei.oceanstor.v6.lun.latency.write["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1e-06`</p></li></ul>|
|Huawei OceanStor V6: LUN [{#NAME}]: Total I/O per second|<p>Current IOPS of the LUN.</p>|SNMP agent|huawei.oceanstor.v6.lun.iops.total["{#NAME}"]|
|Huawei OceanStor V6: LUN [{#NAME}]: Read operations per second|<p>Read IOPS of the node.</p>|SNMP agent|huawei.oceanstor.v6.lun.iops.read["{#NAME}"]|
|Huawei OceanStor V6: LUN [{#NAME}]: Write operations per second|<p>Write IOPS of the node.</p>|SNMP agent|huawei.oceanstor.v6.lun.iops.write["{#NAME}"]|
|Huawei OceanStor V6: LUN [{#NAME}]: Total traffic per second|<p>Current total bandwidth for the LUN.</p>|SNMP agent|huawei.oceanstor.v6.lun.bps.total["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1048576`</p></li></ul>|
|Huawei OceanStor V6: LUN [{#NAME}]: Read traffic per second|<p>Current read bandwidth for the LUN.</p>|SNMP agent|huawei.oceanstor.v6.lun.bps.read["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1048576`</p></li></ul>|
|Huawei OceanStor V6: LUN [{#NAME}]: Write traffic per second|<p>Current write bandwidth for the LUN.</p>|SNMP agent|huawei.oceanstor.v6.lun.bps.write["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1048576`</p></li></ul>|
|Huawei OceanStor V6: LUN [{#NAME}]: Capacity|<p>Capacity of the LUN.</p>|SNMP agent|huawei.oceanstor.v6.lun.capacity["{#NAME}"]<p>**Preprocessing**</p><ul><li><p>Custom multiplier: `1024`</p></li><li><p>Discard unchanged with heartbeat: `6h`</p></li></ul>|
