...
|-----|----|-----------|----|---------------------|
|HPE |Get system |<p>Get data about system.</p> |DEPENDENT |hpe.msa.system.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.system[0]`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get FRU |<p>Get data about FRU.</p> |DEPENDENT |hpe.msa.fru.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['frus']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get fans |<p>Get data about fans.</p> |DEPENDENT |hpe.msa.fans.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['fans']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get disks |<p>Get data about disks.</p> |DEPENDENT |hpe.msa.disks.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['disks']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get enclosures |<p>Get data about enclosures.</p> |DEPENDENT |hpe.msa.enclosures.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['enclosures']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get ports |<p>Get data about ports.</p> |DEPENDENT |hpe.msa.ports.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['ports']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get power supplies |<p>Get data about power supplies.</p> |DEPENDENT |hpe.msa.power_supplies.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['power-supplies']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get pools |<p>Get data about pools.</p> |DEPENDENT |hpe.msa.pools.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['pools']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get controllers |<p>Get data about controllers.</p> |DEPENDENT |hpe.msa.controllers.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['controllers']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get controller statistics |<p>Get data about controllers statistics.</p> |DEPENDENT |hpe.msa.controller_statistics.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['controller-statistics']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get disk groups |<p>Get data about disk groups.</p> |DEPENDENT |hpe.msa.disks.groups.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['disk-groups']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get disk group statistics |<p>Get data about disk groups statistics.</p> |DEPENDENT |hpe.msa.disks.groups.statistics.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['disk-group-statistics']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get volumes |<p>Get data about volumes.</p> |DEPENDENT |hpe.msa.volumes.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['volumes']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
|HPE |Get volume statistics |<p>Get data about volumes statistics.</p> |DEPENDENT |hpe.msa.volumes.statistics.get<p>**Preprocessing**:</p><p>- JSONPATH: `$.['volume-statistics']`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
...
|HPE |Controller [{#CONTROLLER.ID}]: Get data |<p>Get discovered controller data.</p> |DEPENDENT |hpe.msa.controllers["{#CONTROLLER.ID}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$.[?(@['durable-id'] == "{#DURABLE.ID}")].first()`</p> |
|HPE |Controller [{#CONTROLLER.ID}]: Get statistics data |<p>Get discovered controller statistics data.</p> |DEPENDENT |hpe.msa.controller_statistics["{#CONTROLLER.ID}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$.[?(@['durable-id'] == "{#DURABLE.ID}")].first()`</p> |
...
|HPE |Disk group [{#NAME}]: Get data |<p>Get discovered disk group data.</p> |DEPENDENT |hpe.msa.disks.groups["{#NAME}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$.[?(@['name'] == "{#NAME}")].first()`</p> |
|HPE |Disk group [{#NAME}]: Get statistics data |<p>Get discovered disk group statistics data.</p> |DEPENDENT |hpe.msa.disks.groups.statistics["{#NAME}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$.[?(@['name'] == "{#NAME}")].first()`</p> |
...
|HPE |Pool [{#NAME}]: Get data |<p>Get discovered pool data.</p> |DEPENDENT |hpe.msa.pools["{#NAME}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@['name'] == "{#NAME}")].first()`</p> |
...
|HPE |Volume [{#NAME}]: Get data |<p>Get discovered volume data.</p> |DEPENDENT |hpe.msa.volumes["{#NAME}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$.[?(@['volume-name'] == "{#NAME}")].first()`</p> |
|HPE |Volume [{#NAME}]: Get statistics data |<p>Get discovered volume statistics data.</p> |DEPENDENT |hpe.msa.volumes.statistics["{#NAME}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$.[?(@['volume-name'] == "{#NAME}")].first()`</p> |
...
|HPE |Enclosure [{#DURABLE.ID}]: Get data |<p>Get discovered enclosure data.</p> |DEPENDENT |hpe.msa.enclosures["{#DURABLE.ID}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@['durable-id'] == "{#DURABLE.ID}")].first()`</p> |
...
|HPE |Power supply [{#DURABLE.ID}]: Get data |<p>Get discovered power supply data.</p> |DEPENDENT |hpe.msa.power_supplies["{#DURABLE.ID}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@['durable-id'] == "{#DURABLE.ID}")].first()`</p> |
...
|HPE |Port [{#NAME}]: Get data |<p>Get discovered port data.</p> |DEPENDENT |hpe.msa.ports["{#NAME}",,data]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@['port'] == "{#NAME}")].first()`</p> |
...
|HPE |Fan [{#DURABLE.ID}]: Get data |<p>Get discovered fan data.</p> |DEPENDENT |hpe.msa.fans["{#DURABLE.ID}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@['durable-id'] == "{#DURABLE.ID}")].first()`</p> |
...
|HPE |Disk [{#DURABLE.ID}]: Get data |<p>Get discovered disk data.</p> |DEPENDENT |hpe.msa.disks["{#DURABLE.ID}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@['durable-id'] == "{#DURABLE.ID}")].first()`</p> |
...
|HPE |FRU [{#ENCLOSURE.ID}: {#LOCATION}]: Get data |<p>Get discovered FRU data.</p> |DEPENDENT |hpe.msa.frus["{#ENCLOSURE.ID}:{#LOCATION}",data]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@['name'] == "{#TYPE}")].first()`</p> |
