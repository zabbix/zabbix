...
Configure a user for monitoring. Note, that in order to retrieve the device certificate information superuser privileges are required. If you prefer to use user with limited access for security reasons, the device certificate expiration metrics will not be discovered.
...
|Get system state|<p>Get the system state information. Used with filter to retrieve CPU utilization metrics.</p>|HTTP agent|pan.pa440.system_state.get<p>**Preprocessing**</p><ul><li>XML to JSON</li></ul>|
...
|Sessions: Supported, total|<p>Total number of sessions supported.</p>|Dependent item|pan.pa440.sessions.supported.total<p>**Preprocessing**</p><ul><li><p>JSON Path: `$.response.result['num-max']`</p></li><li><p>Discard unchanged with heartbeat: `12h`</p></li></ul>|
...
|Sessions: Session table utilization, in %|<p>Session table utilization percentage.</p>|Dependent item|pan.pa440.sessions.table_util<p>**Preprocessing**</p><ul><li><p>JavaScript: `The text is too long. Please see the template.`</p></li></ul>|
...
|CPU temperature|<p>The CPU temperature in Celsius degrees.</p>|Dependent item|pan.pa440.cpu.temp<p>**Preprocessing**</p><ul><li><p>JSON Path: `$.response.result.thermal.Slot1.entry.DegreesC`</p></li></ul>|
...
### LLD rule HA metrics discovery

|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|HA metrics discovery|<p>Discovers high availability metrics.</p>|Dependent item|pan.pa440.ha.discovery<p>**Preprocessing**</p><ul><li><p>JavaScript: `The text is too long. Please see the template.`</p></li><li><p>Discard unchanged with heartbeat: `12h`</p></li></ul>|

### Item prototypes for HA metrics discovery
...
|HA state reason|<p>The reason for the current state of high availability. May be absent in the master item data in some cases, so it is set to an empty string if not found.</p><p></p><p>Information about high availability states:</p><p>https://docs.paloaltonetworks.com/pan-os/11-1/pan-os-admin/high-availability/ha-firewall-states</p>|Dependent item|pan.pa440.ha.local[state_reason{#SINGLETON}]<p>**Preprocessing**</p><ul><li><p>JSON Path: `$.response.result.group['local-info']['state-reason']`</p><p>⛔️Custom on fail: Set value to: ` `</p></li><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
...
|HA configuration synchronization status|<p>The current state of running configuration synchronization.</p>|Dependent item|pan.pa440.ha[config_sync_status{#SINGLETON}]<p>**Preprocessing**</p><ul><li><p>JSON Path: `$.response.result.group['running-sync']`</p></li></ul>|
...
### Trigger prototypes for HA metrics discovery
...
### Trigger prototypes for HA links discovery
...
### LLD rule Hardware network interfaces discovery

|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Hardware network interfaces discovery|<p>Discovers hardware network interfaces.</p>|HTTP agent|pan.pa440.if.hw.discovery<p>**Preprocessing**</p><ul><li>XML to JSON</li><li><p>JavaScript: `The text is too long. Please see the template.`</p></li><li><p>Discard unchanged with heartbeat: `3h`</p></li></ul>|

### Item prototypes for Hardware network interfaces discovery
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Logical network interfaces discovery|<p>Discovers logical network interfaces.</p>|HTTP agent|pan.pa440.if.sw.discovery<p>**Preprocessing**</p><ul><li>XML to JSON</li><li><p>JavaScript: `The text is too long. Please see the template.`</p></li><li><p>Discard unchanged with heartbeat: `3h`</p></li></ul>|

### Item prototypes for Logical network interfaces discovery
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|BGP peers discovery|<p>Discovers BGP peers.</p>|HTTP agent|pan.pa440.bgp.peer.discovery<p>**Preprocessing**</p><ul><li>XML to JSON</li><li><p>JavaScript: `The text is too long. Please see the template.`</p></li><li><p>Discard unchanged with heartbeat: `3h`</p></li></ul>|

### Item prototypes for BGP peers discovery
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|OSPF neighbors discovery|<p>Discovers OSPF neighbors.</p>|Dependent item|pan.pa440.ospf.neighbor.discovery<p>**Preprocessing**</p><ul><li><p>JavaScript: `The text is too long. Please see the template.`</p></li><li><p>Discard unchanged with heartbeat: `3h`</p></li></ul>|

### Item prototypes for OSPF neighbors discovery

|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|OSPF neighbor [{#NEIGHBORADDR}]: Status|<p>The current state of OSPF neighbor.</p>|Dependent item|pan.pa440.ospf.neighbor.status[{#NEIGHBORAREA}, {#NEIGHBORADDR}]<p>**Preprocessing**</p><ul><li><p>JSON Path: `The text is too long. Please see the template.`</p></li></ul>|

### Trigger prototypes for OSPF neighbors discovery
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Licenses discovery|<p>Discovers licenses installed on the device. Only the licenses with expiration date are discovered.</p>|Dependent item|pan.pa440.licenses.discovery<p>**Preprocessing**</p><ul><li><p>JavaScript: `The text is too long. Please see the template.`</p></li><li><p>Discard unchanged with heartbeat: `3h`</p></li></ul>|

### Item prototypes for Licenses discovery
...
|Device certificate: Expires on|<p>The date when the device certificate will expire.</p>|Dependent item|pan.pa440.certificate.device.expires[{#SINGLETON}]<p>**Preprocessing**</p><ul><li><p>JSON Path: `$.response.result['device-certificate']['not_valid_after']`</p></li><li><p>Discard unchanged with heartbeat: `12h`</p></li></ul>|
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Certificates discovery|<p>Discovers certificates on the device. Only the certificates with expiration date are discovered.</p>|Dependent item|pan.pa440.certificates.discovery<p>**Preprocessing**</p><ul><li><p>JavaScript: `The text is too long. Please see the template.`</p></li><li><p>Discard unchanged with heartbeat: `3h`</p></li></ul>|

### Item prototypes for Certificates discovery
...
### Trigger prototypes for Certificates discovery
