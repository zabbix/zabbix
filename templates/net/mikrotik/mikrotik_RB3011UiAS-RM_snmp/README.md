...
|Mikrotik: Device has been replaced|<p>Device serial number has changed. Ack to close</p>|`last(/MikroTik RB3011UiAS-RM by SNMP/system.hw.serialnumber,#1)<>last(/MikroTik RB3011UiAS-RM by SNMP/system.hw.serialnumber,#2) and length(last(/MikroTik RB3011UiAS-RM by SNMP/system.hw.serialnumber))>0`|Info|**Manual close**: Yes|
