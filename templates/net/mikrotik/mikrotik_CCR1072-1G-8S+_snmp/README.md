...
|Mikrotik:  has been replaced|<p> serial number has changed. Ack to close</p>|`last(/MikroTik CCR1072-1G-8S by SNMP/system.hw.serialnumber,#1)<>last(/MikroTik CCR1072-1G-8S by SNMP/system.hw.serialnumber,#2) and length(last(/MikroTik CCR1072-1G-8S by SNMP/system.hw.serialnumber))>0`|Info|**Manual close**: Yes|
