...
|Mikrotik:  has been replaced|<p> serial number has changed. Ack to close</p>|`last(/MikroTik CSS610-8G-2SIN by SNMP/system.hw.serialnumber,#1)<>last(/MikroTik CSS610-8G-2SIN by SNMP/system.hw.serialnumber,#2) and length(last(/MikroTik CSS610-8G-2SIN by SNMP/system.hw.serialnumber))>0`|Info|**Manual close**: Yes|
