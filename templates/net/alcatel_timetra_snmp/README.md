...
|Alcatel TiMOS: High ICMP ping loss||`min(/Alcatel Timetra TiMOS by SNMP/icmppingloss,5m)>{$ICMP_LOSS_WARN} and min(/Alcatel Timetra TiMOS by SNMP/icmppingloss,5m)<100`|Warning|**Depends on**:<br><ul><li>Alcatel TiMOS: Unavailable by ICMP ping</li></ul>|
