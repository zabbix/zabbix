...
|-----|----|-----------|----|---------------------|
|Array |Array: Array Voltage |<p>MIB: TRISTAR</p> |SNMP |array.voltage[arrayloadVoltage.0]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.004246520996`</p> |
...
|Battery |Battery: Charge Current |<p>MIB: TRISTAR</p> |SNMP |charge.current[chargeCurrent.0]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.002034515381`</p> |
|Counter |Counter: Charge Amp-hours |<p>MIB: TRISTAR</p> |SNMP |counter.charge_amp_hours[ahResettable.0] |
