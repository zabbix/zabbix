...
|Intel Qlogic: High ICMP ping loss||`min(/Intel_Qlogic Infiniband by SNMP/icmppingloss,5m)>{$ICMP_LOSS_WARN} and min(/Intel_Qlogic Infiniband by SNMP/icmppingloss,5m)<100`|Warning|**Depends on**:<br><ul><li>Intel Qlogic: Unavailable by ICMP ping</li></ul>|
