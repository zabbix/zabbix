...
|Ciena: High CPU utilization (last 15m)|<p>Average CPU utilization for last 15 minutes exceeded {$CIENA.CPU.UTIL.MAX}%.</p>|`min(/Ciena 3906 by SNMP/ciena.cpu.utilization15m,5m)>{$CIENA.CPU.UTIL.MAX}`|Warning||
