...
|{$CIENA.CPU.UTIL.MAX}|<p>Threshold of CPU utilization expressed in %.</p>|`100`|
...
|Filesystem [/tmp]: Utilization|<p>MIB: WWP-LEOS-SYSTEM-CONFIG-MIB</p><p>Current percentage usage of the /tmp/ directory.</p>|SNMP agent|ciena.tmpfs.util<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
...
|Filesystem [/mnt/sysfs]: Utilization|<p>MIB: WWP-LEOS-SYSTEM-CONFIG-MIB</p><p>Current percentage usage of the /mnt/sysfs/ directory.</p>|SNMP agent|ciena.sysfs.util<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
...
|CPU: Utilization average (15m)|<p>MIB: WWP-LEOS-SYSTEM-CONFIG-MIB</p><p>CPU utilization average for last 15 minutes (value ×100).</p>|SNMP agent|ciena.cpu.utilization15m<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
|CPU: Utilization average minimum (15m)|<p>MIB: WWP-LEOS-SYSTEM-CONFIG-MIB</p><p>Minimum 15 minute CPU utilization average (value ×100).</p>|SNMP agent|ciena.cpu.utilization15m.min<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
|CPU: Utilization average maximum (15m)|<p>MIB: WWP-LEOS-SYSTEM-CONFIG-MIB</p><p>Maximum 15 minute CPU utilization average (value ×100).</p>|SNMP agent|ciena.cpu.utilization15m.max<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
...
|Ciena: High CPU utilization (last 15m)|<p>CPU utilization for last 5 minutes exceeded 100%.</p>|`min(/Ciena 3906 by SNMP/ciena.cpu.utilization15m,5m)>{$CIENA.CPU.UTIL.MAX}`|Warning||
|Ciena: CPU: Utilization state abnormal (15 min)|<p>CPU utilization 15-minute state indicates abnormal or fault condition.</p>|`last(/Ciena 3906 by SNMP/ciena.cpu.utilization15m.state)<>1`|Warning||
