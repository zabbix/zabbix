...
|Filesystem [/tmp]: Utilization|<p>MIB: WWP-LEOS-SYSTEM-CONFIG-MIB</p><p>Current utilization of the /tmp directory.</p>|SNMP agent|ciena.tmpfs.util<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
...
|Filesystem [/mnt/sysfs]: Utilization|<p>MIB: WWP-LEOS-SYSTEM-CONFIG-MIB</p><p>Current utilization of the /mnt/sysfs directory.</p>|SNMP agent|ciena.sysfs.util<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
...
|Ciena: High CPU utilization (last 15m)|<p>Average CPU utilization for the last 15 minutes exceeded '{$CIENA.CPU.UTIL.MAX}%'.</p>|`min(/Ciena 3906 by SNMP/ciena.cpu.utilization15m,5m)>{$CIENA.CPU.UTIL.MAX}`|Warning||
