...
|-----|----|-----------|----|---------------------|
|Array |Array: Array Voltage |<p>MIB: PROSTAR-MPPT</p> |SNMP |array.voltage[arrayVoltage.0] |
|Array |Array: Sweep Vmp |<p>MIB: PROSTAR-MPPT</p> |SNMP |array.sweep_vmp[arrayVmp.0] |
|Array |Array: Sweep Voc |<p>MIB: PROSTAR-MPPT</p> |SNMP |array.sweep_voc[arrayVoc.0] |
|Array |Array: Sweep Pmax |<p>MIB: PROSTAR-MPPT</p> |SNMP |array.sweep_pmax[arrayMaxPowerSweep.0] |
|Battery |Battery: Charge State |<p>MIB: PROSTAR-MPPT</p> |SNMP |charge.state[chargeState.0] |
|Battery |Battery: Battery Voltage |<p>MIB: PROSTAR-MPPT</p> |SNMP |battery.voltage[batteryTerminalVoltage.0] |
|Battery |Battery: Target Voltage |<p>MIB: PROSTAR-MPPT</p> |SNMP |target.voltage[targetVoltage.0] |
|Battery |Battery: Charge Current |<p>MIB: PROSTAR-MPPT</p> |SNMP |charge.current[chargeCurrent.0] |
|Counter |Counter: Charge Amp-hours |<p>MIB: PROSTAR-MPPT</p> |SNMP |counter.charge_amp_hours[ahChargeResettable.0]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.1`</p> |
|Counter |Counter: Charge Amp-hours |<p>MIB: PROSTAR-MPPT</p> |SNMP |counter.charge_kw_hours[kwhChargeResettable.0] |
|Counter |Counter: Load Amp-hours |<p>MIB: PROSTAR-MPPT</p> |SNMP |counter.load_amp_hours[ahLoadResettable.0]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.1`</p> |
|Counter |Counter: Array Faults |<p>MIB: PROSTAR-MPPT</p> |SNMP |counter.array_faults[arrayFaults.0]<p>**Preprocessing**:</p><p>- JAVASCRIPT: `return parseInt(value.replace(/\x20/g, ''), 16);`</p> |
|Counter |Counter: Load Faults |<p>MIB: PROSTAR-MPPT</p> |SNMP |counter.load_faults[loadFaults.0]<p>**Preprocessing**:</p><p>- JAVASCRIPT: `return parseInt(value.replace(/\x20/g, ''), 16);`</p> |
|Counter |Counter: Alarms |<p>MIB: PROSTAR-MPPT</p> |SNMP |counter.alarms[alarms.0]<p>**Preprocessing**:</p><p>- JAVASCRIPT: `return parseInt(value.replace(/\x20/g, ''), 16);`</p> |
|Load |Load: State |<p>MIB: PROSTAR-MPPT</p> |SNMP |load.state[loadState.0] |
|Load |Load: Voltage |<p>MIB: PROSTAR-MPPT</p> |SNMP |load.voltage[loadVoltage.0] |
|Load |Load: Current |<p>MIB: PROSTAR-MPPT</p> |SNMP |load.current[loadCurrent.0] |
|Temperature |Temperature: Ambient |<p>MIB: PROSTAR-MPPT</p> |SNMP |temp.ambient[ambientTemperature.0] |
|Temperature |Temperature: Battery |<p>MIB: PROSTAR-MPPT</p> |SNMP |temp.battery[batteryTemperature.0] |
|Temperature |Temperature: Heatsink |<p>MIB: PROSTAR-MPPT</p> |SNMP |temp.heatsink[heatsinkTemperature.0] |
...
|Counter: Device has fault flags |<p>-</p> |`{TEMPLATE_NAME:counter.array_faults[arrayFaults.0].last()}>0 or {Template Net Morningstar ProStar MPPT SNMP:counter.load_faults[loadFaults.0].last()}>0` |HIGH | |
