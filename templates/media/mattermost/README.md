...
For more information, use the [Zabbix](https://www.zabbix.com/documentation/5.2/manual/config/notifications) and [Mattermost](https://docs.mattermost.com) documentations.
