...
If you use Zabbix 7.0 or higher, SIGNL4 is already available as a media type by default. Otherwise you can get the YAML file (zabbix-signl4.yaml) for Zabbix from Git (https://git.zabbix.com/projects/ZBX/repos/zabbix/browse/templates/media/signl4).
