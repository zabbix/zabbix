...
​
For more information use the [Zabbix](https://www.zabbix.com/documentation/8.0/manual/config/notifications) and [iLert](https://docs.ilert.com/integrations/zabbix/native) documentations.
​
