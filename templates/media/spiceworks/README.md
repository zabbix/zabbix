...
## Setting up Zabbix
1\. Set up an [Email media](https://www.zabbix.com/documentation/5.2/manual/config/notifications/media/email) type if it doesn't exist yet.
...
3\. Configure a [Zabbix action](https://www.zabbix.com/documentation/5.2/manual/config/notifications/action) without recovery and update operations. Since Zabbix doesn't store Spiceworks ticket number, update notifications will result in creating separate tickets instead of updating an existing problem.  
[![](images/thumb.2.png?raw=true)](images/2.png)

See [Zabbix](https://www.zabbix.com/documentation/5.2/manual/config/notifications) documentation for more information.
