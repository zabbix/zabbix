...
|ES {#ES.NODE}: Query latency|<p>The average query latency calculated by sampling the total number of queries and the total elapsed time at regular intervals.</p><p>If the calculated value cannot be evaluated due to missing historical data, the item returns '-1', indicating that there is not enough data to calculate the metric yet.</p>|Calculated|es.node.indices.search.query_latency[{#ES.NODE}]<p>**Preprocessing**</p><ul><li><p>Check for not supported value: `any error`</p><p>⛔️Custom on fail: Set value to: `-1`</p></li></ul>|
...
|ES {#ES.NODE}: Fetch latency|<p>The average fetch latency calculated by sampling the total number of fetches and the total elapsed time at regular intervals.</p><p>If the calculated value cannot be evaluated due to missing historical data, the item returns '-1', indicating that there is not enough data to calculate the metric yet.</p>|Calculated|es.node.indices.search.fetch_latency[{#ES.NODE}]<p>**Preprocessing**</p><ul><li><p>Check for not supported value: `any error`</p><p>⛔️Custom on fail: Set value to: `-1`</p></li></ul>|
...
|ES {#ES.NODE}: Indexing latency|<p>The average indexing latency calculated from the available index_total and index_time_in_millis metrics.</p><p>If the calculated value cannot be evaluated due to missing historical data, the item returns '-1', indicating that there is not enough data to calculate the metric yet.</p>|Calculated|es.node.indices.indexing.index_latency[{#ES.NODE}]<p>**Preprocessing**</p><ul><li><p>Check for not supported value: `any error`</p><p>⛔️Custom on fail: Set value to: `-1`</p></li></ul>|
...
|ES {#ES.NODE}: Flush latency|<p>The average flush latency calculated from the available flush.total and flush.total_time_in_millis metrics.</p><p>If the calculated value cannot be evaluated due to missing historical data, the item returns '-1', indicating that there is not enough data to calculate the metric yet.</p>|Calculated|es.node.indices.flush.latency[{#ES.NODE}]<p>**Preprocessing**</p><ul><li><p>Check for not supported value: `any error`</p><p>⛔️Custom on fail: Set value to: `-1`</p></li></ul>|
