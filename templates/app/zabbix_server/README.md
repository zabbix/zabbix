...
|Zabbix server |Zabbix server: Utilization of connector manager internal processes, in % |<p>The average percentage of the time during which the connector manager processes have been busy for the last minute.</p> |INTERNAL |zabbix[process,connector manager,avg,busy] |
|Zabbix server |Zabbix server: Utilization of connector worker internal processes, in % |<p>The average percentage of the time during which the connector worker processes have been busy for the last minute.</p> |INTERNAL |zabbix[process,connector worker,avg,busy] |
...
|Zabbix server |Zabbix server: Connector queue |<p>The count of values enqueued in the connector queue.</p> |INTERNAL |zabbix[connector_queue] |
