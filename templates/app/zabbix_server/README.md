...
|Zabbix raw items |Zabbix proxies stats |<p>Zabbix proxies statistics master item.</p> |INTERNAL |zabbix[proxy,discovery] |
...
|Zabbix server |Zabbix server: Utilization of connector manager internal processes, in % |<p>Average percentage of time connector manager processes have been busy in the last minute</p> |INTERNAL |zabbix[process,connector manager,avg,busy] |
|Zabbix server |Zabbix server: Utilization of connector worker internal processes, in % |<p>Average percentage of time connector worker processes have been busy in the last minute</p> |INTERNAL |zabbix[process,connector worker,avg,busy] |
...
|Zabbix server |Zabbix server: Connector queue |<p>Count of values enqueued in the connector queue.</p> |INTERNAL |zabbix[connector_queue] |
...
|Zabbix proxy |Proxy [{#PROXY.NAME}]: Stats |<p>Discovered proxy statistics.</p> |DEPENDENT |zabbix.proxy.stats[{#PROXY.NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.[?(@.name=="{#PROXY.NAME}")].first()`</p> |
|Zabbix proxy |Proxy [{#PROXY.NAME}]: Mode |<p>Proxy mode</p> |DEPENDENT |zabbix.proxy.mode[{#PROXY.NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.passive`</p><p>- JAVASCRIPT: `return value === 'false' ? 0 : 1 `</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `12h`</p> |
|Zabbix proxy |Proxy [{#PROXY.NAME}]: Unencrypted |<p>Encryption status for connections from the proxy</p> |DEPENDENT |zabbix.proxy.unencrypted[{#PROXY.NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.unencrypted`</p><p>- JAVASCRIPT: `return value === 'false' ? 0 : 1 `</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `12h`</p> |
|Zabbix proxy |Proxy [{#PROXY.NAME}]: PSK |<p>Encryption status for connections from the proxy</p> |DEPENDENT |zabbix.proxy.psk[{#PROXY.NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.psk`</p><p>- JAVASCRIPT: `return value === 'false' ? 0 : 1 `</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `12h`</p> |
|Zabbix proxy |Proxy [{#PROXY.NAME}]: Certificate |<p>Encryption status for connections from the proxy</p> |DEPENDENT |zabbix.proxy.cert[{#PROXY.NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.cert`</p><p>- JAVASCRIPT: `return value === 'false' ? 0 : 1 `</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `12h`</p> |
|Zabbix proxy |Proxy [{#PROXY.NAME}]: Compression |<p>Compression status</p> |DEPENDENT |zabbix.proxy.compression[{#PROXY.NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.compression`</p><p>- JAVASCRIPT: `return value === 'false' ? 0 : 1 `</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `12h`</p> |
...
|Zabbix proxy |Proxy [{#PROXY.NAME}]: Version |<p>Zabbix proxy version</p> |DEPENDENT |zabbix.proxy.version[{#PROXY.NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.version`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `12h`</p> |
...
|Zabbix proxy |Proxy [{#PROXY.NAME}]: Compatibility |<p>Zabbix proxy compatibility</p> |DEPENDENT |zabbix.proxy.compatibility[{#PROXY.NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.compatibility`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `12h`</p> |
|Zabbix proxy |Proxy [{#PROXY.NAME}]: Required VPS |<p>Required proxy performance (the number of values that need to be collected per second)</p> |DEPENDENT |zabbix.proxy.requiredperformance[{#PROXY.NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.requiredperformance`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `12h`</p> |
...
|Zabbix server: Utilization of connector manager processes is high |<p>-</p> |`avg(/Zabbix server health/zabbix[process,connector manager,avg,busy],10m)>75`<p>Recovery expression:</p>`avg(/Zabbix server health/zabbix[process,connector manager,avg,busy],10m)<65` |AVERAGE | |
|Zabbix server: Utilization of connector worker processes is high |<p>-</p> |`avg(/Zabbix server health/zabbix[process,connector worker,avg,busy],10m)>75`<p>Recovery expression:</p>`avg(/Zabbix server health/zabbix[process,connector worker,avg,busy],10m)<65` |AVERAGE | |
