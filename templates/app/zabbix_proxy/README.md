...
|Zabbix proxy: Utilization of data sender processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,data sender,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,data sender,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of configuration syncer processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,configuration syncer,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,configuration syncer,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of discoverer processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,discoverer,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,discoverer,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of heartbeat sender processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,heartbeat sender,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,heartbeat sender,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of history syncer processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,history syncer,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,history syncer,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of housekeeper processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,housekeeper,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,housekeeper,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of http poller processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,http poller,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,http poller,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of icmp pinger processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,icmp pinger,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,icmp pinger,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of ipmi manager processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,ipmi manager,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,ipmi manager,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of ipmi poller processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,ipmi poller,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,ipmi poller,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of java poller processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,java poller,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,java poller,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of poller processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,poller,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,poller,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of preprocessing worker processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,preprocessing worker,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,preprocessing worker,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of preprocessing manager processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,preprocessing manager,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,preprocessing manager,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of self-monitoring processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,self-monitoring,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,self-monitoring,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of snmp trapper processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,snmp trapper,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,snmp trapper,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of task manager processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,task manager,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,task manager,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of trapper processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,trapper,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,trapper,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of unreachable poller processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,unreachable poller,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,unreachable poller,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
|Zabbix proxy: Utilization of vmware collector processes over {$ZABBIX.PROXY.UTIL.MAX}% |<p>-</p> |`{TEMPLATE_NAME:zabbix[process,vmware collector,avg,busy].avg(10m)}>{$ZABBIX.PROXY.UTIL.MAX}`<p>Recovery expression:</p>`{TEMPLATE_NAME:zabbix[process,vmware collector,avg,busy].avg(10m)}<{$ZABBIX.PROXY.UTIL.MIN}` |AVERAGE | |
