...
|----|-----------|-------|
|{$ACTIVEMQ.BROKER.CONSUMERS.MIN.HIGH} |<p>Minimum amaunt of consumers for broker. Can be used with broker name as context.</p> |`1` |
...
|{$ACTIVEMQ.BROKER.PRODUCERS.MIN.HIGH} |<p>Minimum amaunt of producers for broker. Can be used with broker name as context.</p> |`1` |
...
|{$ACTIVEMQ.DESTINATION.CONSUMERS.MIN.HIGH} |<p>Minimum amaunt of consumers for destination. Can be used with destination name as context.</p> |`1` |
...
|{$ACTIVEMQ.DESTINATION.PRODUCERS.MIN.HIGH} |<p>Minimum amaunt of producers for destination. Can be used with destination name as context.</p> |`1` |
