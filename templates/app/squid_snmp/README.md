...
|Squid |Squid: Cache swap low water mark |<p>Cache Swap Low Water Mark</p> |SNMP |squid.cacheSwapLowWM[cacheSwapLowWM] |
|Squid |Squid: Cache swap high water mark |<p>Cache Swap High Water Mark</p> |SNMP |squid.cacheSwapHighWM[cacheSwapHighWM] |
|Squid |Squid: Cache swap directory size |<p>The total of the cache_dir space allocated in MB</p> |SNMP |squid.cacheSwapMaxSize[cacheSwapMaxSize]<p>**Preprocessing**:</p><p>- MULTIPLIER: `1048576`</p> |
|Squid |Squid: Cache swap current size |<p>Storage Swap Size in MB</p> |SNMP |squid.cacheCurrentSwapSize[cacheCurrentSwapSize]<p>**Preprocessing**:</p><p>- MULTIPLIER: `1048576`</p> |
...
|Squid |Squid: HTTP traffic sent |<p>Number of HTTP KB's sent to clients</p> |SNMP |squid.http.out[cacheHttpOutKb]<p>**Preprocessing**:</p><p>- MULTIPLIER: `1024`</p> |
|Squid |Squid: HTTP requests sent per second |<p>Number of HTTP requests sent per second</p> |DEPENDENT |squid.snmp[cacheHttpOutKbRate]<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND |
|Squid |Squid: HTTP Hits sent from cache |<p>Number of HTTP Hits sent to clients from cache</p> |SNMP |squid.http.cache.hits[cacheHttpHits] |
|Squid |Squid: HTTP Hits sent from cache per second |<p>Number of HTTP Hits sent to clients from cache per second</p> |DEPENDENT |squid.snmp[cacheHttpHitsRate]<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND |
|Squid |Squid: HTTP Errors sent |<p>Number of HTTP Errors sent to clients</p> |SNMP |squid.http.cache.errors[cacheHttpErrors] |
|Squid |Squid: HTTP Errors sent per second |<p>Number of HTTP Errors sent to clients per second</p> |DEPENDENT |squid.snmp[cacheHttpErrorsRate]<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND |
...
|Squid |Squid: DNS server requests |<p>Number of external dns server requests</p> |SNMP |squid.cacheDnsRequests[cacheDnsRequests] |
|Squid |Squid: DNS server replies |<p>Number of external dns server replies</p> |SNMP |squid.cacheDnsReplies[cacheDnsReplies] |
|Squid |Squid: FQDN cache requests |<p>Number of FQDN Cache requests</p> |SNMP |squid.cacheFqdnRequests[cacheFqdnRequests] |
|Squid |Squid: FQDN cache hits |<p>Number of FQDN Cache hits</p> |SNMP |squid.cacheFqdnHits[cacheFqdnHits] |
|Squid |Squid: FQDN cache misses |<p>Number of FQDN Cache misses</p> |SNMP |squid.cacheFqdnMisses[cacheFqdnMisses] |
|Squid |Squid: IP cache requests |<p>Number of IP Cache requests</p> |SNMP |squid.cacheIpRequests[cacheIpRequests] |
|Squid |Squid: IP cache hits |<p>Number of IP Cache hits</p> |SNMP |squid.cacheIpHits[cacheIpHits] |
|Squid |Squid: Ip cache misses |<p>Number of IP Cache misses</p> |SNMP |squid.cacheIpMisses[cacheIpMisses] |
|Squid |Squid: Objects count |<p>Number of objects stored by the cache</p> |SNMP |squid.cacheNumObjCount[cacheNumObjCount] |
|Squid |Squid: Objects LRU expiration age |<p>Storage LRU Expiration Age</p> |SNMP |squid.cacheCurrentLRUExpiration[cacheCurrentLRUExpiration]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.01`</p> |
|Squid |Squid: Objects unlinkd requests |<p>Requests given to unlinkd</p> |SNMP |squid.cacheCurrentUnlinkRequests[cacheCurrentUnlinkRequests] |
|Squid |Squid: HTTP all service time per 5 minute |<p>HTTP all service time per 5 minute</p> |SNMP |squid.cacheHttpAllSvcTime.5[cacheHttpAllSvcTime.5]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: HTTP all service time per hour |<p>HTTP all service time per hour</p> |SNMP |squid.cacheHttpAllSvcTime.60[cacheHttpAllSvcTime.60]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: HTTP miss service time per 5 minute |<p>HTTP miss service time per 5 minute</p> |SNMP |squid.cacheHttpMissSvcTime.5[cacheHttpMissSvcTime.5]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: HTTP miss service time per hour |<p>HTTP miss service time per hour</p> |SNMP |squid.cacheHttpMissSvcTime.60[cacheHttpMissSvcTime.60]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: HTTP miss service time per 5 minute |<p>HTTP hit service time per 5 minute</p> |SNMP |squid.cacheHttpHitSvcTime.5[cacheHttpHitSvcTime.5]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: HTTP hit service time per hour |<p>HTTP hit service time per hour</p> |SNMP |squid.cacheHttpHitSvcTime.60[cacheHttpHitSvcTime.60]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: ICP query service time per 5 minute |<p>ICP query service time per 5 minute</p> |SNMP |squid.cacheIcpQuerySvcTime.5[cacheIcpQuerySvcTime.5]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: ICP query service time per hour |<p>ICP query service time per hour</p> |SNMP |squid.cacheIcpQuerySvcTime.60[cacheIcpQuerySvcTime.60]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: ICP reply service time per 5 minute |<p>ICP reply service time per 5 minute</p> |SNMP |squid.cacheIcpReplySvcTime.5[cacheIcpReplySvcTime.5]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: ICP reply service time per hour |<p>ICP reply service time per hour</p> |SNMP |squid.cacheIcpReplySvcTime.60[cacheIcpReplySvcTime.60]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: DNS service time per 5 minute |<p>DNS service time per 5 minute</p> |SNMP |squid.cacheDnsSvcTime.5[cacheDnsSvcTime.5]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
|Squid |Squid: DNS service time per hour |<p>DNS service time per hour</p> |SNMP |squid.cacheDnsSvcTime.60[cacheDnsSvcTime.60]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p> |
