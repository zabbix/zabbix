...
A template set for monitoring your Kubernetes cluster via Zabbix {{GLOBAL.VERSION}} and higher. Zabbix provides a powerful automated solution for monitoring the Kubernetes cluster components.
