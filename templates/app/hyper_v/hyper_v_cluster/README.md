...
|{$HYPERV.TRIGGER.NODE.MEMORY.UTILIZATION}|<p>Threshold for Hyper-V Cluster Node memory utilization trigger. Support context `{#NODE.NAME}`</p>|`85`|
|{$HYPERV.TRIGGER.NODE.CPU.UTILIZATION}|<p>Threshold for Hyper-V Cluster Node CPU utilization trigger. Support context `{#NODE.NAME}`</p>|`85`|
|{$HYPERV.TRIGGER.CSV.SPACE.UTILIZATION}|<p>Threshold for Hyper-V Cluster CSV space utilization trigger. Support context `{#CSV.NAME}`</p>|`85`|
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Node discovery|<p>Discover Hyper-V Cluster Nodes.</p>|Dependent item|hyperv.cluster.node.discovery<p>**Preprocessing**</p><ul><li><p>JSON Path: `$.Data.Nodes`</p><p>⛔️Custom on fail: Discard value</p></li><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|CSV discovery|<p>Discover Hyper-V Cluster CSVs.</p>|Dependent item|hyperv.cluster.csv.discovery<p>**Preprocessing**</p><ul><li><p>JSON Path: `$.Data.Storage`</p><p>⛔️Custom on fail: Discard value</p></li><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|S2D pools discovery|<p>Discover Hyper-V S2D Pools.</p>|Dependent item|hyperv.s2d.pool.discovery<p>**Preprocessing**</p><ul><li><p>JSON Path: `$.Data.S2D.Pools`</p><p>⛔️Custom on fail: Discard value</p></li><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|

### Item prototypes for S2D pools discovery
...
### Trigger prototypes for S2D pools discovery
...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|S2D physical disks discovery|<p>Discover Hyper-V S2D Physical disks.</p>|Dependent item|hyperv.s2d.disk.discovery<p>**Preprocessing**</p><ul><li><p>JSON Path: `$.Data.S2D.PhysicalDisks`</p><p>⛔️Custom on fail: Discard value</p></li><li><p>Discard unchanged with heartbeat: `1h`</p></li></ul>|

### Item prototypes for S2D physical disks discovery
...
### Trigger prototypes for S2D physical disks discovery
