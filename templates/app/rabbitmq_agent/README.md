...
|RabbitMQ |RabbitMQ: Get process summary |<p>-</p> |ZABBIX_PASSIVE |proc.get[,,,summary] |
...
|RabbitMQ |RabbitMQ: Get process apache |<p>-</p> |DEPENDENT |rabbitmq.proc.get[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.[?(@["name"]=="{#NAME}")]`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|RabbitMQ |RabbitMQ: Number of processes running |<p>-</p> |DEPENDENT |rabbitmq.proc.num[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$..processes.first()`</p> |
|RabbitMQ |RabbitMQ: Memory usage (rss) |<p>Resident set size memory used by process in bytes.</p> |DEPENDENT |rabbitmq.proc.rss[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$..rss.first()`</p> |
|RabbitMQ |RabbitMQ: Memory usage (vsize) |<p>Virtual memory size used by process in bytes.</p> |DEPENDENT |rabbitmq.proc.vmem[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$..vsize.first()`</p> |
