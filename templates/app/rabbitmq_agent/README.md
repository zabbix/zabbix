...
|RabbitMQ |RabbitMQ: Get processes summary |<p>-</p> |ZABBIX_PASSIVE |proc.get[,,,summary] |
...
|RabbitMQ |RabbitMQ: Get process data |<p>-</p> |DEPENDENT |rabbitmq.proc.get[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.[?(@["name"]=="{#NAME}")].first`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|RabbitMQ |RabbitMQ: Number of running processes |<p>-</p> |DEPENDENT |rabbitmq.proc.num[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.processes`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|RabbitMQ |RabbitMQ: Memory usage (rss) |<p>Resident set size memory used by process in bytes.</p> |DEPENDENT |rabbitmq.proc.rss[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.rss`</p> |
|RabbitMQ |RabbitMQ: Memory usage (vsize) |<p>Virtual memory size used by process in bytes.</p> |DEPENDENT |rabbitmq.proc.vmem[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.vsize`</p> |
|RabbitMQ |RabbitMQ: Memory usage, % |<p>Percentage of real memory used by process {#NAME}.</p> |DEPENDENT |rabbitmq.proc.pmem[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.pmem`</p> |
|RabbitMQ |RabbitMQ: CPU utilization |<p>Process CPU utilization percentage.</p> |ZABBIX_PASSIVE |proc.cpu.util[{#NAME}] |
