...
|Disks temperature discovery |<p>Disks temperature discovery from FREENAS-MIB.</p> |SNMP |disk.temp.discovery<p>**Preprocessing**:</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `6h`</p> |
...
|ZFS datasets discovery |<p>ZFS datasets discovery from FREENAS-MIB.</p> |SNMP |zfs.dataset.discovery<p>**Preprocessing**:</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `6h`</p><p>**Filter**:</p>AND <p>- {#DATASET_NAME} MATCHES_REGEX `{$DATASET.NAME.MATCHES}`</p><p>- {#DATASET_NAME} NOT_MATCHES_REGEX `{$DATASET.NAME.NOT_MATCHES}`</p> |
|ZFS pools discovery |<p>ZFS pools discovery from FREENAS-MIB.</p> |SNMP |zfs.pools.discovery<p>**Preprocessing**:</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `6h`</p> |
|ZFS volumes discovery |<p>ZFS volumes discovery from FREENAS-MIB.</p> |SNMP |zfs.zvols.discovery<p>**Preprocessing**:</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `6h`</p> |
...
|Storage |[{#DEVNAME}]: Disk read rate |<p>MIB: UCD-DISKIO-MIB</p><p>The number of read accesses from this device since boot.</p> |SNMP |vfs.dev.read.rate[{#SNMPINDEX}]<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|Storage |[{#DEVNAME}]: Disk write rate |<p>MIB: UCD-DISKIO-MIB</p><p>The number of write accesses from this device since boot.</p> |SNMP |vfs.dev.write.rate[{#SNMPINDEX}]<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|Storage |[{#DEVNAME}]: Disk utilization |<p>MIB: UCD-DISKIO-MIB</p><p>The 1 minute average load of disk (%)</p> |SNMP |vfs.dev.util[{#SNMPINDEX}] |
|TrueNAS |TrueNAS: ARC size |<p>MIB: FREENAS-MIB</p><p>ARC size in bytes.</p> |SNMP |zfs.arc.size<p>**Preprocessing**:</p><p>- MULTIPLIER: `1024`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|TrueNAS |TrueNAS: ARC metadata size |<p>MIB: FREENAS-MIB</p><p>ARC metadata size used in bytes.</p> |SNMP |zfs.arc.meta<p>**Preprocessing**:</p><p>- MULTIPLIER: `1024`</p> |
|TrueNAS |TrueNAS: ARC data size |<p>MIB: FREENAS-MIB</p><p>ARC data size used in bytes.</p> |SNMP |zfs.arc.data<p>**Preprocessing**:</p><p>- MULTIPLIER: `1024`</p> |
|TrueNAS |TrueNAS: ARC hits |<p>MIB: FREENAS-MIB</p><p>Total amount of cache hits in the ARC per second.</p> |SNMP |zfs.arc.hits<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |TrueNAS: ARC misses |<p>MIB: FREENAS-MIB</p><p>Total amount of cache misses in the ARC per second.</p> |SNMP |zfs.arc.misses<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |TrueNAS: ARC target size of cache |<p>MIB: FREENAS-MIB</p><p>ARC target size of cache in bytes.</p> |SNMP |zfs.arc.c<p>**Preprocessing**:</p><p>- MULTIPLIER: `1024`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|TrueNAS |TrueNAS: ARC target size of MRU |<p>MIB: FREENAS-MIB</p><p>ARC target size of MRU in bytes.</p> |SNMP |zfs.arc.p<p>**Preprocessing**:</p><p>- MULTIPLIER: `1024`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|TrueNAS |TrueNAS: ARC cache hit ratio |<p>MIB: FREENAS-MIB</p><p>ARC cache hit ration percentage.</p> |SNMP |zfs.arc.hit.ratio |
|TrueNAS |TrueNAS: ARC cache miss ratio |<p>MIB: FREENAS-MIB</p><p>ARC cache miss ration percentage.</p> |SNMP |zfs.arc.miss.ratio |
|TrueNAS |TrueNAS: L2ARC hits |<p>MIB: FREENAS-MIB</p><p>Hits to the L2 cache per second.</p> |SNMP |zfs.l2arc.hits<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |TrueNAS: L2ARC misses |<p>MIB: FREENAS-MIB</p><p>Misses to the L2 cache per second.</p> |SNMP |zfs.l2arc.misses<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |TrueNAS: L2ARC read rate |<p>MIB: FREENAS-MIB</p><p>Read rate from L2 cache in bytes per second.</p> |SNMP |zfs.l2arc.read<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |TrueNAS: L2ARC write rate |<p>MIB: FREENAS-MIB</p><p>Write rate from L2 cache in bytes per second.</p> |SNMP |zfs.l2arc.write<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |TrueNAS: L2ARC size |<p>MIB: FREENAS-MIB</p><p>L2ARC size in bytes.</p> |SNMP |zfs.l2arc.size<p>**Preprocessing**:</p><p>- MULTIPLIER: `1024`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|TrueNAS |TrueNAS: ZIL operations |<p>MIB: FREENAS-MIB</p><p>The ops column parsed from the command zilstat 1 1.</p> |SNMP |zfs.zil.ops |
|TrueNAS |Pool [{#POOLNAME}]: Total space |<p>MIB: FREENAS-MIB</p><p>The size of the storage pool in bytes.</p> |SNMP |zpool.size.total[{#POOLNAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#POOL_ALLOC_UNITS}`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|TrueNAS |Pool [{#POOLNAME}]: Used space |<p>MIB: FREENAS-MIB</p><p>The used size of the storage pool in bytes.</p> |SNMP |zpool.used[{#POOLNAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#POOL_ALLOC_UNITS}`</p> |
|TrueNAS |Pool [{#POOLNAME}]: Available space |<p>MIB: FREENAS-MIB</p><p>The available size of the storage pool in bytes.</p> |SNMP |zpool.avail[{#POOLNAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#POOL_ALLOC_UNITS}`</p> |
|TrueNAS |Pool [{#POOLNAME}]: Usage in % |<p>The used size of the storage pool in %.</p> |CALCULATED |zpool.pused[{#POOLNAME}]<p>**Expression**:</p>`last(//zpool.used[{#POOLNAME}]) * 100 / last(//zpool.size.total[{#POOLNAME}])` |
|TrueNAS |Pool [{#POOLNAME}]: Health |<p>MIB: FREENAS-MIB</p><p>The current health of the containing pool, as reported by zpool status.</p> |SNMP |zpool.health[{#POOLNAME}]<p>**Preprocessing**:</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|TrueNAS |Pool [{#POOLNAME}]: Read operations rate |<p>MIB: FREENAS-MIB</p><p>The number of read I/O operations sent to the pool or device, including metadata requests (averaged since system booted).</p> |SNMP |zpool.read.ops[{#POOLNAME}]<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |Pool [{#POOLNAME}]: Write operations rate |<p>MIB: FREENAS-MIB</p><p>The number of write I/O operations sent to the pool or device (averaged since system booted).</p> |SNMP |zpool.write.ops[{#POOLNAME}]<p>**Preprocessing**:</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |Pool [{#POOLNAME}]: Read rate |<p>MIB: FREENAS-MIB</p><p>The bandwidth of all read operations (including metadata), expressed as units per second (averaged since system booted).</p> |SNMP |zpool.read.bytes[{#POOLNAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#POOL_ALLOC_UNITS}`</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |Pool [{#POOLNAME}]: Write rate |<p>MIB: FREENAS-MIB</p><p>The bandwidth of all write operations, expressed as units per second (averaged since system booted).</p> |SNMP |zpool.write.bytes[{#POOLNAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#POOL_ALLOC_UNITS}`</p><p>- CHANGE_PER_SECOND</p> |
|TrueNAS |Dataset [{#DATASET_NAME}]: Total space |<p>MIB: FREENAS-MIB</p><p>The size of the dataset in bytes.</p> |SNMP |dataset.size.total[{#DATASET_NAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#DATASET_ALLOC_UNITS}`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|TrueNAS |Dataset [{#DATASET_NAME}]: Used space |<p>MIB: FREENAS-MIB</p><p>The used size of the dataset in bytes.</p> |SNMP |dataset.used[{#DATASET_NAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#DATASET_ALLOC_UNITS}`</p> |
|TrueNAS |Dataset [{#DATASET_NAME}]: Available space |<p>MIB: FREENAS-MIB</p><p>The available size of the dataset in bytes.</p> |SNMP |dataset.avail[{#DATASET_NAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#DATASET_ALLOC_UNITS}`</p> |
|TrueNAS |Dataset [{#DATASET_NAME}]: Usage in % |<p>The used size of the dataset in %.</p> |CALCULATED |dataset.pused[{#DATASET_NAME}]<p>**Expression**:</p>`last(//dataset.used[{#DATASET_NAME}]) * 100 / last(//dataset.size.total[{#DATASET_NAME}])` |
|TrueNAS |ZFS volume [{#ZVOL_NAME}]: Total space |<p>MIB: FREENAS-MIB</p><p>The size of the ZFS volume in bytes.</p> |SNMP |zvol.size.total[{#ZVOL_NAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#ZVOL_ALLOC_UNITS}`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
|TrueNAS |ZFS volume [{#ZVOL_NAME}]: Used space |<p>MIB: FREENAS-MIB</p><p>The used size of the ZFS volume in bytes.</p> |SNMP |zvol.used[{#ZVOL_NAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#ZVOL_ALLOC_UNITS}`</p> |
|TrueNAS |ZFS volume [{#ZVOL_NAME}]: Available space |<p>MIB: FREENAS-MIB</p><p>The available of the ZFS volume in bytes.</p> |SNMP |zvol.avail[{#ZVOL_NAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `{#ZVOL_ALLOC_UNITS}`</p> |
|TrueNAS |Disk [{#DISK_NAME}]: Temperature |<p>MIB: FREENAS-MIB</p><p>The temperature of this HDD in mC.</p> |SNMP |disk.temp[{#DISK_NAME}]<p>**Preprocessing**:</p><p>- MULTIPLIER: `0.001`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `1h`</p> |
...
|Interface [{#IFNAME}({#IFALIAS})]: High input error rate ( > {$IF.ERRORS.WARN:"{#IFNAME}"} for 5m) |<p>Recovers when below 80% of {$IF.ERRORS.WARN:"{#IFNAME}"} threshold</p> |`min(/TrueNAS SNMP/net.if.in.errors[{#SNMPINDEX}],5m)>{$IF.ERRORS.WARN:"{#IFNAME}"}`<p>Recovery expression:</p>`max(/TrueNAS SNMP/net.if.in.errors[{#SNMPINDEX}],5m)<{$IF.ERRORS.WARN:"{#IFNAME}"}*0.8` |WARNING |<p>**Depends on**:</p><p>- Interface [{#IFNAME}({#IFALIAS})]: Link down</p> |
|Interface [{#IFNAME}({#IFALIAS})]: High inbound bandwidth usage ( > {$IF.UTIL.MAX:"{#IFNAME}"}% ) |<p>The network interface utilization is close to its estimated maximum bandwidth.</p> |`(avg(/TrueNAS SNMP/net.if.in[{#SNMPINDEX}],15m)>({$IF.UTIL.MAX:"{#IFNAME}"}/100)*last(/TrueNAS SNMP/net.if.speed[{#SNMPINDEX}])) and last(/TrueNAS SNMP/net.if.speed[{#SNMPINDEX}])>0 `<p>Recovery expression:</p>`avg(/TrueNAS SNMP/net.if.in[{#SNMPINDEX}],15m)<(({$IF.UTIL.MAX:"{#IFNAME}"}-3)/100)*last(/TrueNAS SNMP/net.if.speed[{#SNMPINDEX}])` |WARNING |<p>**Depends on**:</p><p>- Interface [{#IFNAME}({#IFALIAS})]: Link down</p> |
|Interface [{#IFNAME}({#IFALIAS})]: High output error rate ( > {$IF.ERRORS.WARN:"{#IFNAME}"} for 5m) |<p>Recovers when below 80% of {$IF.ERRORS.WARN:"{#IFNAME}"} threshold</p> |`min(/TrueNAS SNMP/net.if.out.errors[{#SNMPINDEX}],5m)>{$IF.ERRORS.WARN:"{#IFNAME}"}`<p>Recovery expression:</p>`max(/TrueNAS SNMP/net.if.out.errors[{#SNMPINDEX}],5m)<{$IF.ERRORS.WARN:"{#IFNAME}"}*0.8` |WARNING |<p>**Depends on**:</p><p>- Interface [{#IFNAME}({#IFALIAS})]: Link down</p> |
|Interface [{#IFNAME}({#IFALIAS})]: High outbound bandwidth usage ( > {$IF.UTIL.MAX:"{#IFNAME}"}% ) |<p>The network interface utilization is close to its estimated maximum bandwidth.</p> |`(avg(/TrueNAS SNMP/net.if.out[{#SNMPINDEX}],15m)>({$IF.UTIL.MAX:"{#IFNAME}"}/100)*last(/TrueNAS SNMP/net.if.speed[{#SNMPINDEX}])) and last(/TrueNAS SNMP/net.if.speed[{#SNMPINDEX}])>0 `<p>Recovery expression:</p>`avg(/TrueNAS SNMP/net.if.out[{#SNMPINDEX}],15m)<(({$IF.UTIL.MAX:"{#IFNAME}"}-3)/100)*last(/TrueNAS SNMP/net.if.speed[{#SNMPINDEX}])` |WARNING |<p>**Depends on**:</p><p>- Interface [{#IFNAME}({#IFALIAS})]: Link down</p> |
...
|Pool [{#POOLNAME}]: High space usage (more than {$ZPOOL.PUSED.MAX.CRIT:"{#POOLNAME}"}% used) |<p>Two conditions should match: First, space utilization should be above {$ZPOOL.PUSED.MAX.CRIT:"{#POOLNAME}"}%.</p><p>Second condition: The pool free space is less than {$ZPOOL.FREE.MIN.CRIT:"{#POOLNAME}"}.</p> |`min(/TrueNAS SNMP/zpool.pused[{#POOLNAME}],5m) > {$ZPOOL.PUSED.MAX.CRIT:"{#POOLNAME}"} and last(/TrueNAS SNMP/zpool.avail[{#POOLNAME}]) < {$ZPOOL.FREE.MIN.CRIT:"{#POOLNAME}"}` |AVERAGE | |
|Pool [{#POOLNAME}]: High space usage (more than {$ZPOOL.PUSED.MAX.WARN:"{#POOLNAME}"}% used) |<p>Two conditions should match: First, space utilization should be above {$ZPOOL.PUSED.MAX.WARN:"{#POOLNAME}"}%.</p><p>Second condition: The pool free space is less than {$ZPOOL.FREE.MIN.WARN:"{#POOLNAME}"}.</p> |`min(/TrueNAS SNMP/zpool.pused[{#POOLNAME}],5m) > {$ZPOOL.PUSED.MAX.WARN:"{#POOLNAME}"} and last(/TrueNAS SNMP/zpool.avail[{#POOLNAME}]) < {$ZPOOL.FREE.MIN.WARN:"{#POOLNAME}"}` |WARNING |<p>**Depends on**:</p><p>- Pool [{#POOLNAME}]: High space usage (more than {$ZPOOL.PUSED.MAX.CRIT:"{#POOLNAME}"}% used)</p> |
|Pool [{#POOLNAME}]: Status is not online |<p>Please check pool status.</p> |`last(/TrueNAS SNMP/zpool.health[{#POOLNAME}]) <> 0` |AVERAGE | |
|Dataset [{#DATASET_NAME}]: High space usage (more than {$DATASET.PUSED.MAX.CRIT:"{#DATASET_NAME}"}% used) |<p>Two conditions should match: First, space utilization should be above {$DATASET.PUSED.MAX.CRIT:"{#DATASET_NAME}"}%.</p><p>Second condition: The dataset free space is less than {$DATASET.FREE.MIN.CRIT:"{#POOLNAME}"}.</p> |`min(/TrueNAS SNMP/dataset.pused[{#DATASET_NAME}],5m) > {$DATASET.PUSED.MAX.CRIT:"{#DATASET_NAME}"} and last(/TrueNAS SNMP/dataset.avail[{#DATASET_NAME}]) < {$DATASET.FREE.MIN.CRIT:"{#POOLNAME}"}` |AVERAGE | |
|Dataset [{#DATASET_NAME}]: High space usage (more than {$DATASET.PUSED.MAX.WARN:"{#DATASET_NAME}"}% used) |<p>Two conditions should match: First, space utilization should be above {$DATASET.PUSED.MAX.WARN:"{#DATASET_NAME}"}%.</p><p>Second condition: The dataset free space is less than {$DATASET.FREE.MIN.WARN:"{#POOLNAME}"}.</p> |`min(/TrueNAS SNMP/dataset.pused[{#DATASET_NAME}],5m) > {$DATASET.PUSED.MAX.WARN:"{#DATASET_NAME}"} and last(/TrueNAS SNMP/dataset.avail[{#DATASET_NAME}]) < {$DATASET.FREE.MIN.WARN:"{#POOLNAME}"}` |WARNING |<p>**Depends on**:</p><p>- Dataset [{#DATASET_NAME}]: High space usage (more than {$DATASET.PUSED.MAX.CRIT:"{#DATASET_NAME}"}% used)</p> |
|Disk [{#DISK_NAME}]: Average disk temperature is too high (over {$TEMPERATURE.MAX.CRIT:"{#DISK_NAME}"}C for 5m) |<p>Disk temperature is high.</p> |`avg(/TrueNAS SNMP/disk.temp[{#DISK_NAME}],5m) > {$TEMPERATURE.MAX.CRIT:"{#DISK_NAME}"}` |AVERAGE | |
|Disk [{#DISK_NAME}]: Average disk temperature is too high (over {$TEMPERATURE.MAX.WARN:"{#DISK_NAME}"}C for 5m) |<p>Disk temperature is high.</p> |`avg(/TrueNAS SNMP/disk.temp[{#DISK_NAME}],5m) > {$TEMPERATURE.MAX.WARN:"{#DISK_NAME}"}` |WARNING | |
