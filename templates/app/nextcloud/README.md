...
|Name|Description|Type|Key and additional info|
|----|-----------|----|-----------------------|
|Nextcloud: User "{#NEXTCLOUD.USER}": Get data|<p>Get common information about user</p>|HTTP agent|nextcloud.user.get_data[{#NEXTCLOUD.USER}]<p>**Preprocessing**</p><ul><li>XML to JSON</li><li><p>Check for not supported value: `any error`</p><p>⛔️Custom on fail: Set value to: `<ocs><meta><status>failure</status><statuscode>999</statuscode><message/></meta><data><message>Unknown error</message></data></ocs>`</p></li></ul>|
