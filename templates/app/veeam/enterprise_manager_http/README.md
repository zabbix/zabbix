...
|{$VEEAM.REPOSITORY.NAME.MATCHES}|<p>This macro is used in repository discovery rule.</p>|`.*`|
|{$VEEAM.REPOSITORY.NAME.NOT_MATCHES}|<p>This macro is used in repository discovery rule.</p>|`CHANGE_IF_NEEDED`|
