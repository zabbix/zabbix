...
|Veeam |Veeam: Get data [{#NAME}] [{#TYPE}] |<p>Gets raw data of the proxy named: `[{#NAME}]`, `[{#TYPE}]`.</p> |DEPENDENT |veeam.proxy.raw[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.proxies.data.[?(@.id=='{#ID}')].first()`</p> |
...
|Veeam |Veeam: Get data [{#NAME}] [{#TYPE}] |<p>Gets raw data of repositories named: `[{#NAME}]`, `[{#TYPE}]`.</p> |DEPENDENT |veeam.repositories.raw[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.repositories_states.data.[?(@.id=='{#ID}')].first()`</p> |
...
|Veeam |Veeam: Get sessions data [{#NAME}] [{#TYPE}] |<p>Gets raw data of sessions named: `[{#NAME}]`, `[{#TYPE}]`.</p> |DEPENDENT |veeam.sessions.raw[{#ID}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.sessions.data.[?(@.id=='{#ID}')].first()`</p><p>⛔️ON_FAIL: `DISCARD_VALUE -> `</p> |
...
|Veeam |Veeam: Get jobs states data [{#NAME}] |<p>Gets raw data of the jobs states named `[{#NAME}]`.</p> |DEPENDENT |veeam.jobs.states.raw[{#ID}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.jobs_states.data.[?(@.id=='{#ID}')].first()`</p> |
