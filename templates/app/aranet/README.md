...
|------------------|---------------------------|-------------------------------------------|-----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.temp["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                     |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.humidity["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                 |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.rssi["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                     |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.battery.voltage["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>          |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.co2["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                      |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.pressure["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                 |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.voltage["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                  |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.weight["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                   |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.volumetric.water.content["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p> |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.ppfd["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                     |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.distance["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                 |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.illuminance["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>              |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.ph["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                       |
| Aranet           | {#METRIC}: {#SENSOR}      | <p>-</p>                                  | DEPENDENT | aranet.current["{#ID}"]<p>**Preprocessing**:</p><p>- JSONPATH: `$[?(@.id == "{#ID}" && @.name == "{#SENSOR}")].metrics[?(@.name == "{#METRIC}")].value.first()`</p>                  |
