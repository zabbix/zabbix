...
It collects metrics by Zabbix agent 2 version 5.4 and later with Smartmontools version 7.0 and later.  
...
|----|-----------|----|----|
|SMART disk discovery |<p>Discovery SMART drives.</p> |ZABBIX_PASSIVE |smart.disk.discovery |
|SMART attribute discovery |<p>Discovery SMART Vendor Specific Attributes of drives.</p> |ZABBIX_PASSIVE |smart.attribute.discovery |

## Items collected

|Group|Name|Description|Type|Key and additional info|
|-----|----|-----------|----|---------------------|
|Zabbix_raw_items |SMART: Get SMART attributes of all disks |<p>-</p> |ZABBIX_PASSIVE |smart.disk.get |
