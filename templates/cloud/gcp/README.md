...
Currently, the template supports the discovery of Compute Engine instances and Cloud SQL instances (Microsoft SQL Server, MySQL, and PostgreSQL, including replicas).
