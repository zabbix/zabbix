...
Currently, the template supports the discovery of Compute instances, Autonomous Databases, Object Storage, Virtual Cloud Networks (VCNs), Block Volumes, and Boot Volumes.
