...
|Intel SR1630 IPMI: BB +1.1V P1 Vccp Non-Critical [{ITEM.VALUE}]||`last(/Intel SR1630 IPMI/bb_1.1v_p1_vccp)<0.708 or last(/Intel SR1630 IPMI/bb_1.1v_p1_vccp)>1.501`|High|**Depends on**:<br><ul><li>Intel SR1630 IPMI: BB +1.05V PCH Critical [{ITEM.VALUE}]</li><li>Intel SR1630 IPMI: Power</li></ul>|
