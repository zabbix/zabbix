...
|MongoDB: MongoDB version|<p>Version of the MongoDB server.</p>|Zabbix agent|mongodb.version<p>**Preprocessing**</p><ul><li><p>Discard unchanged with heartbeat: `12h`</p></li></ul>|
