...
|MySQL: Failed to fetch data|<p>Zabbix has not received any data for the last 30 minutes.</p>|`nodata(/MySQL by Zabbix agent/mysql.uptime,30m)=1`|Info|**Depends on**:<br><ul><li>MySQL: Service is unreachable</li></ul>|
