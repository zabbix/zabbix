...
|Version|<p>MariaDB server version.</p>|Zabbix agent|mariadb.version["{$MARIADB.HOST}","{$MARIADB.PORT}"]<p>**Preprocessing**</p><ul><li><p>Regular expression: `(Server version)\s+(.+) \2`</p></li><li><p>Discard unchanged with heartbeat: `1d`</p></li></ul>|
