...
|MariaDB: Failed to fetch data|<p>Zabbix has not received any data for the last 30 minutes.</p>|`nodata(/MariaDB by Zabbix agent/mariadb.uptime,30m)=1`|Info|**Depends on**:<br><ul><li>MariaDB: Service is unreachable</li></ul>|
