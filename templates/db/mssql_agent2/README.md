...
Loadable plugin requires installation of a separate [package](https://repo.zabbix.com/zabbix/6.5/) or [binary file](https://cdn.zabbix.com/zabbix/binaries/stable/6.4/) or [compilation from sources](https://www.zabbix.com/documentation/7.0/manual/extensions/plugins/build).
