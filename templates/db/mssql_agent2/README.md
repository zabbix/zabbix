...
Note: Since version 7.0.6, you can also connect to the MSSQL by instance name. To do this, set the connection string in the `{$MSSQL.URI}` macro as `<protocol://host/instance_name>`.
